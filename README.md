...
정한(Junghan Kim)의 **디지털가든 코어**입니다. 가든 전체를 미러링한 책이 아닙니다. 어쏠로그(생생날것)와 봇로그를 중심으로 미러 대상 5개 폴더(저널·메타·참고문헌·노트·봇로그) 2,245개 문서 가운데 283개를 골라 낸 현재 판본입니다. 여기 없는 글도 지워진 것이 아니라 가든에 그대로 있고, 원본과 최신본은 언제나 가든입니다.
