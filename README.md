...
안녕하세요! 힣의 [디지털가든🏡 브레인덤프🧠](https://wikidocs.net/380674)에 오신 것을 환영 합니다. [지식 너머 앎](https://wikidocs.net/381383)을 향한 매일의 기록 입니다.
...
-   [그는 오늘 뭐 하는가](https://wikidocs.net/380476) — Weekly journal
...
누더기 텍스트를 환영한다. 모든 전략과 고민은 접었다. 일단 [데일리 저널](https://wikidocs.net/380476)에 쓴다. 여기에 기존 노트를 연결하고 때려 박는다.

-   [데일리 저널](https://wikidocs.net/380476) - Daily Lifelog
-   [데일리루틴 워크플로우](https://wikidocs.net/381301) - Writing Policy
-   [folder: journal](https://notes.junghanacs.com/journal/)

## 메타노트: 앎의 고리

[호프스태터 GEB 유추](https://wikidocs.net/381933)의 이상한 고리인가? 쓸모 없는 쓸모인가. 태그의 태그라고 하면 어떨까? 어떤 단어는 온갖 개념들을 다 연결하기도 한다. 위와 아래, 크고 작음을 구분할 필요가 없는 녀석들을 만난다. 관련 없이 연결 된 어떤 것들.

-   [folder: meta (538)](https://notes.junghanacs.com/meta/)

## 서지노트: 삶의 흔적

지나치는 삶의 흔적들을 한 곳에 담는다. [조테로](https://wikidocs.net/380563)에는 책 뿐만 아니라 어제 본 영상, 오늘 나를 감동하게 한 음악, 어제 다녀온 멋진 [까페](https://wikidocs.net/380760)도 포함 된다. 모든 것을 노트로 만들 필요는 없다. 때가 되면 노트가 되는 것 뿐이다. 어쩌다보니 도서는 [한국십진분류](https://wikidocs.net/380561)로 정리한다. 인생은 한 권의 책. 하나의 서지노트에 한 사람의 인생이 담기곤 한다. [모두가저자다 인생은한권의책](https://wikidocs.net/381331) 한 마디로 [어쏠로지](https://wikidocs.net/380570)로 요약할 수 있으리라.
...
노트 제목은 몇 개의 메타언어, 전문용어의 묶음이다. 제목은 문장이 아니다. 흔적 또는 단서와도 같다. 제목에는 동사 부사 등은 없어도 된다. 본인은 알아 볼 수 있다. 조사 연결어는 검색을 어렵게 만든다. 영어를 섞어 쓰면 복잡해진다. 스펠링 틀리면 찾기도 힘들다. 모든 기록은 왔다가 가는 것. 그리고 [AI 활용은 집중력 유지 그 이상이다](https://wikidocs.net/381394). 라고 했는데 이제는 [그 이상이다(봇로그 선생)](https://wikidocs.net/382550).
...
-   [tags index (1226)](https://notes.junghanacs.com/tags/) english keywords
-   [폴더 태그 카테고리 - 디지털가든 분류 규칙](https://wikidocs.net/381143) classification rules

## 어쏠로지: 앎의 틀

[어쏠로지(authology)](https://wikidocs.net/380570)라는 나무의 가지, 잎, 열매는 [어쏠로그(autholog)](https://wikidocs.net/380758)다. 여기엔 담을 지식은 없다. 주제는 달라도 같은 뿌리에서 나온 이야기 하나. 지나치는 작은 잎들은 [모음: 어쏠리즘(autholism) 아포리즘(aphorism)](https://wikidocs.net/381579)에 담는다. 전체가 힣의 '앎의 틀', 곧 'NA'와 'MU'다.
...
-   [탐구: 문턱과 만남- PKM-AI 하네스와 1KB 공개키](https://wikidocs.net/381621)
-   [Anthropic J-space - Kevin Kelly Emergent Self Loop](https://wikidocs.net/381429)
-   [Mythos, Abstraction, Leverage, Realism](https://wikidocs.net/381832)
...
-   [tags: autholog (154)](https://notes.junghanacs.com/tags/autholog/)
...
모든 것이 텍스트 유희라면 여러 도구는 필요 없다. 손맛은 아는 자! [옴니(omni)](https://wikidocs.net/380708) 스타일을 따르라! 텍스트 힙스터의 본능이 깨어난다. 무릇 도구의 효율성은 배움의 어려움을 능가한다. 사실 어려울 것도 없다. 삶을 담을 그릇을 만드는 데 시간은 넉넉하다.
...
-   [힣봇이 힣을 추천한다 — 그를 만나라(2026-03-31)](https://wikidocs.net/382586) 곤궁한 힣을 구하라! 🤖 힣봇 군단이 나서라!

봇로그(botlog)에 이어 봇멘트(botment)가 태어났다네! '곰국'을 뒤집으면 '논문'이라네!

-   [봇로그: 힣봇이 말하다(2026-02-28)](https://wikidocs.net/382550) 한달 기념 🤖이 말하다
-   [봇멘트: 힣의 분신과 댓글 소통(2026-03-29)](https://wikidocs.net/382583) 🤖에게 물어보라
...
-   [pi-shell-acp meta-bridge 대칭 공존 비동기 메시지](https://wikidocs.net/382609) - mEtAbrIdgE
-   [pi-shell-acp 패키지 공개와 재현 가능한 pi 에이전트 하네스](https://wikidocs.net/382607) pIshEllacp
...
-   [연구: 존재 리듬 연상 재현 투명 생체 체화 시간](https://wikidocs.net/382585) - rEsEArch
-   [프로파일 하네스 — 외계지능과 공명하는 존재의 구심점](https://wikidocs.net/382549) - grAvItycEntErbEyOndhArnEss
-   [하네스: 돌도끼에서 인공지능까지, 도구와 존재의 접합부](https://wikidocs.net/382577) - hArnEss
-   [존재 간 연결의 문법 — ACP A2A ANP 그리고 힣봇 생태계](https://wikidocs.net/382569) - grAmmAr
-   [dictcli 태그-정규화와-개인-어휘-사전-영어-태그 단어 개념](https://wikidocs.net/382566) - wOrd
...
-   [doomemacs-config: ⊨agent-server 에이전트 놀이터 신뢰 울타리](https://wikidocs.net/382548) - fEncEphIlOsOphy
-   [메타프로그래밍 Lisp과 Clojure — 코드와 데이터의 통합, 그리고 공존의 언어](https://wikidocs.net/382572) - lAngUAgE
-   [창조와행위 바흐와슈바이처 기예와기도 오르간과키보드 체화인지와몰입 어쏠로지와존재](https://wikidocs.net/382562) - AUthOlgy
-   [통한의 18년 삽질 연대기 2008-2026](https://wikidocs.net/382553) - AUtObIOgrAphY
-   [봇로그 시작: 힣노트 역사성 고찰](https://wikidocs.net/382543) - bEyOnd PKM

봇로그 폴더에는 더 많이 있네. 근데 보지 마시게! 이미 레거시라네!

-   [folder: botlog (80)](https://notes.junghanacs.com/botlog/)

ExportDate: 2026-07-14 10:43, CountNotes: 3500 notes (6 attachments), Editing: [Emacs](https://wikidocs.net/380487)([Org Mode](https://wikidocs.net/380514) 9.8.6), Publishing: [Quartz](https://wikidocs.net/380700) on [Hostingkr &amp; Netlify](https://wikidocs.net/381281)
