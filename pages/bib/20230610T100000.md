<!-- gid:20230610T100000 -->
[[TIP("이 노트에 대하여")]]
Emacs Writing Studio는 생산성을 요령이 아니라 작업 환경의 일관성에서 찾는다. 이 노트는 글쓰기, 참고문헌, 출판, 노트 관리가 하나의 흐름으로 이어지는 EWS의 핵심 감각을 담는다.
...
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/bib/20230610T100000/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-06-10T10:00:00+09:00`
...
-   [contacts::Peter Prevos - lucidmanager.org -](https://notes.junghanacs.com/meta/20230303T030300.md#h-ed26a5d0-134e-4b0c-af4a-d0faf846579b/)
...
### D3.js by Observable - The JavaScript visualization <span class="org-hashtag">#옵저버블</span>

(“D3.Js by Observable - the Javascript Visualization #옵저버블” n.d.)

### Observable: Build expressive charts and dashboards <span class="org-hashtag">#옵서버블</span>
...
### Quarto - Observable JS <span class="org-hashtag">#콰르토</span> <span class="org-hashtag">#옵서버블</span>
...
[2024-12-23 Mon 10:16]

[디노트](https://notes.junghanacs.com/meta/20231005T141500/) 참고하라

-   (“Junghan0611/Denote-Explore” 2023) 포크한 것

(“Pprevos/Denote-Explore” 2024)
...
## <span class="underline">나의 생각</span> : 훌륭하다. 초보자를 위한 3 가지 포인트.
...
![](../../assets/20230620-1543-screenshot.png)

## <span class="underline">원문 번역</span> : More Productive with Emacs
...
{{< /sidenote >}} 디자인의 결여는 새로운 사용자가 화려한 아이콘을 마우스나 손가락으로 포인팅 할 수 없기 때문에 처음에는 낙담할 수 있습니다. 안타깝게도 대부분의 소프트웨어 개발자는 부드러운 디자인과 마우스를 사용하는 것으로 사용자 친화성을 혼동합니다. 이러한 접근 방식은 학습 된 단순성을 달성하기 위해 사용자가 가질 수 있는 많은 장점을 희생 합니다. 그래픽 기반 소프트웨어(GUI)는 도금한 새장입니다. 즐거울 수도 있지만 그럼에도 불구하고 결국 우리(cage) 일 뿐입니다.
...
![](../../assets/20230620-1505-screenshot.png)

### The learning curve : 러닝 커브
...
[GitHub 에서 다운로드](https://github.com/pprevos/EmacsLife)

### Advantages of using Emacs 이맥스 사용의  장점
...
### More Productive with Emacs : 앞으로 배워 나갈 것들
...
-   [protesilaos 프롯 이맥스 철학자 구루 장인](https://notes.junghanacs.com/bib/20250127T154040/)

## BIBLIOGRAPHY

- “D3.Js by Observable - the Javascript Visualization #옵저버블.” n.d. Accessed December 23, 2024. [https://d3js.org/](https://d3js.org/).
- “Emacs Writing Studio.” 2021. [https://lucidmanager.org/tags/emacs/](https://lucidmanager.org/tags/emacs/).
- “Junghan0611/Denote-Explore.” 2023. [https://github.com/junghan0611/denote-explore](https://github.com/junghan0611/denote-explore).
- “Observable: Build Expressive Charts and Dashboards #옵서버블.” n.d. Accessed December 23, 2024. [https://observablehq.com/](https://observablehq.com/).
- Peter Prevos. 2021. “More Productive with Emacs: Writing, Researching, Publishing.” May 7, 2021. [https://lucidmanager.org/productivity/more-productive-with-emacs/](https://lucidmanager.org/productivity/more-productive-with-emacs/).
- “Pprevos/Denote-Explore.” 2024. [https://github.com/pprevos/denote-explore](https://github.com/pprevos/denote-explore).
- “Pprevos/Emacs-Writing-Studio.” 2024. [https://github.com/pprevos/emacs-writing-studio](https://github.com/pprevos/emacs-writing-studio).
- “Quarto - Observable JS #콰르토 #옵서버블.” n.d. Accessed December 23, 2024. [https://quarto.org/docs/reference/cells/cells-ojs.html](https://quarto.org/docs/reference/cells/cells-ojs.html).

## 로그

### [|2025-06-16 Mon 14:37|](https://notes.junghanacs.com/journal/20250616T000000.md#h-2025-06-16/) 이걸 좀 확장하자
