<!-- gid:20230622T203000 -->
[[TIP("이 노트에 대하여")]]
이 노트는 Aditya Athalye의 글과 프로젝트를 따라가며 클로저식 사고와 이맥스 작업법을 함께 읽는다. 코드를 짜는 일, 글을 쓰는 일, 문제를 탐구하는 일이 한 환경에서 이어질 수 있음을 보여준다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/bib/20230622T203000/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-06-22T20:30:00+09:00`
...
- “Adityaathalye/Clojure-Multiproject-Example Clojure Multi-Project Example Layout and Tool Use.” 2025. [https://github.com/adityaathalye/clojure-multiproject-example](https://github.com/adityaathalye/clojure-multiproject-example).
- Athalye, Aditya. 2023a. “Emerging from Dotemacs Bankruptcy the Hard Way: Integrating the IDE (Feat. Clojure(Script)).” 2023. [https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html](https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html).
- ———. 2023b. “Why and How I Use ‘Org Mode’ for My Writing and More.” 2023. [https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html](https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html).
- ———. n.d.-a. “Clojuring the Web Application Stack: Meditation One.” Accessed February 7, 2025. [https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html](https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html).
- ———. n.d.-b. “Evalapply Blog Tagged #Clojure.” Accessed February 6, 2025. [https://www.evalapply.org/tags/clojure/index.html](https://www.evalapply.org/tags/clojure/index.html).

## 관련노트

-   [내가쓰는이유방법: 조직모드](https://notes.junghanacs.com/notes/20240820T124819/) 여기에 해당한다

## Aditya Athalye

-   [contacts::Athalye, Aditya - evalapply.org - adityaathalye](https://notes.junghanacs.com/meta/20230303T030300.md#h-0f8cce06-c16c-4c5b-a050-db71781e5297/)

adityaathalye · he/him Micro SaaS enthusiast. Alum @recursecenter. Mostly Functional Programmer. Best met in meatspace minus too much coffee. (λ.x (x x) λ.x (x x)) ; forever \m/

<https://github.com/adityaathalye>

### About

[2023-09-11 Mon 10:00] The dashing duo of eval/apply 1 and learn generously 2 pervade all that I do 3. 평가/적용 1 과 아낌없는 배움 2 이라는 멋진 듀오가 제가 하는 모든 일에 스며들어 있습니다 3 .
...
![](../../assets/20230911_100053_screenshot.png)
...
-   Clojuring the web application stack

### adityaathalye/clojure-multiproject-example Clojure Multi-Project Example Layout and Tool Use

(“Adityaathalye/Clojure-Multiproject-Example Clojure Multi-Project Example Layout and Tool Use” 2025)
...
Why and How I Use 'Org-mode' for My Writing and More 원문의 글이다. 멋진 분의 멋진 글이다.
...
![](../../assets/20230622-2035-screenshot.png)

### `번역` 내가 글쓰기 등에 'Org-mode' 를 사용하는 이유와 방법
...
orgmode 는 이미 유서 깊은 Emacs 편집기를 사용하고 있었기 때문에 문화적으로 쉬워졌습니다. _utility_ 와 관련이 있습니다. 유틸리티는 상황에 따라 다릅니다. 저에게는 "(많은) 다른 방법으로 모든 것을 유용하게 사용할 수 있도록 기록하는 것"입니다.
...
예, Emacs 에는 조직 모드의 표준적이고 완전한 구현이 포함되어 있기 때문에 유효한 질문입니다. 많은 사람들이 조직 모드에 Emacs _just_ 를 사용합니다.
...
그 심술궂은 외관[^fn:4][<sup>3</sup>]] 아래에는 아마도 _가장_ 가장 접근하기 쉬운 소프트웨어 응용 프로그램일 것입니다[^fn:5][<sup>4</sup>]]!
...
그래서 저는 이제 _**local first**_ 에 가치를 둡니다. 이는 특히 네트워크나 원격 서비스가 아닌 제 3 자에 대한 엄격한 의존 없이 이식성이 뛰어난 형식의 콘텐츠와 함께 _full_ 데이터 소유권을 의미합니다.
...
이제 _"평문으로 된 당신의 삶"_ 은 org 웹사이트에서 말했듯이 절대적인 필수 아이템입니다. 또한 OneNote 등에서 내가 좋아하는 모든 것을 제공합니다.
...
자, 여기에 뉘앙스가 있습니다. org 는 텍스트를 구조화하고 메타 정보를 설명하기 위해 특정 _구문_ 을 규정하지만, 텍스트를 해석하고 사용하기 위해 _어떤 하나의 방법_ 을 규정하거나 강요하지 _않습니다_; 예를 들어 GTD, Kanban, GANTT 또는 무엇을 가지고 있습니까?
...
-   _"나는 X 를 하고 싶습니다. 조직 모드가 나를 도울 수 있습니까?"_ 를 고려하십시오. 여기서 X 는 **당신** 에게 **가장 중요한** 것입니다. 대답은 거의 확실하게 _"예 m'lorx, 이쪽으로 주세요."_ 일 것입니다. 이전에 나열한 앱 중 요구 사항에 맞는 앱이 있는지 확인하세요.
