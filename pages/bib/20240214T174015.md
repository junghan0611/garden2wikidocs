...
[[TIP("이 노트에 대하여")]] 이 노트는 RDF, OWL, 시맨틱 모델링 같은 기본 개념을 중심으로 지식그래프의 뼈대를 따라간다. 데이터 연결을 검색을 넘어 의미와 추론의 문제로 다루는 시야가 중요하게 드러난다. [[/TIP]] ontology:owl:rdf: - [bib/ 데니즈고즈넬 마티아스브뢰헬러 그래프데이터 실무 가이드 - 그래프씽킹 '2024-05-07 2025-02-15](https://wikidocs.net/381918)
