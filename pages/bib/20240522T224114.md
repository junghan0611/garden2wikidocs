<!-- gid:20240522T224114 -->
[[TIP("이 노트에 대하여")]]
Stefan Thesing의 발표와 글은 Denote 기반 제텔카스텐을 구조적으로 설계하려는 시도다. 제목, 키워드, 서명, 백링크를 어떻게 엮을지 고민할 때 참고가 된다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/bib/20240522T224114/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-05-22T22:41:00+09:00`
...
## 1 What do we need to have a Zettelkasten?

[2023-11-01 Wed 12:09]
...
@user 루만의 제텔카스텐 기법에서 Forgezettel에 대해서 알려줘

@assistant 루만의 제텔카스텐(Zettelkasten) 기법은 독일의 사회학자 니클라스 루만(Niklas Luhmann)이 체계적으로 지식을 축적하고 관리하기 위해 개발한 노트 작성 방법론입니다. 이 기법은 기본적으로 독립적인 노트들(제텔)로 구성되며, 이러한 노트들을 특정한 방식으로 연결하여 복잡한 아이디어들과 인사이트를 도출해냅니다.
...
## 2 Search and inspect operations: Title, keywords, signature

[2023-11-01 Wed 12:08]
...
![](../../assets/20231101_124203_screenshot.png)
...
## <span class="org-todo todo TODO">TODO</span> 4 `Excerpts` (literature notes) and the Zettelkasten

[2023-11-01 Wed 12:08]

## <span class="org-todo todo TODO">TODO</span> 5 Putting Zettels on a "desks"
