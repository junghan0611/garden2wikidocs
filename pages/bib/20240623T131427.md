<!-- gid:20240623T131427 -->
[[TIP("이 노트에 대하여")]]
마크 왓슨의 저작과 사이트를 따라 개인지식관리, 시맨틱웹, AI 프로그래밍이 만나는 흐름을 살핀다. 지식그래프와 LLM을 잇는 실무 감각을 얻는 데도 도움이 된다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/bib/20240623T131427/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-06-23T13:14:00+09:00`
- 최근 수정: `2026-04-30T11:07:00+09:00`
[[/TIP]]
...
-   [2026-04-30 Thu 11:07] 노트 정리 통합했다
-   [2024-06-23 Sun 13:14] 구루를 모십니다.
...
- 마크 왓슨. 2023a. <i>마크왓슨 Ai 파이썬 프로그래밍</i>. Leanpub. [https://leanpub.com/pythonai](https://leanpub.com/pythonai).
- ———. 2023b. <i>마크왓슨 Ai 클로저 프로그래밍</i>. Leanpub. [https://leanpub.com/clojureai/read](https://leanpub.com/clojureai/read).
- ———. 2023c. <i>마크왓슨 Ai 하스켈 프로그래밍</i>. [https://leanpub.com/haskell-cookbook/read](https://leanpub.com/haskell-cookbook/read).
- ———. 2023d. <i>마크왓슨 Langchain Llamaindex Llm Ai 프로그래밍</i>. Leanpub. [https://leanpub.com/langchain/read](https://leanpub.com/langchain/read).
- ———. 2024a. <i>마크왓슨 커먼리스프 프로그래밍</i>. [https://leanpub.com/lovinglisp/read](https://leanpub.com/lovinglisp/read).
- ———. 2024b. <i>마크왓슨 Hylang 하이랭 파이썬 리스프 프로그래밍</i>. Leanpub. [https://leanpub.com/hy-lisp-python](https://leanpub.com/hy-lisp-python).
- ———. n.d. “Knowledgebooks.Com - 지식 관리 및 시맨틱 웹에 대한 연구 Research on the Knowledge Management, and the Semantic Web.” Accessed June 20, 2024. [https://knowledgebooks.com/](https://knowledgebooks.com/).

## Works

이 노트로 통합된 항목들(예전에는 주제별로 분리돼 있었음):

## LangChain / LlamaIndex / LLM

## 마크왓슨 LangChain LlamaIndex LLM AI 프로그래밍

(마크 왓슨 2023d)

-   Read LangChain and LlamaIndex Projects Lab Book: Hooking Large Language Models Up to the Real World
-   마크 왓슨
-   
...
-   [Read Practical Artificial Intelligence Programming With Clojure | Leanpub](https://leanpub.com/clojureai/read)
...
-   [Read Loving Common Lisp, or the Savvy Programmer's Secret Weapon | Leanpub](https://leanpub.com/lovinglisp/read)
...
## "KnowledgeBooks.com - 지식 관리 및 시맨틱 웹에 대한 연구
