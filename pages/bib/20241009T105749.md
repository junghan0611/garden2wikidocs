<!-- gid:20241009T105749 -->
[[TIP("이 노트에 대하여")]]
이맥스의 Org-drill과 Org-fc를 중심으로 텍스트 기반 간격반복학습 워크플로를 정리한다. 암기 도구가 글쓰기와 노트 환경 안에서 어떻게 이어지는지도 살핀다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/bib/20241009T105749/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-10-09T10:57:00+09:00`
...
## Learn the AWK programming language with Emacs Org-drill <span class="org-hashtag">#awk</span>

(“Learn the Awk Programming Language with Emacs Org-Drill #Awk” 2022)
