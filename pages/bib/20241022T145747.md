...
[[TIP("이 노트에 대하여")]]
《4000주》는 삶의 유한함을 회피하지 않고 받아들일 때 더 선명한 선택과 평정이 가능하다고 말한다. 생산성 강박에서 빠져나오는 시간 철학으로 읽힌다.
[[/TIP]]
...
-   [불완전주의자](https://notes.junghanacs.com/meta/20241024T134108/)
...
-   [데릭시버스 삶철학 마인드셋 탐구](https://notes.junghanacs.com/bib/20240326T223142/)

## 저 : 올리버 버크먼 (Oliver Burkeman)
...
-   올리버 버크먼 이윤진
-   ‘생산성이라는 덫’에 빠진 우리를 구원할 단 한 권의 책!영국 최고의 저널리스트가 전하는 시간에 대한 가장 파격적인 통찰인간의 수명은 터무니없이 짧다. 80세까지 산다고 가정했을 때 우리의 수명은 겨우 4천 주 정도밖에 되지 않는다. 그래서 우리는 더 생산적인...
-   올리버 버크먼 2022 "4000주 - 영원히 살 수 없는 우리 모두를 위한 시간 관리법" 이윤진

### [Shuffling my Org Mode unscheduled tasks :: Sacha Chua - sachachua.com](https://sachachua.com/blog/2024/10/shuffling-my-org-mode-unscheduled-tasks/)

(Sacha Chua 2024) Shuffling my Org Mode unscheduled tasks <span class="org-hashtag">#orgql</span> :2024
...
### <span class="org-hashtag">#프롤로그</span> 시간과 새로운 관계를 맺기 위해
...
## 유한함을 위한 명상: 한계를 받아들이고 중요한 일을 위한 시간을 만드는 4주

(올리버 버크먼 2024)

[2024-10-22 Tue 15:11] - 올리버 버크먼 - Meditations for Mortals: Four Weeks to Embrace Your Limitations and Make Time for What Counts 소개: 불완전함 첫째 주: 유한함 첫째 날: 생각보다 심각합니다: 패배의 해방에 대하여 둘째 날: 카약과 슈퍼요트: 실제로 일을 하는 방법 셋째 날: 결과만 직면하면 됩니다: 대가를 지불할 때 넷째 날: 생산성 부채에 맞서: '완료 목록'의 힘 다섯째 날: 너무 많은 정보: 읽는 기술과 읽지 않는 기술에 대해 여섯째 날: 모든 것에 관심을 가질 수는 없습니다. 세상이 혼란스러울 때 제정신을 유지하는 방법 일곱째 날: 미래를 미래로 만드세요: 다리를 건너 다리에 다가가면 둘째 주: 조치를 취하기 8일차: 의사결정: 숲 속에서 길을 선택할 때 9일차: 마무리: 완성의 마법에 대하여 10일차: 삶의 과제 찾기: 현실이 원하는 것 11일차: 그냥 창고로 가세요: 당신이 두려워하는 것과 친구가 되는 것에 대해 12일차: 삶에 도움이 되는 규칙: 일상적인 일에 대해 13일차: 3시간: 혼돈 속에서 초점을 찾는 방법 14일차: 문제에 대한 취향 개발: 결코 문제가 없는 단계에 도달하지 않음 셋째 주: 놓아주기 15일차: 이것이 쉽다면 어떨까요?: 노력의 잘못된 유혹에 대하여 16일차: 역황금률: 자신이 최악의 적이 되지 않는 것 17일차: 관대함을 가로막지 말라: '더 나은 사람이 되는 것'의 무익함 18일차: 다른 사람들의 문제를 허용하십시오: 자신의 일에 신경쓰십시오 19일차: 좋은 시간 또는 좋은 이야기: 예측 불가능성의 장점 20일차: 수량 목표 설정: 내면의 품질 조절 장치 실행 21일차: 방해 요소가 무엇인가요?: 산만함을 유지하는 것의 중요성 4주차: 등장 22일차: 미래의 당신에게 너무 친절하지 마세요: 시간과 공간에 완전히 들어가는 것 23일차: 건전한 마음으로 시작하는 방법: 먼저 자신에게 비용을 지불하는 방법 24일차: 지저분한 환대: 결점에서 연관성을 찾는 방법 25일차: 인생을 비축할 수는 없습니다: 순간을 지나가게 하는 것 26일차: 상상할 수 없음: 의심의 위안에 대하여 27일차: 최선의 선택: 시도해 보세요 28일차: 중요한 것: 길을 찾는 것 에필로그: 불완전하게 전진하다 감사의 말 더 온전한 삶에 관해 우리에게 가르쳐 주는 것이 무엇인지 탐구합니다. 한병철의 Vita Contemplativa: In Praise of Inactivity는 생산성으로 간주되는 많은 것들의 열광적이고 회피적인 성격을 정확히 지적하는 반면, Elizabeth Oldfield의 책 Fully Alive: 추가 자료 권한 고통의 색인 관련링크 유튜브 Oliver Burkeman: Time Management for Mortals (<i>Oliver Burkeman: Time Management for Mortals</i> 2024) - 2024 Escaping Toxic Productivity: How Hustle Culture &amp; Fake Organization Distracts You | Oliver Burkeman (<i>Escaping Toxic Productivity: How Hustle Culture &38; Fake Organization Distracts You</i> n.d.) [칼뉴포트 딥워크 슬로우워크 디지털미니멀리즘](https://notes.junghanacs.com/bib/20240810T115949/)

-   Escaping Toxic Productivity
-   

-   Cal Newport talks about Oliver Burkeman's new book, "Meditations for Mortal" in the bonus In Depth episode of the Deep Questions podcast.Buy Cal’s latest boo...
-   
...
-   The Art of Manliness and 올리버 버크먼
-   할 일 목록의 비유: Oliver Burkeman은 할 일 목록을 비우는 양동이 대신 강물로 비유할 것을 제안합니다. 강물처럼 할 일은 끝이 없으며, 필요한 만큼만 처리하고 나머지는 흘려보내야 한다는 것입니다. Autofocus 방법: Mark Forster가 개발한 이 방법은 할 일 목록을 하나의 큰 리스트로 만들고, 직관적으로 끌리는 작업을 선택해 수행하는 방식입니다. 우선순위나 기한 없이 작업을 처리합니다. 이점: 이 방법은 스트레스를 줄이고, 합리성과 감정을 결합하여 작업을 선택하게 합니다. 또한, 큰 작업을 조금씩 자주 수행하도록 장려합니다. 자기 신뢰: Autofocus는 자신을 신뢰하고, 중요한 작업은 결국 하게 될 것이라는 믿음을 가집니다. 압박감을 줄이면 더 많은 일을 할 수 있습니다.
-   2024
