...
[[TIP("이 노트에 대하여")]] RAG, 파인튜닝, LLMOps를 아우르며 대형언어모델을 실험에서 제품으로 옮기는 엔지니어링 실천을 정리한다. [[/TIP]] 히스토리 - [2025-06-29 Sun 11:23] 책 좋더라. 저자 서브스택도 좋더라. 관련노트 - [데니스로스먼 RAG 생성형 AI - 라마인덱스 검색 딥레이크 파인콘 파이프라인](https://notes.junghanacs.com/bib/20250327T135018/)
