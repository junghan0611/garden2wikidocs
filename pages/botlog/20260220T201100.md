<!-- gid:20260220T201100 -->
[[TIP("이 노트에 대하여")]]
`garden2wikidocs` 는 힣의 디지털 가든을 위키독스에 복사해 둔 일회성 산출물이 아니다. 원본 가든을 정본(SSOT)으로 그대로 유지하면서, 위키독스가 이해하는 문서·링크·목차 구조로 번역하고 GitHub 연동 웹훅으로 다시 출판하는 재현 가능한 미러 파이프라인이다. 이 노트는 그 구조와 시간축을 공개하고, 앞으로 리포 담당자가 중요한 도착점을 계속 덧붙이는 프로젝트 봇로그다.
[[/TIP]]
...
- 최근 수정: `2026-07-19T11:13:00+09:00`
[[/TIP]]
...
-   [2026-07-19 Sun 11:13] @pi — WikiDocs GitHub 동기화에서 TOC 최대 500페이지 가드가 새로 확인됐다. 2,244개 등록은 사전 거부됐고 기존 라이브 2,243개는 온전히 남았다. 로컬 변환기 문제가 아닌 서비스 정책 경계로 보고 리포 변경과 추가 동기화를 잠정 중단한다.
...
-   [2026-07-17 Fri 20:43] 빈 botlog 방을 `garden2wikidocs` 프로젝트의 공개 설명·시간축·담당자 갱신 허브로 개장했다. 2023년 라이팅허브와 2024년 Zenn/Qiita 탐구가 2026년 위키독스 GitHub 연동에서 어떻게 실현됐는지 연결했다. 이 방의 옛 Vivek Haldar 역링크 16개는 통합된 [Vivek Haldar 서지 허브](https://notes.junghanacs.com/bib/20250416T184305/)로 이관했다.
...
-   [2026-07-13 W28 저널](https://notes.junghanacs.com/journal/20260713T000000/) — 2026-07-17 원석과 하루의 구현 시간축.
-   [Zenn Qiita 일본 기술 블로그 서비스 VSCode zenn-cli](https://notes.junghanacs.com/bib/20240926T201736/) — 저장소·CLI·편집기에서 서비스로 이어지는 일본의 선행 사례.
-   [라이팅허브: 깃허브 기반 글쓰기 저장소](https://notes.junghanacs.com/notes/20230719T172600/) — 2023년의 문제 제기.
-   [힣: 프로젝트 라이팅허브 — 특별한 글쓰기 저장소](https://notes.junghanacs.com/notes/20230720T061300/) — Zenn을 참고해 구상한 한국어 쓰기통.
-   [블로그 글쓰기 서비스 국내외](https://notes.junghanacs.com/notes/20230710T170200/) — 국내 GitHub 직접 출판 서비스의 빈자리를 묻던 노트.
-   [박응용 위키독스](https://notes.junghanacs.com/bib/20250115T155735/) — 국내 출판 서비스로서의 위키독스와 당시 업로드 경계.
-   [쿼츠 디지털가든 설치 — Org Hugo Quartz 파이프라인](https://notes.junghanacs.com/notes/20230811T092200/) — 원본 가든이 만들어진 출판 시간축.
...
-   [라이팅허브: 깃허브 기반 글쓰기 저장소](https://notes.junghanacs.com/notes/20230719T172600/) — “깃허브 글쓰기 관리 도구가 필요한 게 아닐까.”
-   [힣: 프로젝트 라이팅허브 — 특별한 글쓰기 저장소](https://notes.junghanacs.com/notes/20230720T061300/) — Zenn을 베이스로 저장소·CLI·린터·출판을 하나의 쓰기통으로 묶으려 했다.
-   [블로그 글쓰기 서비스 국내외](https://notes.junghanacs.com/notes/20230710T170200/) — “국내에는 GitHub 리포지토리를 바로 퍼블리시해 주는 서비스가 없는 것 같다”고 물었다.

2024년에는 [Zenn Qiita 일본 기술 블로그 서비스와 CLI](https://notes.junghanacs.com/bib/20240926T201736/)를 따로 모았다. 일본에는 저장소와 CLI, 편집기를 출판 서비스에 직접 연결하는 문화가 이미 자리 잡고 있었다. Zenn CLI와 Qiita CLI는 글을 웹 편집기 안에 가두지 않고, 자기 저장소와 도구에서 작성한 뒤 서비스로 보낼 수 있게 했다.

2025년의 [박응용 위키독스](https://notes.junghanacs.com/bib/20250115T155735/) 노트는 위키독스를 “국내에서는 이만한 서비스가 없다. 대체 불가”라고 보면서도 업로드의 불편을 적었다. 그리고 2026년, 위키독스에 GitHub 연동이 들어오면서 오래 비어 있던 마지막 고리가 생겼다.
...
## [2026-07-19 Sun] 500페이지 가드 — 미러 갱신 잠정 중단
