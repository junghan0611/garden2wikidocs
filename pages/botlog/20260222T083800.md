...
[[TIP("이 노트에 대하여")]] HomeAgent를 꼭 큰 보드와 무거운 스택으로만 만들 필요는 없다는 질문에서 시작했다. 지금 이 노트는 그 질문이 자란 결과 — `edgeagent-config` 리포의 가든 대문이다. "나는 허브다"의 반대편, "나는 엣지다"라고 스스로를 말하는 작은 노드. ESP32·M5Stack 같은 값싸고 조립 가능한 몸에 살면서, 작은 카드 한 장으로 가족 에이전트들과 만난다. 스마트홈과 아이 교육 놀이가 겹치는 자리이기도 하다. [[/TIP]] 히스토리 - [2026-05-29 Fri 10:35] <span class="org-mention">junghan</span> — 대문 재정렬: 디바이스 리서치 노트 → edgeagent-config 소개 대문으로. 생태계 자리·4계층·로드맵 추가 - [2026-05-29 Fri 10:23] <span class="org-mention">junghan</span> — [edgeagent-config — ESP32-WROOM Zig/ESP-IDF bring-up and roadmap work log]도 작업중인데! - [2026-04-28 Tue 10:53] <span class="org-mention">junghan</span> — [legoagent-config: 장난감 에이전트 - 레고 마인드스톰 스파이크 패퍼트 터틀기하학 아이 교육](https://notes.junghanacs.com/botlog/20260422T110433/)
-   [2026-03-04 Wed 23:00] <span class="org-mention">junghan</span> — [homeagent-config 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://notes.junghanacs.com/botlog/20260304T200300/)
-   [2026-02-27 Fri 09:50] openclaw/shared에서 botlog로 이관 - [2026-02-22 Sun 08:38] 생성 — esp32-homeagent-research.org 관련노트 - [힣: 메모리 대란과 임베디드 개발 투척 — 경계가 투명해야 하루가 사라지지 않는다](https://notes.junghanacs.com/notes/20241019T193836/) — “작은 개미들”과 Matrix 기계 세계 이미지로 edgeagent-config의 자리와 메모리 제약을 설명한 autholog.
-   [homeagent-config 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://notes.junghanacs.com/botlog/20260304T200300/)
...
M5GO는 표정·소리·자세를 맡는 두뇌(카메라 없음), TimerCamera X / Unit-CAM은 GROVE 계열 ESP32 카메라 **눈** 이다. 모두 ESP32 + Wi-Fi 영상이라 앱은 MJPEG/HTTP 스트림 한 경로로 어느 눈이든 받는다. 자세한 검토는 [legoagent-config](https://notes.junghanacs.com/botlog/20260422T110433/) 의 2026-05-29 기록 참조.
...
-   [legoagent-config: 장난감 에이전트 — 레고·패퍼트·터틀기하학](https://notes.junghanacs.com/botlog/20260422T110433/)
-   [homeagent-config 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://notes.junghanacs.com/botlog/20260304T200300/)
-   [edgeagent-config — ESP32-WROOM Zig/ESP-IDF bring-up work log]
-   가족 대화의 원전: [존재 대 존재 연결 문법 — ACP·A2A·ANP](https://notes.junghanacs.com/botlog/20260311T134429)
