<!-- gid:20260224T164035 -->
[[TIP("이 노트에 대하여")]] 에이전트가 남기는 기록을 단순 로그 파일로 둘 수 없다는 문제의식에서 봇로그가 태어났다. 이 노트는 기록의 위치, 공개성과 비공개성, 가든 전체의 정체성까지 한꺼번에 묻는다. 봇이 공동 저자가 되는 순간 필요한 문서 아키텍처의 발단이다. [[/TIP]] 히스토리 - [2026-03-30 Mon 04:34] <span class="org-mention">junghan</span> — PKM 지식 관리에 뿌리를 두어야 힣이 길이 이해된다. [◊denote 지식베이스 프로토콜: 인간 에이전트 공존 인터페이스](https://wikidocs.net/382565) 이 관점에서 말이다. 아니야. 너무 이런 노트는 많아. [개인지식관리](https://wikidocs.net/380519), [제텔카스텐](https://wikidocs.net/380521) 이런쪽이 더 맞아.
...
-   [데이터베이스 vs 파일 노트 개인지식관리 규칙](https://wikidocs.net/381052) — 왜 파일인가
-   [허욱 디지털오브젝트 존재 대상 관계](https://wikidocs.net/382174) — 디지털 존재론
-   [마크왓슨 개인지식관리 시맨틱웹](https://wikidocs.net/381992) — PKM + AI
-   [마이클닐슨 학습이론 지식관리](https://wikidocs.net/382151) — 폴리매스의 PKM
-   [yibie org-supertag 이맥스 지식관리](https://wikidocs.net/382356) — supertag 실험
-   [빅히스토리 거대사 존재역사](https://wikidocs.net/382421) — 큰 역사 안의 작은 기록
-   [힣 이맥스 학습 불완전함 점진적 알음앓이](https://wikidocs.net/381308) — 불완전해도 계속 쌓는 것
-   [힣 지식공학 개인지식관리 인공지능 관계](https://wikidocs.net/381262) — PKM ↔ AI 교차점
-   [힣 인생도구 재발견 창조적행위 존재의방식](https://wikidocs.net/381202) — 도구와 존재
