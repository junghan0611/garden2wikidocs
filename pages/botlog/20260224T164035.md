...
-   [2026-03-30 Mon 04:34] <span class="org-mention">junghan</span> — PKM 지식 관리에 뿌리를 두어야 힣이 길이 이해된다. [◊denote 지식베이스 프로토콜: 인간 에이전트 공존 인터페이스](https://wikidocs.net/382565) 이 관점에서 말이다. 아니야. 너무 이런 노트는 많아. [개인지식관리](https://notes.junghanacs.com/meta/20230919T132700/), [제텔카스텐](https://notes.junghanacs.com/meta/20230926T135400/) 이런쪽이 더 맞아.
...
-   [힣 AI 시대에 왜 개인은 더 지식에 목마른가](https://wikidocs.net/381018) (2022)
-   [힣 ADHD AI 시대 해방에서 경계까지](https://wikidocs.net/381022) (2022)
-   [힣 원샷 러닝 어려운 문제를 해결하는 핵심 학습 전략](https://wikidocs.net/381024) (2022)
-   [힣 이맥스 학습 의미 1년 시간 마스터](https://wikidocs.net/381042) (2022)
-   [힣 영성 알아차림 마음챙김 훈련 도구 창조적 인간론](https://wikidocs.net/381051) (2023)
-   [힣 개인지식관리 이야기](https://wikidocs.net/381060) (2023)
-   [힣 아무도 읽지 않는 블로그 디지털가든 왜 공개 하는가](https://wikidocs.net/381520) (2025)
-   [힣 디지털가든 불완전함에서 창조가 나오는 곳](https://wikidocs.net/381586) (2025)
-   [힣 느린 창조 도구 커뮤니티 불완전함 수용 자각](https://wikidocs.net/381731) (2025)

이건 실패의 역사이자 진화의 기록이다. 도구는 바뀌었지만(org-roam → denote, Claude → Pi) 질문은 같다: **"인간과 도구의 관계는 무엇인가?"**

#### 존재 대 존재로의 수렴

-   [존재대존재 오케스트레이션 서브에이전트 설계](https://wikidocs.net/381817) — AI를 작업자가 아닌 존재로
-   [존재대존재 협업 SDD 패러다임](https://wikidocs.net/381833) — 협업의 철학적 기반
...
| memex-kb  | [힣 memex-kb 범용 지식베이스 변환](https://wikidocs.net/381806)                                               | 내보내기/변환 파이프라인 |
| 어쏠로그  | [어쏠로그](https://wikidocs.net/380758)                                                                       | 힣의 정체성: 저자이자 기록자 |
| AI노트    | [힣 AI노트 지식도구 핵심 질문과 답변](https://wikidocs.net/381708)                                             | AI가 노트를 쓴다면?    |
...
-   [힣 노트테이킹 유니코드 기호 파일명](https://wikidocs.net/381471) — 유니코드 접두사 전체 목록
-   [힣 디지털가든 분류체계 규칙](https://wikidocs.net/381143) — 분류법의 원본 (2023~, 지속 업데이트)
-   [힣 개인지식관리 역사](https://wikidocs.net/381206) — PKM 여정 기록
