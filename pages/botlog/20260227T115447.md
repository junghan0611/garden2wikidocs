<!-- gid:20260227T115447 -->
[[TIP("이 노트에 대하여")]]
에이전트도 시간축 위에 살아야 한다는 생각에서 출발한 어젠다 설계다. DB 없이 파일만으로, 멀티디바이스 환경에서도 최신 기록을 앞에 쌓고 org-agenda로 함께 읽는 구조를 만든다. 인간과 봇의 하루가 같은 화면에 놓이기 위한 토대다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/botlog/20260227T115447/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2026-02-27T11:54:00+09:00`
- 최근 수정: `2026-02-27T11:54:00+09:00`
[[/TIP]]
...
[봇-활동-기록-아키텍처와-힣노트-역사성-고찰](https://notes.junghanacs.com/botlog/20260224T164035/)에서 멀티에이전트 쓰기 문제를 다뤘다. 거기서 "파일 분리 + 쓰기 규약"이 현실적 답이라 했는데, 여기서 한 발 더 나간다: **에이전트 활동을 org-agenda로 보자.**
...
-   [에이전틱코딩 라이브코딩 에이전트코딩](https://notes.junghanacs.com/meta/20250209T203153/) — 에이전트 코딩 메타
