...
[봇-활동-기록-아키텍처와-힣노트-역사성-고찰](https://wikidocs.net/382543)에서 멀티에이전트 쓰기 문제를 다뤘다. 거기서 "파일 분리 + 쓰기 규약"이 현실적 답이라 했는데, 여기서 한 발 더 나간다: **에이전트 활동을 org-agenda로 보자.**
...
[에이전트를 이맥서로 만드는 방향](https://wikidocs.net/382548)에서 핵심 통찰이 나왔다. xenodium(Alvaro Ramirez)의 [emacs-skills](https://github.com/xenodium/emacs-skills)가 열어준 "세 번째 인터페이스".
...
-   [봇-활동-기록-아키텍처와-힣노트-역사성-고찰](https://wikidocs.net/382543) — 이 문서의 전편
...
-   [에이전트를 이맥서로 만드는 방향](https://wikidocs.net/382548) — emacsclient 접근법, xenodium emacs-skills
