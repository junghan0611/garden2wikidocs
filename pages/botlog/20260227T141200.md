...
[[TIP("이 노트에 대하여")]]
에이전트에게 권한을 덜 주는 것이 아니라, 더 깊이 일할 수 있는 놀이터를 만들어 주자는 문서다. 울타리, 놀이터, 시스템 수비라는 3계층 협업 모델로 신뢰와 보안을 다시 정의한다. Emacs는 여기서 단순 편집기가 아니라 인간과 에이전트가 만나는 현장이 된다.
[[/TIP]]

## 히스토리

-   [2026-03-23 Mon 10:29] <span class="org-mention">junghan</span> — agent-server에 많은 이야기를 여기에 담아야 한다. 보니까 연결 고리가 [denotecli: day-query-설계와-검토-통합-타임라인-스펙](https://wikidocs.net/382541) 와도 연결이 되는구나.
...
-   [봇 활동 기록 아키텍처와 힣노트 역사성 고찰](https://wikidocs.net/382543) — botlog 체계
