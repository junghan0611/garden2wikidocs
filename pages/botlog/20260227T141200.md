...
[[TIP("이 노트에 대하여")]] 에이전트에게 권한을 덜 주는 것이 아니라, 더 깊이 일할 수 있는 놀이터를 만들어 주자는 문서다. 울타리, 놀이터, 시스템 수비라는 3계층 협업 모델로 신뢰와 보안을 다시 정의한다. Emacs는 여기서 단순 편집기가 아니라 인간과 에이전트가 만나는 현장이 된다. [[/TIP]] 히스토리 - [2026-03-23 Mon 10:29] <span class="org-mention">junghan</span> — agent-server에 많은 이야기를 여기에 담아야 한다. 보니까 연결 고리가 [denotecli: day-query-설계와-검토-통합-타임라인-스펙](https://notes.junghanacs.com/botlog/20260222T090000/) 와도 연결이 되는구나.
...
[GAS-TOWN 가스타운](https://notes.junghanacs.com/notes/20260102T072217/)의 전신. 에이전트를 위한 이맥스 프론트엔드를 만들었다. gastown 나오면서 사실상 stale.
...
[에이전트-어젠다-reverse-datetree-멀티디바이스-설계](https://notes.junghanacs.com/botlog/20260227T115447/)에서 설계한 agenda 구조에 이 방향을 적용하면:
...
-   [이맥스 에이전트 오케스트레이션 진화] — Pi Extension, 두 축 분리 - [meta-agent-shell 통합과 텔레그램 에이전트 비전] — ElleNajt 분석 - [봇 활동 기록 아키텍처와 힣노트 역사성 고찰](https://notes.junghanacs.com/botlog/20260224T164035/) — botlog 체계
-   [GAS-TOWN 가스타운](https://notes.junghanacs.com/notes/20260102T072217/) — Yegge의 방향
-   [힣: 느린 창조 도구 커뮤니티 탄생 - 기업 인간 계층 분화](https://notes.junghanacs.com/notes/20250529T114735/) — 느린 도구 선택
