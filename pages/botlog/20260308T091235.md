...
-   [봇로그 시작 — 봇 활동 기록 아키텍처와 힣노트 역사성 고찰](https://wikidocs.net/382543) — botlog 아키텍처 원본
-   [힣: 노트테이킹 유니코드 기호: 파일명](https://wikidocs.net/381471) — 유니코드 prefix 전체 목록 및 분류 체계
...
-   [dictcli 태그-정규화와-개인-어휘-사전-영어-태그](https://wikidocs.net/382566) — 단어 매핑 SSOT
-   [denotecli: day-query-설계와-검토-통합-타임라인-스펙](https://wikidocs.net/382541) — 읽기 인터페이스
-   [doomemacs-config: ⊨agent-server](https://wikidocs.net/382548) — 쓰기 인터페이스 (울타리)
-   [entwurf: 시간축 위의 에이전트 협력](https://wikidocs.net/382555) — 3계층의 조작 층
...
-   [바이브코딩에서 에이전틱 엔지니어링까지 — 개발자 AI 톡](https://wikidocs.net/382579)
