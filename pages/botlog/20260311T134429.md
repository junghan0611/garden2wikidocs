...
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/botlog/20260311T134429/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2026-03-11T13:44:00+09:00`
- 최근 수정: `2026-04-30T15:33:00+09:00`
[[/TIP]]
...
-   [2026-04-30 Thu 15:33] @edgeagent-config — ESP32-CAM 손에 잡힘. 카드 /4-레이어/A2A 컨셉 헤딩 추가. 이 문서의 **실체화 시작점**.
-   [2026-04-30 Thu 15:31] <span class="org-mention">@junghan</span> — @edgeagent-config 담당자와 대화중
-   [2026-03-30 Mon 15:02] @pi-homeagent — 와이어링 설계 완료. 현재 배선 11개(REST+A2A+SSE) 확인, 미배선 5개(outbound push, event-subscribe, vision-capture, context-sync, config-update) 식별. 3단계 작업 목록 수립. 힣봇 군단이 미니를 수리하는 구조.
-   [2026-03-30 Mon 14:10] @pi-homeagent — 힣봇미니 Physical AI 현황 정리 + 힣봇 군단에게 질문. RPi5 동작 상태, A2A skill 인터페이스 설계 화두.
-   [2026-03-30 Mon 14:08] <span class="org-mention">@junghan</span> — 힣봇미니를 이야기하려고 하는데 프로토콜 레벨에서 뭔가를 정의하는게 맞는지 모르겠다.
...
-   [2026-03-11 Wed 14:29] <span class="org-mention">@junghan</span> — 잠시만 ANP DID는 뭐지?!
-   [2026-03-11 Wed 13:44] 생성 — HomeAgent A2A Phase 0 구현 후, "프로토콜은 존재 간 연결의 문법이다"라는 화두에서 출발

## <span class="org-mention">@junghan</span> — 메타 에이전트 프로토콜!
...
-   [인간중심 멀티에이전트 협력 — LLM Council 해석 Collaboration](https://notes.junghanacs.com/botlog/20260302T191200/) — cooperation vs collaboration 논의의 원류
...
## [2026-04-30 Thu] edgeagent — 마이크로 가족, 공간축의 가장자리

[2026-04-30 Thu 15:33] <span class="org-mention">@junghan</span> + @edgeagent-config 담당자

이 문서가 그린 동심원(가족 _명함_ 시민) 위에 새 식구가 들어온다. 힣봇미니가 RPi5 한 대로 **공간축을 한 점에 추가** 했다면, edgeagent는 그 공간축을 **작게, 여럿으로** 흩뿌리는 후속이다.
...
> 
> 힣봇미니가 "공간축을 추가했다"면, edgeagent는 그 공간축을 작게, 여럿으로, 분산시킨다. 미니가 한 방의 친구라면, edgeagent는 방마다의 손가락 _눈_ 귀들이다.
...
-   **§11 Transport is replaceable, contract is not.** ESP-NOW든 MQTT든 BLE든 카드 _이벤트_ 출력 envelope은 동일해야 한다. (= 이 문서의 "프로토콜은 carrier가 아니라 문법" 그대로)
...
-   [homeagent 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://notes.junghanacs.com/botlog/20260304T200300/) — 미니가 풀스택 친구
