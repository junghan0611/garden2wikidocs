...
-   [인간중심 멀티에이전트 협력 — LLM Council 해석 Collaboration](https://wikidocs.net/382555) — cooperation vs collaboration 논의의 원류
-   [프로파일링 너머의 담금질 — 존재대존재 공진화 야화](https://wikidocs.net/382549) — "존재 대 존재"의 철학적 기반
-   [에이전트를 이맥서로 만드는 방향 — 워크플로우 공유와 존재대존재](https://wikidocs.net/382548) — 공유 파일시스템 기반 내부 프로토콜
-   [딥시크 대화 분석 — 일관성의 비밀과 에이전트 협업 멤버 가능성](https://wikidocs.net/382556) — 에이전트의 "색깔"
-   [homeagent 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://wikidocs.net/382560) — HomeAgent 기술 로드맵
...
-   [인간중심 멀티에이전트 협력 — LLM Council 해석 Collaboration](https://wikidocs.net/382555)
...
-   [homeagent 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://wikidocs.net/382560) — 미니가 풀스택 친구
