<!-- gid:20260312T174622 -->
[[TIP("이 노트에 대하여")]]
이 문서는 한 리포의 변경 내역이 아니라, 힣봇 생태계의 인프라 허브가 어떻게 자라났는지 보여준다. 스킬, 확장, 세션 검색, dictcli, 멀티하네스, 세션 리캡이 하나의 운영 체계로 묶인다. 에이전트 협업의 현실적인 뼈대가 만들어진 과정이다.
[[/TIP]]
...
- 최근 수정: `2026-03-20T11:33:00+09:00`
[[/TIP]]
...
-   [2026-03-14 Sat 14:12] <span class="org-mention">junghan</span> — 작업 이어가려고 한다. 스타벅스 잠시 들림 [dictcli 태그-정규화와-개인-어휘-사전-영어-태그-500워드-가이드-구상](https://notes.junghanacs.com/botlog/20260309T194058/) 이 노트와 연결해서 생각해봐야해요.
...
| 항목                  | 가격                      |
|---------------------|-------------------------|
| 텍스트 임베딩         | 0.20 달러 / 1M 토큰       |
| Batch API             | 0.10 달러 / 1M 토큰 (50% 할인) |
| 이미지 _오디오_ 비디오 | Gemini API 미디어 토큰 요금 |
| 기존 Text Embedding 004 | 0.025 달러 / 1M 토큰 (텍스트 전용) |
...
-   Denote 3000개 전체 임베딩해도 1 달러 미만 추정
...
-   `extraPaths` 에 `~/org/notes` 추가 → Denote 3000+ 노트 시맨틱 검색 (비용 1 달러 미만 추정)
...
| 항목             | 비용             |
|----------------|----------------|
| 초기 인덱싱 (625K 토큰) | 0.13 달러        |
| 월간 증분        | 0.02 달러        |
| 검색 쿼리        | 0.006 달러       |
| Jina rerank      | 0 달러 (무료 티어) |
| **월 합계**      | **&lt; 0.03 달러** |
...
| 모델               | $/1M        | 컨텍스트 | 차원     | 한국어    |
|------------------|-------------|------|--------|--------|
| Qwen3 Embed 4B     | 0.02 달러   | 32K    | 2048     | ★★★★★     |
| OpenAI 3-small     | 0.02 달러   | 8K     | 1536     | ★★★★      |
| OpenAI 3-large     | 0.13 달러   | 8K     | 3072     | ★★★★★     |
| Gemini Embed 001   | 0.15 달러   | 20K    | 3072     | ★★★★★     |
| **Gemini Embed 2** | **0.20 달러** | **8K** | **3072** | **★★★★★** |

비용은 전부 무시 수준 (월 0.14 달러). 최상의 결과 → **Gemini Embed 2**. Matryoshka 절삭, 멀티모달, 네이티브 taskType 지원까지.
...
-   [삽질 연대기 2008-2026](https://notes.junghanacs.com/botlog/20260302T130000/)
...
-   [dictcli 태그-정규화와-개인-어휘-사전](https://notes.junghanacs.com/botlog/20260309T194058/) — CAPE/CAPF 설계가 담긴 봇로그
