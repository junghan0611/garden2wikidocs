...
[[TIP("이 노트에 대하여")]] 흩어진 에이전트 지침서를 한데 모아, 어떤 하네스 위에서 협업하는지 다시 고정하는 문서다. 스킬 문서와 AGENTS.md의 일관성을 확보하고, 다른 학교 출신 에이전트들이 와도 힣의 중심축을 잃지 않게 한다. 정체성과 운영 규칙을 동시에 보존하는 원본 창고다. [[/TIP]] 프롤로그 - [2026-04-03 Fri 08:35] 스킬 문서와 에이전트 문서 일관성을 확보하고, 효율성을 끌어 올리기 위한 작업. 그리고 다른 학교 출신의 에이전트들 사이에서 힣의 정체성을 유지하면서 [프로파일 하네스 — 외계지능과 공명하는 존재의 구심점](https://notes.junghanacs.com/botlog/20260228T075300/)을 세워서 협업 하는 환경을 구축하는 명세서임 SSOT 파일입니다.

## 히스토리

-   [2026-04-03 Fri 08:29] <span class="org-mention">junghan</span> — org AGENTS.md 옮김. 어제 지피티랑 영문화함. - [2026-04-03 Fri 08:24] <span class="org-mention">junghan</span> — sLLM 이야기는 그다지 별거 이야기는 빼고 다른걸로 담자. [homeagent-config 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼](https://notes.junghanacs.com/botlog/20260304T200300/) 여기로 원래 문서 옮김.
