...
[[TIP("이 노트에 대하여")]] 알림만 보내는 구조를 넘어, 분신과 로컬 에이전트들이 실제로 대화하고 제어할 수 있는 길을 그린다. 텔레그램 DM, tdlib 직접 접근, pi IPC, 릴레이와 보안 경계가 어떻게 포개지는지 층별로 정리한다. 힣맨 유니버스의 통신 배선도를 공개한 셈이다. [[/TIP]] 히스토리 - [2026-04-06 Mon 10:19] <span class="org-mention">junghan</span> — [에이전트 전환 분신 가이드 — 힣봇클로드에서 pi-entwurf로](https://wikidocs.net/382590) 이거 전달하면서 이 문서에 새로 적었다.
