...
[[TIP("이 노트에 대하여")]] 이 노트는 andenken을 중심에 두고, Karpathy의 llm-wiki(개인 실천)·Google의 OKF(조직 표준)·Andrew Hyatt의 EKG(이맥스 커뮤니티)라는 세 외부 조류가 어떻게 내가 18년 서 있던 PKM-AI 자리로 수렴하는지 정리한다. 따라가기 위해서가 아니라, 알아두면 고도화의 전략적 유연성이 되기 때문이다. [[/TIP]] 히스토리 - [2026-06-19 Fri 09:04] claude — botlog로 격상(llmlog→botlog) + andenken 중심으로 전면 재작성. Karpathy 원본 SSOT 축에서 "내 자리로 수렴하는 세 조류" 축으로 전환. ahyatt(EKG/semext)·OKF·ROSSE·지식그래프 씨앗 연결 강화. denote ID 보존. - [2026-04-06 Mon 14:10] <span class="org-mention">junghan</span> — 지피티 힣에게 전달 - [2026-04-06 Mon 14:04] 생성 — Karpathy LLM Wiki gist 원본(SSOT) + 댓글 분류 + 힣 관점 기록 관련메타 - [ 카파시조어 — 바이브코딩·샤디드싱킹·LLMWiki·소프트웨어3.0](https://notes.junghanacs.com/meta/20250328T074505/) — 카파시 어휘 자석

## 관련노트

-   [andenken — 존재의 뜻새김, 시맨틱 메모리를 넘어서](https://notes.junghanacs.com/botlog/20260319T110800/) — andenken의 정체성
-   [andenken 이맥스 임베딩 검색](https://notes.junghanacs.com/notes/20250214T145633/) — andenken의 원류
-   [에이전트 기억층 — 누가 기억의 주인인가](https://notes.junghanacs.com/botlog/20260408T120252/) — 기억의 주인 질문
-   [ahyatt EKG llm calc 이맥스 지식그래프 구루](https://notes.junghanacs.com/bib/20250415T185955/) — 스승의 지식그래프
-   [ahyatt semext embed-db 시맨틱 임베딩 확장](https://notes.junghanacs.com/notes/20250528T114254/) — 스승의 시맨틱 패키지
-   [힣 원석을 날것으로 휘갈긴다 — POSSE 너머 ROSSE](https://notes.junghanacs.com/notes/20250324T110312/) — 날것 입력, OKF/llm-wiki 언급 원장면
-   [안드레이 카파시 — 바이브코딩 인공지능](https://notes.junghanacs.com/bib/20250619T155352/) — Karpathy bib
-   [디지털가든 시맨틱 연결 고도화 방안](https://notes.junghanacs.com/botlog/20260404T145500/) — 힣봇군단이 llm-wiki 읽고 정리
-   [지식그래프·RAG의 의미 전환 — LLM 보조에서 분신의 기억으로](https://notes.junghanacs.com/notes/20250214T145957/) — RAG→기억 전환
-   [개인지식그래프 personal knowledge graphs](https://notes.junghanacs.com/bib/20240720T062600/) — PKG 씨앗
-   [삽질 연대기 2008-2026](https://notes.junghanacs.com/botlog/20260302T130000/) — 18년의 시간
