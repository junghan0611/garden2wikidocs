...
-   [WezTerm SSH tmux Emacs 터미널 통합 — OSC 52 클립보드 한영키 truecolor] - [터미널 이맥스 한글 입력 삽질기 — kime→fcitx5→term-keys→wezterm 해결] - [emacs terminal-name /dev/tty 문제 조사] - [존재 간 연결의 문법 — ACP A2A ANP 그리고 힣봇 생태계](https://wikidocs.net/382569)
-   [OpenClaw ACP 재정비 다음턴 진입가이드] - [힣: 이맥스 학습 의미 - 도구 효율성 가치](https://wikidocs.net/381068)
