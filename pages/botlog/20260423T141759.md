...
-   [pi-shell-acp 에이전트 통합 연결 프로젝트 작업로그] — 최신 작업로그 + Layer 0~4 검증 질의서 - [pi-claude-acp 하네스 인계와 능력 노출 경계] — 능력 boundary 초기 설계 - [pi-shell-acp 전환 설계안 — bespoke bridge에서 표준 acp로] — 전환 결정 - [agent-config 하네스 전환 — claude-agent-sdk pi non-append] — 하네스 철학 - [기억공고화 — 에이전트 회상 주입과 장기기억 승격 루프](https://wikidocs.net/382593) — 턴 누적 품질 문제의 구조적 원인
