...
-   [나오미배런 읽기 쓰기의 미래 - 언어학자](https://notes.junghanacs.com/bib/20250324T034547/)
-   [맥스베넷 지능의 기원 - 우리의 뇌 그리고 AI를 만든 다섯 번의 혁신](https://notes.junghanacs.com/bib/20250324T033847/)
-   (susam 2025)
...
[LLM: Warning (emacs): Org version mismatch.](https://notes.junghanacs.com/notes/20250224T210015/) 실마리를 잡았는데, 건들지 말라는 것. 기본에서 건드니까 발생하는 문제라는 것
...
### 13:33 [Lex Friedman 팟케스트(ThePrimeagen 인터뷰) - Emacs vs. NeoVIM (feat. ADHD)](https://notes.junghanacs.com/notes/20250326T135916/)

### 14:12 [POSSE 블로깅 전략 - 디지털가든 - 인디웹 - 공유](https://notes.junghanacs.com/notes/20250324T110312/)
...
### 17:02 [jira 프로젝트 관리 협업 - 이맥스](https://notes.junghanacs.com/notes/20250326T170451/) 이것이 눈에 들어왔다
...
[2025-03-27 Thu 10:55] [LLM: JVM 자바가상머신 - 코틀린 클로저](https://notes.junghanacs.com/notes/20250327T110315/) [코틀린](https://notes.junghanacs.com/meta/20250327T094135/)과 클로저 자바 가상머신의 미래에 대한 생각

### 11:18 버그픽스 필요 - vertico childframe

[LLM: marginalia vertico-multiform - sort-modified - emacs](https://notes.junghanacs.com/notes/20250327T123531/)

### 13:04 [defrecord - 클로저 하이랭 조직모드 이맥스 LLM](https://notes.junghanacs.com/bib/20250327T134019/)
...
-   [비욘나티코 내가틀릴수도있습니다 숲속 현자 인생수업 루게릭병](https://notes.junghanacs.com/bib/20241203T132944/)

## 2025-03-28 Fri

-   [이맥스 팝업 레이아웃 창관리](https://notes.junghanacs.com/notes/20231125T083342/)
...
[khoj-ai: personal AI second brain](https://notes.junghanacs.com/notes/20250214T145633/) ![](../../assets/20250328T090345-khoj-rag-test.png)
...
-   《그대들은 어떻게 살 것인가》(일본어: 君たちはどう生きるか 기미타치와 도 이키루카[\*])는 2023년 일본의 애니메이션 영화이다. 미야자키 하야오가 감독을 맡고 스튜디오 지브리에서 제작하였다. 2013년 영화 《바람이 분다》 이후 미야자키 하야오 감독의 10년만의 복귀작이다. 요시노 겐자부로의 소설 《그대들, 어떻게 살 것인가》로부터 작품의 제목을 따 왔지만, 원작을 직접적으로 각색한 것은 아니며, 이 소설이 주인공에게 큰 의미를 가진다는 형식으로 연관짓고 있다. 장르 자체는 모험 판타지로 소개되고 있다. 제96회 아카데미상 장편 애니메이션상 수상작이다. - 2024 Learn Anything - 무엇이든 배울 수 있는 뭔가다 [2025-03-28 Fri 02:19] (“Learn Anything” n.d.) 2024-09-12 이때 찾은것인데 또 만나네 learn-anything/books: Awesome Books (“Learn-Anything/Books: Awesome Books” n.d.) - - - - learn-anything/learn-anything (“Learn-Anything/Learn-Anything” [2016] 2024) - - - Organize world's knowledge, explore connections and curate learning paths - 2024 11:45 일단 무식하게 한 권은 좀 보자 지루해도 13:10 리스프로 통일하는 것 - 전체 프로그래밍 언어 클로저 하이랭 하나로 하위 인프라는 동일하게 가능하다. 하이랭 하나만 테스트 잘 될 것이다. 13:31 속쓰리다 부글부글 [나오미배런 (1946-) 읽기 쓰기의 미래 - 언어학자](https://notes.junghanacs.com/bib/20250324T034547/) 리딩

### 15:15 뚱이네 5500원 식사 - 집 왔다. 컨디션.

### 16:31 [aider 페어프로그래밍 이맥스](https://notes.junghanacs.com/notes/20250214T135245/) 개선하는 방법

(MatthewZMD 2025) 이녀석 탑재

### 17:47 [Cursor - The AI Code Editor](https://notes.junghanacs.com/bib/20250328T174028/) 알아야 넘는다.
...
[피터스콧-모건 나는 사이보그가 되기로 했다 - 루게릭 - 로봇공학](https://notes.junghanacs.com/bib/20250329T015544/)
...
1.  **범위와 특성**
    -   카테고리: 보다 넓은 주제나 분야를 나타냅니다. 웹사이트의 주요 섹션이나 "책의 장"과 같은 역할을 합니다[6]. - 태그: 더 구체적이고 세부적인 주제나 키워드를 나타냅니다. 콘텐츠의 특정 측면을 설명하는 데 사용됩니다[6]. 2. **구조** - 카테고리: 일반적으로 계층적 구조를 가질 수 있습니다. - 태그: 주로 비계층적이며, 더 자유롭게 사용됩니다. 3. **사용 방식** - 카테고리: 포스트당 하나 또는 소수의 카테고리만 할당하는 것이 일반적입니다. - 태그: 하나의 포스트에 여러 개의 태그를 자유롭게 할당할 수 있습니다[1]. 구현 측면 Hugo에서는 태그와 카테고리를 기술적으로 동일하게 취급합니다[4]. 둘 다 taxonomy로 구현되며, 콘텐츠 파일의 front matter에서 정의됩니다[2][5]. 예를 들어: ```yaml
---
title: "블로그 포스트"
categories: ["웹 개발"]
tags: ["Hugo", "정적 사이트", "블로그"]
---
``` 커스터마이징 태그와 카테고리에 대해 서로 다른 레이아웃을 적용하고 싶다면, 다음과 같이 별도의 템플릿 파일을 만들 수 있습니다[8]: - `/layouts/categories/terms.html` - `/layouts/tags/terms.html` 이렇게 하면 태그와 카테고리 페이지에 대해 서로 다른 디자인과 기능을 구현할 수 있습니다. 결론적으로, Hugo에서 태그와 카테고리의 주요 차이점은 그들의 사용 목적과 방식에 있으며, 기술적인 구현은 거의 동일합니다. 웹사이트의 구조와 콘텐츠 조직에 맞게 적절히 활용하는 것이 중요합니다. Citations: [1] <https://hugo-in-action.foofun.cn/docs/part1/chapter4/4/> [2] <https://staticmania.com/blog/hugo-taxonomy> [3] <https://www.jessicahuynh.info/blog/2020/06/hugo-taxonomies/> [4] <https://smhk.net/note/2018/03/hugo-tag-and-category-pages/> [5] <https://www.jakewiesler.com/blog/hugo-taxonomies> [6] <https://stackoverflow.com/questions/70149736/hugo-difference-between-tags-and-categories> [7] <https://discourse.gohugo.io/t/adding-tags-and-categories-to-blog-post/27020> [8] <https://discourse.gohugo.io/t/different-layout-for-tag-and-category-pages/34699> [9] <https://discourse.gohugo.io/t/i-dont-want-tags-and-categories/12091> [10] <https://discourse.gohugo.io/t/listing-tags-in-posts-of-specific-category/22391> [11] <https://www.youtube.com/watch?v=pCPCQgqC8RA> [12] <https://discourse.gohugo.io/t/whats-the-concept-of-the-categories-taxonomy/6486> [13] <https://discourse.gohugo.io/t/how-to-add-tag-and-category/3202> [14] <https://ox-hugo.scripter.co/doc/tags-and-categories/> [15] <https://discourse.gohugo.io/t/using-content-type-to-categorise-list-of-posts/7950> [16] <https://gohugo.io/content-management/taxonomies/> [17] <https://discourse.gohugo.io/t/hugo-isnt-making-different-pages-for-categories-and-tags/23786> [18] <https://aioseo.com/the-difference-between-tags-and-categories/> --- Perplexity로부터의 답변: pplx.ai/share 09:58 \*\* quartz 코드베이스에 taxonomy 분류로 category를 추가하려고해. 요청아이디: 8432adc5-15f0-4e6e-8895-69021c1baa1f Ran tool Quartz 프로젝트에서 taxonomy 관련 파일을 찾아봅시다. 먼저 quartz 디렉토리 내부를 살펴보겠습니다. Ran tool Quartz 프로젝트에서 taxonomy나 카테고리 관련 기능을 찾기 위해 더 깊이 살펴보겠습니다. 플러그인 디렉토리를 확인해보겠습니다. Ran tool transformers 디렉토리를 살펴보겠습니다. 여기에 taxonomy나 카테고리 관련 기능이 있을 수 있습니다. Ran tool `frontmatter.ts` 파일이 taxonomy 관련 기능을 다룰 가능성이 있습니다. 확인해보겠습니다. Read file: quartz/plugins/transformers/frontmatter.ts 이제 프로젝트 구성 파일인 quartz.config.ts 파일을 확인해보겠습니다. Read file: quartz.config.ts 이제 태그 관련 컴포넌트를 살펴봅시다. 태그와 카테고리는 유사한 기능을 수행하므로 이 부분을 확인하는 것이 도움이 될 것입니다. Ran tool 태그 페이지 구현을 확인해보겠습니다. Read file: /home/junghan/git/notes/quartz/plugins/emitters/tagPage.tsx 이제 TagContent 컴포넌트를 살펴봅시다. Ran tool TagContent 컴포넌트 내용을 확인해보겠습니다. Read file: /home/junghan/git/notes/quartz/components/pages/TagContent.tsx Quartz 프로젝트에 카테고리를 추가하기 위해 어떤 부분을 수정해야 하는지 파악했습니다. 태그와 유사한 방식으로 카테고리 기능을 구현할 수 있습니다. 아래와 같은 단계로 진행하겠습니다: 1. frontmatter.ts에 카테고리 관련 코드 추가 2. 카테고리 페이지 컴포넌트 만들기 (TagPage와 유사하게) 3. quartz.config.ts에 카테고리 페이지 플러그인 추가 먼저 frontmatter.ts를 수정하여 카테고리 필드를 추가하겠습니다: ```typescript:quartz/plugins/transformers/frontmatter.ts
// ... existing code ...
...
``` } CategoryContent.css = concatenateResources(style, PageList.css) return CategoryContent }) satisfies QuartzComponentConstructor ````text
...
```` components/index.ts 파일을 수정하여 CategoryContent를 추가해야 합니다: Ran tool Read file: /home/junghan/git/notes/quartz/components/index.ts 이제 CategoryContent를 components/index.ts에 추가합시다: ````typescript:/home/junghan/git/notes/quartz/components/index.ts
...
```` 마지막으로 quartz.config.ts 파일에 CategoryPage 플러그인을 추가해야 합니다: ````typescript:quartz.config.ts
// ... existing code ...
    emitters: [
      ...
      // ... existing code ...
```` plugins/index.ts 파일에 CategoryPage를 추가해야 합니다: Read file: /home/junghan/git/notes/quartz/plugins/index.ts 이제 plugins/emitters/index.ts 파일을 확인하고 CategoryPage를 추가해야 합니다: Read file: /home/junghan/git/notes/quartz/plugins/emitters/index.ts CategoryPage를 plugins/emitters/index.ts에 추가합니다: ````typescript:/home/junghan/git/notes/quartz/plugins/emitters/index.ts
export { ContentPage } from "./contentPage"
export { TagPage } from "./tagPage"
export { CategoryPage } from "./categoryPage"
export { FolderPage } from "./folderPage"
// ... existing code ...
```` quartz.config.ts의 generateSocialImages 에러를 해결합니다: Ran tool Read file: /home/junghan/git/notes/quartz/cfg.ts GlobalConfiguration에 generateSocialImages 필드가 없습니다. 해당 부분을 수정해야 합니다: ````typescript:quartz.config.ts
// ... existing code ...
    ...
    theme: {
      // ... existing code ...
```` 훌륭합니다! 이제 모든 필요한 파일을 생성하고 수정했습니다. 마지막으로 정리해 보겠습니다: 1. frontmatter.ts에 categories 필드를 추가했습니다. 2. CategoryContent.tsx 컴포넌트를 생성했습니다. 3. CategoryPage.tsx emitter를 생성했습니다. 4. components/index.ts 파일에 CategoryContent를 등록했습니다. 5. plugins/emitters/index.ts 파일에 CategoryPage를 등록했습니다. 6. quartz.config.ts 파일에 CategoryPage 플러그인을 추가했습니다. 이제 마크다운 파일의 frontmatter에 다음과 같이 카테고리를 추가할 수 있습니다: ````markdown
---
title: 문서 제목
...
문서 내용...
```` 또한 categories 디렉토리를 생성하여 개별 카테고리에 대한 설명 페이지를 추가할 수도 있습니다: ````sh
mkdir -p content/categories
```` 10:20 아내 등장 11:10 동네 빽다방 체크인 3시간 딥워크 아이더맥스로 가자. 13:51 집에가자 - RAG 실패 - hy 이상해 15:00 온생명 타이거 영어까페 - 자전거 타고 데리고 옴 3시간 딥워크 17:23 conda 쓸거야. [파이썬: 활용법: 미니콘다::콘다에서 필요한 패키지 설치](https://notes.junghanacs.com/notes/20240625T153507/) 설치해줘
...
[LLM: hyrule 설치 하이랭 플러그인](https://notes.junghanacs.com/notes/20250329T164150/) 아무튼 설치해서 했다.
...
[LLM: 파이썬 모듈 설치 전역 활용법](https://notes.junghanacs.com/notes/20250329T213644/) 이걸 준비했다.
