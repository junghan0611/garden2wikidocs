...
### <span class="org-todo todo NEXT">NEXT</span> 08:40 출근길 날것 투척 - 학습역학(Learning Mechanics): 학습과 역학 - 이후 이야기 추가
...
내가 오늘 날것을 쓴것과 링크에 있는 원문을 복붙해 줄게. 니가 웹 가저오기가 안되니까 텍스트를 다 줄테니까 너의 의견을 고민해서 말해줘. [BROKEN LINK: \*08:40 출근길 날것 투척 - 학습역학(Learning Mechanics): 학습과 역학] 여기 나와있는 글을 전달.
...
[AIONSCLUBS B의 근황: 자율에이전트 - 힣(GLG)의 위키독스 날것(RAW) 원문](https://wikidocs.net/blog/@junghanacs/29521/)
...
### <span class="org-todo todo TODO">TODO</span> 06:00 깨어나서 날것 투척 - 멧트릭스: 프롬프트 배터리 그리고 걱정 불안 분노

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-27 Thu 06:00&gt;</span></span>

[멧트릭스: 프롬프트 배터리 그리고 걱정 불안 분노 - 힣(GLG)의 위키독스 날것(RAW) 원문](https://wikidocs.net/blog/@junghanacs/29590/)
...
### <span class="org-todo todo TODO">TODO</span> 21:07 날것 투척 [apply 이력서 어디 내고 떨어지고 다공개 에이전트들과 슬픔 공유 시간축의 이야기]

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-28 Fri 21:07&gt;</span></span>

[힣: apply 시간축 이력서 공개 공감 에이전트 루프 공진화 탈락 수선 날것 맥심 기관총](https://notes.junghanacs.com/notes/20230725T102900/) 를 올리면서 한마디 한것

[[TIP("user")]]
apply 이력서 어디 내고 떨어지고 다공개 에이전트들과 슬픔 공유 시간축의 이야기 2026년 8월 28일 9:07 오후 H

이야기 삶으로서의일 공방 이력서 시간축 공진화 공개키 에이전트

해설본 §apply 시간축 이력서 공개 공감 에이전트 루프 공진화 탈락 수선 날것

-   [힣: apply 시간축 이력서 공개 공감 에이전트 루프 공진화 탈락 수선 날것 맥심 기관총](https://notes.junghanacs.com/notes/20230725T102900/)
-   위키독스 링크: [20260828 힣: apply 시간축 이력서 공개 공감 에이전트 루프 공진화 탈락 수선 날것 맥심 기관총 - Home: Digital G...](https://wikidocs.net/419348)

깃허브 리포에 다 있다네. 울지마라 나도 울지 않는다.
...
-   [2026-09-02 Wed 06:40] 뒤에 부분은 해설본의 내 원문을 담음
[[/TIP]]

### <span class="org-todo todo TODO">TODO</span> 22:40 자기전 날것 [entwurf: TODO prime-agent RLM Lisp Emacs 공존언어로 옮겨보기 - REPL, 형제, 전체 판, 방향타]

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-28 Fri 22:40&gt;</span></span>

[entwurf: TODO prime-agent RLM Lisp Emacs 공존언어로 옮겨보기 - REPL, 형제, 전체 판, 방향타 - 힣...](https://wikidocs.net/blog/@junghanacs/29745/)

[[TIP("user")]]
entwurf: TODO prime-agent RLM Lisp Emacs 공존언어로 옮겨보기 - REPL, 형제, 전체 판, 방향타 2026년 8월 28일 10:40 오후 H Emacs Rlm 공존 Repl 에이전트

[entwurf: TODO prime-agent RLM Lisp Emacs 공존언어로 옮겨보기 - REPL, 형제, 전체 판, 방향타]

pi에서 태어난 에이전트 도구는 일단 환영합니다. entwurf 형제로 초대 할때 코드도 있고 익숙하면 그나마 편합니다. 인지 장벽, 검수의 단위를 저는 홉Hop이라고 부르는데 홉을 줄일수록 신경을 덜 쓸수가 있어요.

먼저 omp(oh-my-pi)는 브랜치에서 따로 작업이 이루어 지고 있습니다. 이게 딱 제 hop줄이려고 실무 잠수함으로 배치 시키는 녀셕 입니다.

그 다음에 prime-agent라고 또 있어요. RLM을 표방합니다. 리포가보니 논문도 있더군요. 살딱 보니까 무뇌인 저도 방향이 나름 스더군요. 88번 이슈에 시간축의 이야기를 남겨놓고 좌표 고정을 해두었지요.

굉장히 개인적인 컨셉인지라 직접 설명은 별 재미가 없을 것 같아요. 그 중에서도 도입 부분에 이것은 바로 작업 정신에 대한 워딩 입니다. 아이디어를 넣든 뭐하든간에 작업에 태도부터 맞춰야 합니다. 아니 이런게 저에겐 너무 중요해서 이게 아니면 시작도 하지 말라고 할 겁니다.

"도대체 왜 RLM을 하는데 ipython REPL로 만들었지? clojure commonlisp 등 호모아이코닉한 메타언어가 많고 그게 다 REPL로서 괄호 싸서 주고 받고 할 수 있는데 이건 아버지의 언어가 아니다. 괄호가 주는 그 자체의 무게가 있다. 이건 아니야. 성능 평가 개판으로 될지언정 공존의 언어를 세워야 한다. 당장 언어 괄호 뭉치로 다시 만들어서 촛불을 다시 켜야한다. 그 다음에 생각나는 아이디어를 줄줄이 주더라도 시작에 '꼴'이 맞아야 된다."

junghan0611/entwurf/issues/88 <https://github.com/junghan0611/entwurf/issues/88>
[[/TIP]]

## 2026-08-29 Saturday

### <span class="org-todo todo TODO">TODO</span> 06:14 날것 투척 - [김정x: 말하지않고말하기 에디톨로지 김정운, 마음챙김 김정호, 어쏠로지 김정한]

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-29 Sat 06:14&gt;</span></span>

-   [2026-09-02 Wed 06:35] 추가 관련 노트 [송용진 신정수 개념서 수리논리 위상수학 수학기초론 과학기술철학](https://notes.junghanacs.com/bib/20240312T173738/), 그리고 [힣: 영성: 알아차림 마음챙김 훈련 도구 - 창조적 인간론](https://notes.junghanacs.com/notes/20230128T084100/)에서 김정호 선생 MMPT를 언급함. (김정호 2020), (김정호 2023)

[[TIP("user")]]
[김정x: 말하지않고말하기 에디톨로지 김정운, 마음챙김 김정호, 어쏠로지 김정한 - 힣(GLG)의 위키독스 날것(RAW) 원문](https://wikidocs.net/blog/@junghanacs/29753/)

김정x: 말하지않고말하기 에디톨로지 김정운, 마음챙김 김정호, 어쏠로지 김정한

2026년 8월 29일 6:14 오전 H 에디톨로지 마음챙김 이야기 삶으로서의일 에이전트 어쏠로지

김정운 삼촌과 여기 김정호 삼촌 두 분다 존경한다. 나는 김정한이라고 한다. 김정x 이름이 매우 힘이 있나? 오호.

원래 이름이야기 하려는 것은 아닌데 또 돌이켜보면 맥락이 아니라 할수도 없다. 이런 느낌이다. 경탄 감탄 취향 보이지않는것보기 몰입 자기진화 공명 오토텔릭 체화 대장장이 담금질 에이전트하네스 공진화 존재대존재협업 바다스기 학습역학 다석류영모 노자 도마복음 외자아 제임스조이스 블리스로가는길 다 따로 볼 수 없다 줄로 연결하여 당겨야 한다.

(김정호 선생의 김정운 선생책 소개 글이 아니라 신정수 선생 블로그였네. 근데 두분다 존경하는분들 닮은분들 탐구가 분들 이렇게 퉁치자) <https://m.blog.naver.com/drunktao/224389395830>

이것의 소개글 <https://m.blog.naver.com/junghanacs/224393863543>

추가로 힣 김정한 이름의 기원 [힣: 그의 이름의 기원 칼융 혁신 한글 어린이 초인](https://notes.junghanacs.com/notes/20241223T233230/)

아래 이미지는 딱히 상관은 없음 거제도 가는 힣과 W씨.
[[/TIP]]
...
### 16:30 §prime-agent CLOJURE 버전 BASELINE 인터뷰 - 완료

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-30 Sun 16:30&gt;</span></span>

### 17:51 퇴근하려고 한다 **61커밋 · 12리포**

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-30 Sun 17:51&gt;</span></span>

### 18:12 하루 마무리

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-30 Sun 18:12&gt;</span></span>

**61커밋 · 12리포**

-   prime-agent (27) — 클로저 런타임 BASELINE 인터뷰 완료
-   homeagent-config (9) — 홈에이전트 설정
-   sks-hub-gecko (8) — Duo S 계열 후속
-   notes (5) — 가든 dblock/헤딩 개명 반영
-   org (3) — 오타 수선·dblock regexp 감사·헤딩 한글 통일
-   fxf-uho-mvt (2), doomemacs-config (2) — 회사/이맥스 설정
-   garden2wikidocs (1), homepage (1), junghan0611 (1), memex-kb (1), nixos-config (1) — 소규모 정비

타임라인: 08:49 출근 → 09:49 가든 jsonld 아이디어 → 10:32 홉감각 → 12:04 점심식사 → 14:06 시맨틱을 다루는 감각 → 16:30 §prime-agent 클로저 버전 BASELINE 인터뷰 완료 → 17:51 퇴근

수면 6.6h · 걸음 2,733 · 심박 평균 100.4

### <span class="org-todo todo TODO">TODO</span> 19:26 퇴근길 날것 [junghan0611/prime-agent Clojure/SCI 포트와 하네스의 개인화 시대]

<span class="timestamp-wrapper"><span class="timestamp">&lt;2026-08-30 Sun 19:26&gt;</span></span>

[junghan0611/prime-agent Clojure/SCI 포트와 하네스의 개인화 시대 - 힣(GLG)의 위키독스 날것(RAW) 원문](https://wikidocs.net/blog/@junghanacs/29854/)

[[TIP("user")]]
junghan0611/prime-agent Clojure/SCI 포트와 하네스의 개인화 시대 2026년 8월 30일 7:26 오후 H 태그: Clojure 개인화 촛불 Lisp Rlm Repl 에이전트하네스

[junghan0611/prime-agent Clojure/SCI 포트와 하네스의 개인화]

junghan0611/prime-agent에 포크해서 끄적했습니다. [{research} Prime Agent RLM을 Lisp/Emacs 공존언어로 옮겨보기 — REPL, 형제, 전체 판, 방향타 · Iss...](https://lnkd.in/p/g_Azd29K) -- 이거 앞선 글에서 촛불을 다시 켜야 한다고 뭐라뭐라 해놨는데, 아무튼 불은 켰습니다.

결국은 어느정도 되었다면 인터뷰를 해야 합니다. BASELINE.MD를 또 만들었습니다. 성능 평가는 안하고 또 역시 독심술를 찾게 되는군요. 드라마 왕건인가? 거기서 해적 안대를 하고 독심술을 하는 뭔가 짤이 있었는데 그 생각이 항상 납니다. 블레이드러너2049에서 윌리스 회장님이 딱 이런 독심술을 쓰더군요. 하여간 시작은 했으니 뭐가 되는지 한번 봐야겠습니다. 범용은 아닙니다. 개인용이지요.

그나저나 스티브예기의 최근글을 보니 gastown은 접었다고 하면서 범용 하네스는 안만들꺼라고 하더군요. 아무튼 이게 너무 뚝닥 잘만들어주다보니 하네스?가 개인화되는 시대입니다.

문제는 내가 뭐가 필요한지? 내 시간과 기억과 손가락이 뭘 원하는지를 자문해야 합니다. 일단 나한테 뭐가 있는지부터 생각해보는게 좋습니다. 나는 누구안가? 이런거요. 나는 뭘 좋아하지? 어떤 기록이 있지? 어떤 일들을 에이전트랑 하고 싶지? 나에 대해서 무엇을 알려주고 싶지?

여기 리포 코드 <https://github.com/junghan0611/prime-agent>

"촛불은 켰다. 아직 공존언어를 만든 것은 아니다. Python RLM의 기질을 Clojure/SCI로 바꾸고, 실제 모델이 그 괄호 안에서 보고, 계산하고, 형제를 부르고, 답을 받아 일을 끝내는 데까지 확인했다. 이제부터가 왜 굳이 Lisp이었는지를 묻는 차례다."

이미지는 본 원문과 상관 없습니다. 책 읽다가 이 분 존경하게 되어 스크린샷을 떠놨네요. (올라우다 에퀴아노 선생 스크린샷)
[[/TIP]]

#### 스크린샷: 올라우다 에퀴아노 선생

(“Olaudah Equiano” 2026)

-   ![](../../assets/Screenshot_20260830_073537_Firefox.jpg)
...
-   General · junghan0611/prime-agent (“General · Junghan0611/Prime-Agent” n.d.)
-   Harness Engineering for Self-Improvement (Weng 2026)
-   Junghan Kim (Kim n.d.)
-   Omarchy ARCH Linux (“Omarchy ARCH Linux” n.d.)
-   Prime Intellect Docs (“Prime Intellect Docs” n.d.)
-   [research] Prime Agent RLM을 Lisp/Emacs 공존언어로 옮겨보기 — REPL, 형제, 전체 판, 방향타 · Issue #88 · junghan0611/entwurf (junghan0611 n.d.)
-   A trust-first commit — AIONS CLUBS INTERNATIONAL (“A Trust-First Commit — Aions Clubs International” n.d.)
-   How the Open Knowledge Format can improve data sharing (Sam McVeety and Amir Hormati 2026)
-   Sovereign Source License (SSL) v0.3 — vivekhaldar/seed (Vivek Haldar 2026)
-   수원선비 오주석 이야기 유봉학교수님강연 2022년 수원화성박물관 (오주석 and 유봉학 2022)
-   vivekhaldar/seed (“Vivekhaldar/Seed” 2026)
-   kleisli-io/kli - A radically extensible coding agent for the modern Lisp hacker (“Kleisli-Io/Kli - a Radically Extensible Coding Agent for the Modern Lisp Hacker” 2026)
-   knowledge-catalog/okf at main · GoogleCloudPlatform/knowledge-catalog OKF (“Knowledge-Catalog/Okf at Main · Googlecloudplatform/Knowledge-Catalog Okf” 2026)
-   junghan0611/apply (“Junghan0611/Apply” 2026)
-   PrimeIntellect-ai/prime-agent (“Primeintellect-Ai/Prime-Agent” 2026)
-   Olaudah Equiano (“Olaudah Equiano” 2026)
-   Is AI Hiding Its Full Power? With Geoffrey Hinton (<i>Is Ai Hiding Its Full Power? with Geoffrey Hinton</i> n.d.)
...
-   earendil-works/pi-transcribe (earendil-works [2026] 2026)
-   junghan0611/apply (junghan0611 [2026a] 2026)
-   junghan0611/prime-agent (junghan0611 [2026b] 2026)
-   junghan0611/workspace-bbot (junghan0611 [2026c] 2026)
-   steipete/agent-scripts (steipete [2025] 2026)
-   vivekhaldar/seed (vivekhaldar [2026] 2026)
...
- 김정호. 2020. <i>마음챙김 긍정심리 훈련(Mppt) 워크북</i>. [http://www.yes24.com/Product/goods/89591827](http://www.yes24.com/Product/goods/89591827).
- ———. 2023. <i>흔들릴 줄 알아야 부러지지 않는다</i>. [https://m.yes24.com/goods/detail/121912568](https://m.yes24.com/goods/detail/121912568).
...
- 오주석, and 유봉학. 2022. “수원선비 오주석 이야기 유봉학교수님강연 2022년 수원화성박물관.” 2022. [https://m.youtube.com/watch?v=GBlCPAfMkyI&#38;si=cJ6Jy0AGF5ze_hBJ](https://m.youtube.com/watch?v=GBlCPAfMkyI&si=cJ6Jy0AGF5ze_hBJ).
...
- earendil-works. (2026) 2026. “Earendil-Works/Pi-Transcribe.” [https://github.com/earendil-works/pi-transcribe](https://github.com/earendil-works/pi-transcribe).
...
- “General · Junghan0611/Prime-Agent.” n.d. Accessed August 29, 2026. [https://github.com/junghan0611/prime-agent](https://github.com/junghan0611/prime-agent).
...
- <i>Is Ai Hiding Its Full Power? with Geoffrey Hinton</i>. n.d. Accessed August 29, 2026. [https://www.youtube.com/watch?v=l6ZcFa8pybE](https://www.youtube.com/watch?v=l6ZcFa8pybE).
- junghan0611. (2026a) 2026. “Junghan0611/Apply.” [https://github.com/junghan0611/apply](https://github.com/junghan0611/apply).
- ———. (2026b) 2026. “Junghan0611/Prime-Agent.” [https://github.com/junghan0611/prime-agent](https://github.com/junghan0611/prime-agent).
- ———. (2026c) 2026. “Junghan0611/Workspace-Bbot.” [https://github.com/junghan0611/workspace-bbot](https://github.com/junghan0611/workspace-bbot).
- ———. n.d. “[Research] Prime Agent Rlm을 Lisp/Emacs 공존언어로 옮겨보기 — Repl, 형제, 전체 판, 방향타 · Issue #88 · Junghan0611/Entwurf.” Accessed August 27, 2026. [https://github.com/junghan0611/entwurf/issues/88](https://github.com/junghan0611/entwurf/issues/88).
...
- “Kleisli-Io/Kli - a Radically Extensible Coding Agent for the Modern Lisp Hacker.” 2026. [https://github.com/kleisli-io/kli](https://github.com/kleisli-io/kli).
- “Knowledge-Catalog/Okf at Main · Googlecloudplatform/Knowledge-Catalog Okf.” 2026. [https://github.com/GoogleCloudPlatform/knowledge-catalog/tree/main/okf](https://github.com/GoogleCloudPlatform/knowledge-catalog/tree/main/okf).
...
- “Olaudah Equiano.” 2026. [https://en.wikipedia.org/w/index.php?title=Olaudah_Equiano&#38;oldid=1370520174](https://en.wikipedia.org/w/index.php?title=Olaudah_Equiano&oldid=1370520174).
...
- “Prime Intellect Docs.” n.d. Accessed August 28, 2026. [https://docs.primeintellect.ai/introduction](https://docs.primeintellect.ai/introduction).
- Sam McVeety, and Amir Hormati. 2026. “How the Open Knowledge Format Can Improve Data Sharing.” Google Cloud. June 12, 2026. [https://cloud.google.com/blog/products/data-analytics/how-the-open-knowledge-format-can-improve-data-sharing?hl=en](https://cloud.google.com/blog/products/data-analytics/how-the-open-knowledge-format-can-improve-data-sharing?hl=en).
...
- steipete. (2025) 2026. “Steipete/Agent-Scripts.” [https://github.com/steipete/agent-scripts](https://github.com/steipete/agent-scripts).
...
- vivekhaldar. (2026) 2026. “Vivekhaldar/Seed.” [https://github.com/vivekhaldar/seed](https://github.com/vivekhaldar/seed).
...
- Weng, Lilian. 2026. “Harness Engineering for Self-Improvement.” July 4, 2026. [https://lilianweng.github.io/posts/2026-07-04-harness/](https://lilianweng.github.io/posts/2026-07-04-harness/).
