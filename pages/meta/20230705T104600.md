<!-- gid:20230705T104600 -->
[[TIP("이 노트에 대하여")]]
자바스크립트와 타입스크립트는 웹과 도구 생태계를 움직이는 핵심 언어로 다뤄진다. 입문서, 튜토리얼, 비동기 처리, 정규표현식, 타입 개념을 따라가며 실제 학습 경로와 활용 맥락을 정리한다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/meta/20230705T104600/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-07-05T10:46:00+09:00`
...
### <span class="org-todo done DONT">DONT</span> 서바이벌 타입스크립트 : 일본
...
[2023-07-25 Tue 16:32] 개념이 헷갈릴 수도 있다.
