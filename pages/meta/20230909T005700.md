...
-   [2025-04-22 Tue 16:26] SICP 메타 Related-Notes - [클로저 클로저스크립트](https://wikidocs.net/380504)
...
-   [sicp/ SICP video-notes '2024-11-14] - [notes/ junghan0611 sicp-info - texi-info 파일 변환 '2024-11-13 2025-04-22](https://wikidocs.net/381380)

## <span class="org-hashtag">#래킷</span> <span class="org-hashtag">#클로저</span> sicp-notes

[2024-11-12 Tue 15:50] 상당히 잘 정리가 되어있는 노트다. 래킷으로 되어 있고 클로저로 활용하면 된다. - [클로저 컴퓨터 대수학 시스템 혁신](https://wikidocs.net/381373) 을 위한 일이다.
