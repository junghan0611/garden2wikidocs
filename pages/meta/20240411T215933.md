<!-- gid:20240411T215933 -->
[[TIP("이 노트에 대하여")]] 시각화는 이미 알고 있는 내용을 꾸미는 일이 아니라 아직 엉킨 생각을 바깥으로 펼쳐 보는 방법이다. 마인드맵, 다이어그램, 관련 도구들은 개념 간 거리와 관계를 빠르게 드러낸다. 사고를 글만으로 붙들기 어려울 때 이 형식들이 좋은 보조 장치가 된다. [[/TIP]] 관련메타 - [인생도구 생각도구 지식도구 사고도구](https://wikidocs.net/380657)
