...
[[TIP("이 노트에 대하여")]] 프로그램은 특정 작업을 수행하는 명령의 묶음이고, 소프트웨어는 그것이 배포·유지·협업되는 더 큰 층위까지 포함한다. 아파치 재단 같은 사례는 코드가 공동체와 제도 속에서 자란다는 점을 보여준다. 기술 산물과 생태계의 양쪽을 함께 봐야 이 개념이 또렷해진다. [[/TIP]] KEYWORDS: 소프트웨어 software - [신기술: 혁신 하드웨어 소재 도구 로봇 소프트웨어 공학 모음 (2025-06-05)](https://notes.junghanacs.com/notes/20250605T223958/)
