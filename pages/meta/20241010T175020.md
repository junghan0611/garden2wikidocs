...
[[TIP("이 노트에 대하여")]] 데이터과학과 데이터마이닝은 큰 데이터에서 패턴을 찾는 실천적 분석의 기술이다. 통계와 기계학습, 시각화, 서비스 운영 맥락까지 함께 보며 데이터를 읽는 감각을 모은다. [[/TIP]] 관련메타 - [컴퓨터과학 전산](https://wikidocs.net/380611)
...
[2024-10-10 Thu 21:33] 아래 두 권은 이상일 교수 추천. - [이상일: 공간정보 통계 콰르토 대시보드 교육 R언어](https://wikidocs.net/382165)
