<!-- gid:20220906T124100 -->
[[TIP("이 노트에 대하여")]]
org-roam을 중심으로 제텔카스텐, 에버그린, 위키데이터, 퍼블리시 흐름을 어떻게 엮을지 장기간 실험한 기록이다. 백링크 버퍼, 캡처, 태그, export, 폴더 구조까지 실제 운영에서 부딪힌 문제와 점검 항목이 두껍게 쌓여 있다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20220906T124100/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2022-09-06T12:41:00+09:00`
...
## 2022-2023 오그롬 orgroam 활용

### <span class="org-todo done DONE">DONE</span> 연결 노트 버퍼 관련 기록
...
#### <span class="org-todo done DONE">DONE</span> bug-fix in Spacemacs

[2023-08-17 Thu 12:13] [org-roam/org-roam#1772 Weird backlink buffer display by \`org-roam-buffer-togg...](https://github.com/org-roam/org-roam/issues/1772)

### <span class="org-todo done DONE">DONE</span> 오그롬 통합 관련 기록
...
[Netlify CMS + Netlify 로 블로그 사이트 관리 및 배포 자동화 하기 - DuiNaru | 개발과 경험을 담는 블로그](https://duinaru.github.io/posts/2020-09-02-make-blog-with-netlifycms-netlify/) jf 의 모두스 색상이 좋다. [2023-03-25 Sat 16:44]
...
#### <span class="org-todo todo TODO">TODO</span> Backlinks count display
...
#### <span class="org-todo done DONE">DONE</span> CANCELLED nursery 참고 &gt; 저자가 둠이맥스 사용자라
...
-   [에버그린노트 디지털가든 노트테이킹](https://notes.junghanacs.com/notes/20240908T065729/)
