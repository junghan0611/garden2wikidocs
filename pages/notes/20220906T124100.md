<!-- gid:20220906T124100 -->
[[TIP("이 노트에 대하여")]] org-roam을 중심으로 제텔카스텐, 에버그린, 위키데이터, 퍼블리시 흐름을 어떻게 엮을지 장기간 실험한 기록이다. 백링크 버퍼, 캡처, 태그, export, 폴더 구조까지 실제 운영에서 부딪힌 문제와 점검 항목이 두껍게 쌓여 있다. [[/TIP]] 키워드: orgroam 오그롬 - [notes/ 모음: 노트테이킹 애플리케이션 '2024-12-07 2025-03-25](https://wikidocs.net/381409)
...
#### [links::PKM ONE – Medium] [links::Semantic Search for Org roam | lgmoneda] Langtools 관련 된 글이다 훌륭하다. <span class="org-todo done DONE">DONE</span> CANCELLED nursery 참고 &gt; 저자가 둠이맥스 사용자라 "chrisbarrett/nursery" Related-Notes - [오그롬 롬노트](https://wikidocs.net/380593)
