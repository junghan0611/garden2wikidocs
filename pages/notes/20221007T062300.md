<!-- gid:20221007T062300 -->
[[TIP("이 노트에 대하여")]]
paredit, smartparens, puni를 중심으로 구조적 편집이 왜 리스프와 이맥스에서 중요한지 정리한다. 괄호를 단순 문자로 다루지 않고 구조로 다루는 감각과 패키지 선택지가 함께 묶여 있다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20221007T062300/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2022-10-07T06:23:00+09:00`
...
- “Amaikinono/Puni.” 2025. [https://github.com/AmaiKinono/puni](https://github.com/AmaiKinono/puni).
- “Fuco1/Smartparens.” 2025. [https://github.com/Fuco1/smartparens](https://github.com/Fuco1/smartparens).
- karthink. n.d. “A Consistent Structural Editing Interface - Smartparens Paredit Puni Treesit.” Accessed November 15, 2024. [https://karthinks.com/software/a-consistent-structural-editing-interface/?](https://karthinks.com/software/a-consistent-structural-editing-interface/?)
...
-   [2025-02-11 Tue 15:25] 둠이맥스 smartparens 기본 사용
-   [2023-11-23 Thu 10:13] Puni 사용 중

## 관련노트

-   [이맥스: 구조적편집 괄호 개행 탈출](https://notes.junghanacs.com/notes/20240704T161606/)
-   [편집](https://notes.junghanacs.com/meta/20250211T153136/)

## smartparens / mark-sexp — 상위 폼 한 번에 선택

-   커서가 폼 안/근처에 있을 때:
    -   `C-M-u` (`backward-up-list`) → 바깥으로
    -   `C-M-d` (`down-list`) → 폼 안으로
    -   `C-M-SPC` (`mark-sexp`) → sexp 선택(region)
-   원래 기록(퍼블리시 ID 보존용 스텁): [smartparens mark-sexp (통합됨)](https://notes.junghanacs.com/notes/20250320T103618/)

## 깃허브

### AmaiKinono/puni

(“Amaikinono/Puni” 2025)
...
(“Fuco1/Smartparens” 2025)

-   Goljer, Matus
-   Minor mode for Emacs that deals with parens pairs and tries to be smart about it.

## A Consistent Structural Editing Interface - smartparens paredit puni treesit

(karthink n.d.)

-   karthink

## Corgi : Structural editing

[2023-11-23 Thu 10:19] 돌이켜보니 이게 정말 맛집이었네. Spacemacs 와 거의 유사함
...
-   <SPAN CLASS="ORG-HASHTAG">#FIXME</SPAN> 45fa2db9-3a43-4222-b412-2198e662d03a][Evil]] 패키지에 대한 정보는 여기에 담겨 있다.
...
## 2022-11-01 Smartparens 관련 글 [Emacs and Pairs](https://ebzzry.com/en/emacs-pairs/)
...
아래 사이트에 요약을 가져 왔다. 이게 원 저자의 키 바인닝이다 [A Cheatsheet for Emacs Smarparens example configuration · GitHub](https://gist.github.com/pvik/8eb5755cc34da0226e3fc23a320a3c95#file-smartparens-cheatsheet-md) ![](../../assets/2022-10-13_06-36-smartparens-cheat.png)
...
### - <SPAN CLASS="ORG-HASHTAG">#FIXME</SPAN> 5e7bb2b6-3a5a-49d1-8783-aeaffd55faec][기계인간님]] 님 블로그를 보니
