<!-- gid:20230117T102700 -->
[[TIP("이 노트에 대하여")]]
persp-mode를 통해 워크스페이스, 프레임, 윈도우, 버퍼 관계를 정리하려는 시행착오를 담았다. 화면이 제멋대로 바뀌는 문제를 이해 가능한 작업 단위로 묶어 보려는 시도가 핵심이다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230117T102700/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-01-17T10:27:00+09:00`
...
## <span class="org-todo done DONE">DONE</span> persp mode buffer management how to
