<!-- gid:20230117T123500 -->
[[TIP("이 노트에 대하여")]] VSCode에서 한국어 맞춤법 검사를 붙이려는 문제를 질문과 추론 중심으로 적어 둔 메모이다. 아직 완성된 해답보다 무엇이 필요한지 구조화하려는 초기 단계의 생각이 남아 있다. [[/TIP]] BIBLIOGRAPHY Related-Notes - [VSCODE](https://wikidocs.net/380502)
