<!-- gid:20230117T170000 -->
[[TIP("이 노트에 대하여")]]
글쓰기 흐름 안에서 로컬 사전이 왜 중요한지, 그리고 sdcv를 이맥스와 어떻게 연결할지 정리한다. 한국어 사전 자원을 보강하며 온오프라인 조회를 실전 도구로 만들려는 맥락이 살아 있다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230117T170000/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-01-17T17:00:00+09:00`
- 최근 수정: `2026-05-10T16:06:00+09:00`
[[/TIP]]
...
-   [2026-05-10 Sun 16:06] 오랜만에 검토
-   [2023-09-20 Wed] repo 만들었다. <https://github.com/junghan0611/sdcv-dict-ko>
-   [2023-07-08 Sat] kodict 추가
-   [2023-06-26 Mon] sdcv 로 이맥스에서 동작 확인. 사전이 아쉽다. 이 부분은 전뇌해커님 자료 보고 함. 우리말사전/표준국어사전 지원 필요
-   [2023-01-17 Tue 17:00] 글쓰기 시나리오에서 로컬 사전 구성은 굉장히 중요하다. 다행히 할 수 있다. 충분히 준비했다.
...
_home/junghan_.spacemacs.d/spacemacs.org:5492
...
#### <span class="org-todo done DONE">DONE</span> dict 포멧으로 변경
