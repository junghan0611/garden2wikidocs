...
[[TIP("이 노트에 대하여")]] 골든딕이 설치할 만한 사전 도구인지, 어떤 버전을 골라야 하는지를 짧게 정리한다. 오프라인 사전 인프라를 구축하는 흐름 속에서 왜 이 도구가 유용한지 핵심만 붙잡는다. [[/TIP]] GoldenDict Crow-translate 사전 활용법 [Local Offline Dictionary for Emacs with SDCV](https://wikidocs.net/381048)
