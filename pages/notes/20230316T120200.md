<!-- gid:20230316T120200 -->
[[TIP("이 노트에 대하여")]]
조직모드의 인용과 각주 기능을 빠르게 익히기 위한 영상과 참고 자료를 모아 둔다. 실전 예제를 통해 citation과 footnote 설정 흐름을 확인하려는 가벼운 진입점 역할을 한다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230316T120200/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-03-16T12:02:00+09:00`
...
[2023-03-16 Thu 18:10]

## README

<https://blog.tecosaur.com/tmio/2021-07-31-citations.html> 이게 찐이다. [2023-03-16 Thu 18:14]

## <span class="org-todo done DONE">DONE</span> citar

좀 더 프로세스를 고려한 방식을 해보자 만들어 진 것을 넣는 것 말고 일단 bib 파일에 넣어야 한다. 수작업으로 넣을 수 없으니까 넣는 방법을 모르겠네. url 이 있다면 결국 citation 키를 만들어 줘야 한다.

[2023-03-25 Sat 17:03]

## <span class="org-todo done DONE">DONE</span> citar org-roam
