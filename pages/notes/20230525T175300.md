...
[[TIP("이 노트에 대하여")]] 코드 포매터와 린터, 구문 오류 검사의 역할을 나누어 보며 Apheleia를 개발 흐름 속에 배치한다. 자동 정리와 정적 분석을 헷갈리지 않고 쓰기 위한 기준을 세우려는 자료이다. [[/TIP]] BIBLIOGRAPHY Related-Notes - [이맥스통합개발환경: 클로저 리스프](https://wikidocs.net/381178)
