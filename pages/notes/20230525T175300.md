<!-- gid:20230525T175300 -->
[[TIP("이 노트에 대하여")]]
코드 포매터와 린터, 구문 오류 검사의 역할을 나누어 보며 Apheleia를 개발 흐름 속에 배치한다. 자동 정리와 정적 분석을 헷갈리지 않고 쓰기 위한 기준을 세우려는 자료이다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230525T175300/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-05-25T17:53:00+09:00`
...
-   [이맥스통합개발환경: 클로저 리스프](https://notes.junghanacs.com/notes/20240117T121614/)
...
## <span class="org-todo done DONT">DONT</span> `format-all`

[2023-09-16 Sat 07:46] [GitHub - lassik/emacs-format-all-the-code: Auto-format source code in many la...](https://github.com/lassik/emacs-format-all-the-code)
...
## <span class="org-todo done DONT">DONT</span> In Spacemacs
