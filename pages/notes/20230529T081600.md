<!-- gid:20230529T081600 -->
[[TIP("이 노트에 대하여")]]
스페이스맥스에서 자주 쓰는 키바인딩과 명령을 빠르게 찾기 위한 치트시트이다. 전환기에 필요한 최소한의 손동작을 압축해 작업 속도를 잃지 않도록 돕는다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230529T081600/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-05-29T08:16:00+09:00`
- 최근 수정: `2024-12-04T11:37:00+09:00`
[[/TIP]]
...
## <span class="org-todo done DONT">DONT</span> Example 1
...
## <span class="org-todo done DONT">DONT</span> Example 2
...
-   [이블: 치트시트](https://notes.junghanacs.com/notes/20240927T144314/)
