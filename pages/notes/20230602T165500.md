<!-- gid:20230602T165500 -->
[[TIP("이 노트에 대하여")]]
마우스 의존을 줄이기 위해 qutebrowser와 nyxt 같은 키보드 중심 브라우저를 탐색한다. 실제 사용자 경험과 설정 철학을 참고하며 왜 브라우저까지 키보드 흐름에 넣고 싶은지 드러난다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230602T165500/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-06-02T16:55:00+09:00`
- 최근 수정: `2025-06-25T00:00:00+09:00`
[[/TIP]]
...
-   [2025-06-25 Wed 16:40] 저자에게 파이어폭스는 마우스를 사용하게 만드는 유일한 소프트웨어였다. 빔 관련 플러그인만으로는 만족할 수 없었다. 그래서 결국 정착한 녀석이 Qutebrowser 이다. 그에게 배워보자.

## 관련메타

## BIBLIOGRAPHY

- Giovanni Crisalfi. 2022. “Start Qutebrowser Now.” 2022. [https://zwitterio.it/en/software/start-qute-now/](https://zwitterio.it/en/software/start-qute-now/).

## Start Qutebrowser Now

(Giovanni Crisalfi 2022)

-   Giovanni Crisalfi
-   A few days ago, I started using Qutebrowser. I mean using it for real. It wasn’t my first installation: I tried it other times in the past, but I had never considered leaving Firefox. This time I’m us…

## <span class="underline">나의 생각</span> : 키보드 기반 웹 브라우저를 향하여!
...
![](../../assets/20230610-0012-screenshot.png)

## <span class="underline">원문 번역</span> : Start Qutebrowser Now (2022)
