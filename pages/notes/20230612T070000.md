<!-- gid:20230612T070000 -->
[[TIP("이 노트에 대하여")]]
컨벤셔널 커밋, 시멘틱 버저닝, 체인지로그 스펙을 한 흐름으로 묶어 버전 관리 규칙을 정리한다. 커밋 메시지부터 릴리스 기록 자동화까지 일관된 개발 습관을 세우려는 의도가 읽힌다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230612T070000/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-06-12T07:00:00+09:00`
...
- “Eki3z/Git-Cliff.El.” 2025. [https://github.com/eki3z/git-cliff.el](https://github.com/eki3z/git-cliff.el).
- “Keep a Changelog 체인지로그 스펙.” n.d. Accessed January 20, 2025. [https://keepachangelog.com/ko/1.0.0/](https://keepachangelog.com/ko/1.0.0/).
- “Orhun/Git-Cliff: A Highly Customizable Changelog Generator That Follows Conventional Commit Specifications.” 2023. [https://github.com/orhun/git-cliff](https://github.com/orhun/git-cliff).
- Preston-Werner, Tom. n.d. “Semantic Versioning 시멘틱 버저닝.” Accessed January 20, 2025. [https://semver.org/lang/ko/](https://semver.org/lang/ko/).
...
-   [2023-06-12 Mon 07:00] 어떻게 커밋 메시지를 관리할 것이며 변경사항을 자동화 할 것인가? 그것도

이맥스에서 Magit 을 사용하면서 말이다. 그래야 편하게 통일 할 수 있다. 깃허브 주소는 여기다.&nbsp;[^fn:1] 커밋 메시지를 작성하는 방법을 배울 필요가 있다. 가이드라인이 있다. All notable changes to this project will be documented in this file. See [conventional commits](<https://www.conventionalcommits.org/>) for commit guidelines.

-   [버전관리](https://notes.junghanacs.com/meta/20240821T162824/)
...
### <span class="org-todo todo TODO">TODO</span> kijimaD-roam 폴더를 확인하라
...
[2023-07-09 Sun 21:11] [コミットメッセージ規約 · GitHub](https://gist.github.com/minop1205/5fc4f6ef0ec89fb1738833ba25ae00a0) 번역함
...
### Changelog.md 파일 관리 방법

[2023-09-07 Thu 18:45] [Keep a Changelog](https://keepachangelog.com/ko/1.0.0/) 읽어보라. markdown-changelog 패키지
