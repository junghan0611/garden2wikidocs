<!-- gid:20230617T120300 -->
[[TIP("이 노트에 대하여")]] 논리학 개념어를 영어, 한자말, 순화한 우리말로 병렬 배치해 어휘 체계를 실험한다. org 테이블과 CSV 변환 흐름까지 함께 적어 두어 용어집을 실제 데이터로 다루려는 의도가 드러난다. [[/TIP]] - ‘∀x[Man(x)→Mortal(x)]' 논리 온톨로지 관련 CSV 파일 만들어야 히스토리 - [2026-05-15 Fri 07:54] 가든에 업데이트 [logickocli 한국어 자연어 추론 표준 논리 좌표계](https://wikidocs.net/382602)와 같이
