...
[[TIP("이 노트에 대하여")]] 웹 환경에서 아이콘과 이모지를 폰트 외 방식으로 다루는 방법을 찾으며 관련 설정과 참고 글을 모은다. Hugo·웹 퍼블리시 흐름에서 시각 요소를 안정적으로 넣기 위한 탐색의 출발점이다. [[/TIP]] 히스토리 - [|2025-03-28 Fri 02:31|](https://wikidocs.net/380405.md#h-2025-03-28/) 랜덤노트 만남. 수정 바라요
