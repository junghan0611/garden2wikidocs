<!-- gid:20230627T121800 -->
[[TIP("이 노트에 대하여")]]
Emacs 기반 번역 워크플로우에 도움이 되는 패키지와 자료를 한곳에 모은다. 문단 단위 편집, 레퍼런스 버퍼, 두 파일 모델 같은 번역 실무 흐름을 어떤 도구가 받쳐 주는지 살펴본다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230627T121800/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-06-27T12:18:00+09:00`
...
-   [번역툴](https://notes.junghanacs.com/meta/20230725T150800/)
...
-   newer
-   is it open/free software? sort of, 120 달러 per year after trial period. but open source.
