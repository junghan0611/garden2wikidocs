...
[[TIP("이 노트에 대하여")]] Emacs 기반 번역 워크플로우에 도움이 되는 패키지와 자료를 한곳에 모은다. 문단 단위 편집, 레퍼런스 버퍼, 두 파일 모델 같은 번역 실무 흐름을 어떤 도구가 받쳐 주는지 살펴본다. [[/TIP]] - [번역툴](https://notes.junghanacs.com/meta/20230725T150800/)
