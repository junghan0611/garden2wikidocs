...
[[TIP("이 노트에 대하여")]] 이맥스를 웹과 자바스크립트 개발 환경으로 쓰기 위한 패키지, LSP, 실행 도구 구성을 정리한다. 라이팅허브 같은 실제 프로젝트에 바로 쓸 수 있도록 최소하지만 통합된 개발 환경을 만드는 데 초점이 있다. [[/TIP]] 관련 노트 - [이맥스통합개발환경 리눅스](https://notes.junghanacs.com/meta/20231123T040509/)
-   [프론트엔드 브라우저 렌더링](https://notes.junghanacs.com/notes/20230725T102900/)
...
[2023-11-23 Thu 09:21] 여기 패키지를 밀어 넣는다. <a id="code-snippet--"></a> ```bash
...
``` <span class="org-todo done DONE">DONE</span> `pnpm` install on ubuntu ```text

sudo apt-get update
sudo apt-get install nodejs npm
sudo npm install -g pnpm
``` Javascript / Typescript : Nodejs [2023-11-23 Thu 09:22] 기본 패키지로 설치한다. - [nodejs nvm 노드 버전 관리자 포직스 호환 설치 스크립트](https://notes.junghanacs.com/notes/20250529T161426/)
