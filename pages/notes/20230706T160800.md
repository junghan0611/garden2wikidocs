<!-- gid:20230706T160800 -->
[[TIP("이 노트에 대하여")]]
asdf가 여러 언어 런타임을 관리하는 방식과 삭제, 플러그인 구조를 훑어본다. 동시에 리눅스와 Termux에서는 굳이 쓰지 말자는 현실적인 판단도 함께 남겨 실전 사용 기준을 세운다.
[[/TIP]]
...
## asdf-vm/asdf package manager

(“Asdf-Vm/Asdf Package Manager” 2025)
...
## <span class="org-todo done DONT">DONT</span> Node
...
## <span class="org-todo done DONT">DONT</span> Ruby
...
## <span class="org-todo done DONT">DONT</span> Deno

[2023-07-27 Thu 12:33] 설치하는 방법은 정말 다양하다. 이미 나도 설치 했었더라. 다시 설치한다. ASDF 로 툴 관리를 통합하는 게 여러모로 편하기 때문이다&nbsp;[^fn:2] 이것 말고도 내가 사용하고 앞으로 사용할 툴들은 이녀석으로 다 가능하다.
...
## <span class="org-todo done DONT">DONT</span> babashka
...
## <span class="org-todo done DONT">DONT</span> go
...
## <span class="org-todo done DONT">DONT</span> Python
...
## <span class="org-todo done DONT">DONT</span> OFF Racket
