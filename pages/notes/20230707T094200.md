...
[[TIP("이 노트에 대하여")]] 교열과 스타일 점검에 쓰이는 도구들을 한곳에 모아 각각의 역할을 비교한다. 특히 textlint 생태계를 중심으로 어떤 그림이 가능한지, 앞으로 무엇을 붙여야 하는지 파악하려는 탐색 기록이다. [[/TIP]] - [한글 텍스트 린터 플러그인 :개발](https://wikidocs.net/381081)
