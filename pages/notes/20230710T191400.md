...
[[TIP("이 노트에 대하여")]] 이맥스 안에서 검색과 편집, 정규식 치환, 일괄 변경을 하나의 워크플로우로 묶어 본다. 패키지 이름을 나열하는 수준을 넘어, 왜 텍스트 환경 전체가 점진적 변경에 유리한지까지 사유한 역사 노트다. [[/TIP]] 히스토리 - [2026-02-19 Thu 12:30] 이게 왜 어쏠로그인가? 이 주제는 매우 까다롭다. 이맥스에서 제공하는 옵션이 너무 많아서. 종합하는 역사 노트로서 발굴된 것!     ```markdown
    ...
    ``` - [2026-02-19 Thu 12:23] 종합 - 에이전트와 업데이트 - 2023년 7월 첫 삽질(wgrep 발견)부터 2026년 2월 consult-ripgrep 문법 파악까지, 2년 반의 점진적 이해가 하나의 노트에 담겼습니다. - 디지털 가든의 핵심이 이것 — 시간이 지나며 노트가 성숙해가는 과정. Evergreen note. - [2023-08-21 Mon 13:18] 2023-08-21 incremental search and replace 방법은 어떤가? - [2023-07-10 Mon 19:14] 2023-07-10 `rg` Usages : ripgrep and wgrep - [2023-05-03 Wed 14:02] 2023-05-03 Edit and apply (wgrep) 관련메타 - [둠이맥스 스페이스맥스](https://notes.junghanacs.com/meta/20241003T171723/)
