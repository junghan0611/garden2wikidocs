...
[[TIP("이 노트에 대하여")]] Deno가 어떤 런타임인지, Node.js와 무엇이 다르고 어떤 대안이 있는지를 간단한 질답 형식으로 정리한다. 이후 데노 학습 노트로 이어질 개념적 발판 역할을 하는 문서다. [[/TIP]] 온라인 책의 장점은 계속 업데이트가 되는 것이다. 어떻게? 봇으로 예제들을 돌려서 업데이트 하면 된다. [2025-01-13](https://notes.junghanacs.com/journal/20250113T000000/)
