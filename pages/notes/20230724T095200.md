...
[[TIP("이 노트에 대하여")]] 어드벤트 캘린더처럼 특정 주제로 여러 날에 걸쳐 꾸준히 기록하는 형식을 살핀다. 개인 창작이 연속될 때 하나의 책이나 프로젝트로 자랄 수 있다는 가능성을 붙잡는 메모다. [[/TIP]] Related-Notes - [기록 로그](https://wikidocs.net/380787)
...
-   [2023-07-24 Mon 09:56] 특정 주제로 여러 사람들의 글을 모으는 것. 개인 창작물. 합쳐서 보면 하나의 책이 될 수도 있다. 개인이 능력이 중요한 시대. - [AOC: Advent of Code 코드카타 - 어드벤트 코드](https://wikidocs.net/381677)
