<!-- gid:20230814T100300 -->
[[TIP("이 노트에 대하여")]]
딥엘을 번역기 자체보다 작업 흐름 속 도구로 바라보며 장단을 기록한다. 다른 번역 수단이 늘어났어도 Emacs와 연결되는 실전 번역 경험에서 왜 여전히 중요하게 남는지 드러난다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230814T100300/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-08-14T10:03:00+09:00`
...
-   [2025-05-25 Sun 16:39] 딥엘의 안위를 걱정하다.
-   [2023-08-17 Thu 07:19] 딥엘을 만나 놀라다.

## Related-Notes

-   [번역기](https://notes.junghanacs.com/meta/20230725T150800/)
-   [번역가](https://notes.junghanacs.com/meta/20240412T134539/)
-   [번역기: ImmersiveTranslate](https://notes.junghanacs.com/notes/20230913T131900/)

## BIBLIOGRAPHY

- “DeepL 계정.” n.d. Accessed May 21, 2024. [https://www.deepl.com/ko/your-account](https://www.deepl.com/ko/your-account).
- “Deeplx.” n.d. Accessed February 17, 2025. [https://deeplx.owo.network/](https://deeplx.owo.network/).
- “Owo-Network/Deeplx.” 2024. [https://github.com/OwO-Network/DeepLX](https://github.com/OwO-Network/DeepLX).

## 2025 그 사이 세상이 얼마나 변했는가?

[2025-05-25 Sun 16:54]

딥엘을 쓰는가? 아니... 이런... 그렇지만 여전히 이맥스에서 워크플로우는 딥엘이다.

[tmalsburg txl.el 이맥스 번역 패키지 프로젝트 관리](https://notes.junghanacs.com/bib/20250408T145631/)
...
[2023-08-17 Thu 07:19] 문법 및 구두점 교정 어조 뉘앙스 등

### 파일 번역

[2023-08-17 Thu 07:01] PDF, DOCX, TXT 파일 번역.

일단 PDF 파일 테스트 : Scattered Minds 를 그냥 넣어보자. 여기에 용어집을 갖추면 더욱 편하게 될 것이다.

### 용어집 Glossary

[2023-08-17 Thu 06:51] 도착어 목적어 쌍을 지정.

2023-08-17 현재 영어 -&gt; 한국어 지원 안됨

### DeepLX : Free API

[2023-08-16 Wed 06:41] <https://github.com/OwO-Network/DeepLX>
...
(“Owo-Network/Deeplx” 2024)

-   DeepL Free API (No TOKEN required)
-   [2025-04-08 Tue 12:00] 간단하게 무료 사용하기 좋다.
    ```elisp
...
[2023-08-14 Mon 10:17] 원문을 구글이나 빙으로 번역하면 정말 형편이 없다. 그러나 DeepL 은 다르다. 이게 기준이 된다. 한글을 작성할 때 DeepL 스타일이 된다면 괜찮은 영문 결과를 기대할 수 있다.
...
### <span class="org-todo done DONE">DONE</span> Deepl 8 월 한국 출시

무료 계정 사용

[2023-07-25 Tue 17:13] 1 인당 비용입니다. 유료 서비스는 팀 관리를 지원하기 때문에 파일 용량 같은 경우 인원수를 곱한 숫자를 팀 내에서 사용할 수 있습니다. 예를 들어 Starter 서비스를 10 명이 쓴다면 한 달에 10\*5=50 개 파일까지 쓸 수 있는 거죠.
