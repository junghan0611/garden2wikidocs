...
[[TIP("이 노트에 대하여")]] 딥엘을 번역기 자체보다 작업 흐름 속 도구로 바라보며 장단을 기록한다. 다른 번역 수단이 늘어났어도 Emacs와 연결되는 실전 번역 경험에서 왜 여전히 중요하게 남는지 드러난다. [[/TIP]] 히스토리 - [2025-05-25 Sun 16:39] 딥엘의 안위를 걱정하다. - [2023-08-17 Thu 07:19] 딥엘을 만나 놀라다. Related-Notes - [번역기](https://wikidocs.net/380501)
...
[2025-05-25 Sun 16:54] 딥엘을 쓰는가? 아니... 이런... 그렇지만 여전히 이맥스에서 워크플로우는 딥엘이다. [tmalsburg txl.el 이맥스 번역 패키지 프로젝트 관리](https://wikidocs.net/382364)
