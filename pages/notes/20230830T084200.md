...
[[TIP("이 노트에 대하여")]] 터미널에서 Emacs를 쓸 때 Wezterm, kitty와 Ghostty가 어떤 차이를 만드는지 기록해 둔다. 키 입력, GPU 가속, Wayland, 장기간의 시행착오가 함께 남아 있어 선택의 맥락을 보여 준다. [[/TIP]] 관련메타 - [ 도구](https://wikidocs.net/380778)
