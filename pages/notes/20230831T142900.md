<!-- gid:20230831T142900 -->
[[TIP("이 노트에 대하여")]]
textlint 기반 글쓰기 환경을 npm 대신 Deno로 옮기려는 구상과 실전 흐름을 정리한다. 저장소 템플릿, 실시간 교정, 온오프라인 글쓰기 환경을 한 번에 묶으려는 시도가 중심이다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230831T142900/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-08-31T14:29:00+09:00`
- 최근 수정: `2024-12-03T14:06:00+09:00`
[[/TIP]]
...
-   [2023-08-31 Thu 14:32] 글쓰기 환경에서 NPM 을 DENO 로 바꾼다.

## 왜 DENO 인가

[2023-08-31 Thu 14:23]

[2023-07-23 Sun 08:24] 다 좋다. 깃허브 리포를 만들어서 나의 글을 저장 할 것이다. 저장할 때 그냥 저장하지 않는다. 문법 스펠링 스타일 단어 사전 모두를 관리 할 것이다. 여기에 더 나아가 다양한 블로그 서비스로 내보내기 할 것이다.
...
[2023-07-24 Mon 10:20] 위 글에서 긁어 왔다. 정말 간단해졌다. 알아야할 것도 줄었다. 쉽게 테스트를 다 해본 샘이다. 근데 개발 중인 플러그인을 넣고 테스트는 어떻게 하는가?
...
[2023-07-24 Mon 09:01] 여기서 말한 바 zenn-cli + textlint 를 처리하는 데 deno 로 중심을 가져 간다.
...
[2023-07-24 Mon 09:12]

-   <SPAN CLASS="ORG-HASHTAG">#FIXME</SPAN> f8b7ac71-2d9a-4670-afc4-a2f22c2bb499][How to Install Deno JavaScript Runtime and Deno-Bridge🫛]]
...
[2023-07-24 Mon 09:40] 위의 글에서는 커맨드 설치 방법으로는 CLI 린팅이 안된다고 하던데 실제 해보니까 잘 된다. 버전 차이인듯. 그럼에도 다음에 소개할 모듈 방식이 더 깔끔해 보인다.
...
[2023-07-24 Mon 10:22] 여기&nbsp;[^fn:2] 에서 다룬 방법에 따르면 이게 더 효과적인 것 같다. 여기 리포를 싹 가져왔다.

<https://github.com/junghan0611/deno-textlint-ci-sample>

액션까지 완벽하게 동작한다. 단 여기서는 Linter 룰을 모두 가져오는 경우다. 이제 개발이야기도 들어가야 한다.

![](../../assets/20230724-1031-screenshot.png)

## 이제 나의 텍스트린트 플러그인을 개발해서 연결해보자.

[2023-07-24 Mon 09:22] 다시 돌아왔다. 이 글&nbsp;[^fn:3] 은 빔을 기준으로 개발 환경을 다루고 있다. 특히 젠 커맨드까지 커버하고 있다. 아! 그리고 efm 서버를 사용한다. 괜찮은 접근이다. 왜냐?! 이맥스도 지원하니까.
...
## <span class="org-todo todo TODO">TODO</span> deno-textlint-plugin samples

[2023-07-24 Mon 11:55] 있다. 좋은 글이 있다. 개발 사례를 통해서 개발 방법을 알아야 한다. devdocs 를 한글버전으로 가져왔다. 좋은 시작이다.
...
[2023-07-27 Thu 11:14]

### <span class="org-todo todo NEXT">NEXT</span> 진행 방법 알고 싶은 것들

[2023-07-27 Thu 11:25] 타입스크립트 문서는 어디서 누가 가져오지? 데노가? 데노 서버가 가져오나?

### <span class="org-todo todo NEXT">NEXT</span> 데노 예제로 수련을 해야 한다

[2023-07-27 Thu 22:10] 데노가 뭔지 알아야 패키징도 할 수 있다.

### <span class="org-todo todo NEXT">NEXT</span> 데노로 샘플 애플리케이션 노드 패키징

[2023-07-27 Thu 16:05]
...
[2023-07-27 Thu 11:17]

#### 데노 텍스트린트 플러그인 개발 사례 (Pure ESM 기반)

[2023-07-24 Mon 15:59] <https://zenn.dev/err9317/articles/dcb28bee9f05c3>
...
[2023-07-27 Thu 16:08] 결과를 가지고 있다. 아 텍스트린트를 빼고 그냥 만들고 내보내기 부터 하자

##### 내용 정리

[2023-07-27 Thu 15:57]
...
[2023-07-24 Mon 16:10] 잠시만 이걸 한글로 바꾸는 것도 좋겠다.
...
-   [데노: 자바스크립트 타입스크립트 런타임](https://notes.junghanacs.com/notes/20230723T082600/)
