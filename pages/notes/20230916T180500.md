<!-- gid:20230916T180500 -->
[[TIP("이 노트에 대하여")]] EditorConfig가 팀과 프로젝트에서 코딩 스타일을 통일하는 데 어떤 역할을 하는지 정리한다. 에디터마다 설정이 갈라지는 문제를 파일 기반 규칙으로 묶는 접근을 이해하기 위한 노트다. [[/TIP]] 관련메타 - [설정 구성](https://notes.junghanacs.com/meta/20250122T115739/)
...
[[TIP("요약")]] What is EditorConfig? EditorConfig helps maintain consistent coding styles for multiple developers working on the same project across various editors and IDEs. The EditorConfig project consists of a file format for defining coding styles and a collection of text editor plugins that enable editors to read the file format and adhere to defined styles. EditorConfig files are easily readable and they work nicely with version control systems. [[/TIP]] 설치 에디터 설정 [2023-09-16 Sat 18:05] <https://editorconfig.org/> 툴을 설치한다. ```shell
sudo apt-get install editorconfig
``` 둠이맥스 모듈 :tools editorconfig [2025-06-11 Wed 14:01] 있는데 쓸 것인가는 검토 스크린샷 ![](../../assets/20250611T140030-editorconfig.png) 로그 [|2025-06-11 Wed 13:59|](https://notes.junghanacs.com/journal/20250609T000000.md#h-2025-06-11/)
