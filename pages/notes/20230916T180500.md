<!-- gid:20230916T180500 -->
[[TIP("이 노트에 대하여")]] EditorConfig가 팀과 프로젝트에서 코딩 스타일을 통일하는 데 어떤 역할을 하는지 정리한다. 에디터마다 설정이 갈라지는 문제를 파일 기반 규칙으로 묶는 접근을 이해하기 위한 노트다. [[/TIP]] 관련메타 - [설정 구성](https://wikidocs.net/380785)
