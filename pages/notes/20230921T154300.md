<!-- gid:20230921T154300 -->
[[TIP("이 노트에 대하여")]]
MS 윈도우즈에서 Emacs를 설치하고 쓰기 위한 자료와 시행착오를 정리한다. 단순 설치법을 넘어서, 최근 방법이 얼마나 쉬워졌는지와 무엇을 가져와야 하는지 가늠하려는 노트다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230921T154300/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-09-21T15:43:00+09:00`
...
- <i>Installing Doom Emacs on Windows #Emacs #Doomemacs #Keybinds - Youtube</i>. 2025. [https://www.youtube.com/watch?v=IAZU6sC46YU](https://www.youtube.com/watch?v=IAZU6sC46YU).
- <i>Properly Installing Emacs on Windows #Emacs #Windows #Coding #Programming</i>. 2025. [https://www.youtube.com/watch?v=9lE45khK3qU](https://www.youtube.com/watch?v=9lE45khK3qU).

[MS윈도우즈](https://notes.junghanacs.com/meta/20250107T151412/)에서 [이맥스 - 텍스트에디터](https://notes.junghanacs.com/meta/20230521T215600/)를 사용한다면

## 히스토리

-   [2025-04-13 Sun 16:25] 레퍼런스 추가
-   2023-09-22 테스트 겸 설치
-   2024-06-06 테스트톱에 설치하려고 문서 확인 --&gt; 수정 필요! 완전 쉽고 개선된 방법
-   2025-01-07 파일 나눔

## [스쿱 활용해서 패키지 설치](https://notes.junghanacs.com/notes/20250107T150402/)

## <span class="org-todo done DONE">DONE</span> Install and Setup Guide

[2023-09-22 Fri 13:59]

[2025-01-07 Tue 15:25] 일부 가져옴직하다.
...
### OFF ivy dotfile 을 수정해서 미니멀로 가져가면 된다.

ivy 버전으로 싹 정리해서 동작해보면 되겠다. 했다. 로딩 중. 잘되는 것 같은데?! 다녀오자. 괜찮다. 동작한다. 심플하게 가져갈 것.

[2023-09-22 Fri 13:59] 내 버전으로도 동작한다. 필요 없다.

### CANCELLED scoop 패키지 설치

[2023-09-21 Thu 20:10] Spacemacs 리포에서 설치 하라는 것들 하면 된다. 아마 여기서 폰트도 설치할 수 있을듯. fd pandoc ag ripgrep 등 다 여기서 찾아보라.
...
### 왜 윈도우즈인가? 터미널 없이 마우스로 다 사용 할 수 있어야 한다.

[2023-09-21 Thu 16:50]
...
![](../../assets/20230921_161220_screenshot.png)
...
[2023-09-22 Fri 13:13] kind-icon 을 못가져온다. 즉 외부로 연결이 안된다. 다른 바이너리도 이런 문제가 발생하는가? scoop or zip version?

[2023-09-22 Fri 11:52] 28 버전 다운?! msys2 를 업데이트하고 다시 설치해보자. 된다. 컴파일을 해서 진행하니 오래 걸린다. 그러나. 기대가 된다.
...
[2023-09-22 Fri 12:23] <https://kyh0703.github.io/tip/post-window-zsh/> 여기 보면 윈도우즈 터미널에 추가하는 방법이 있다.

#### windows script layer : powershell

[2023-09-22 Fri 12:27] 스페이스맥스에 있다.

### 추가 프로그램 설치

[2023-09-21 Thu 16:37]
...
### Enable `Symlinks` 심볼링 링크 - 윈도우즈

[2023-09-21 Thu 16:49] 이게 되는구나?!
...
### Install Git / Gihub : Ssh-Keygen

[2023-09-21 Thu 16:49] git-for-windows : git-2.39.2-64-bit.exe github desktop
...
[2023-09-21 Thu 16:26] 디렉토리 표기가 다르다는 점을 알고 있어야 한다. 근데 신경 쓸 것 없다. 환경 변수 하나 등록하면 나머지는 그냥 쓰던 대로 하면 된다.
...
[2023-09-22 Fri 11:22] 이름 이메일 EPA ORG 디렉토리 적어줄것.
...
[2023-09-21 Thu 20:12] 모든 키가 동작하는지 확인.

### <span class="org-todo done DONT">DONT</span> Spacemacs Installation Guide

[2023-09-21 Thu 16:18] <https://github.com/syl20bnr/spacemacs#windows>

여기 보면 Scoop 을 이용해서 쉽게 설치하라고 한다. 훔. 참고만. 이런 패키지 매니저는 꼭 문제를 만든다.

## 참고자료

### Installing Doom Emacs on Windows <span class="org-hashtag">#emacs</span> <span class="org-hashtag">#doomemacs</span> <span class="org-hashtag">#keybinds</span> - YouTube

(<i>Installing Doom Emacs on Windows #Emacs #Doomemacs #Keybinds - Youtube</i> 2025) 2025

### Properly Installing Emacs on Windows <span class="org-hashtag">#emacs</span> <span class="org-hashtag">#windows</span> <span class="org-hashtag">#coding</span> <span class="org-hashtag">#programming</span>

(<i>Properly Installing Emacs on Windows #Emacs #Windows #Coding #Programming</i> 2025) 2025
