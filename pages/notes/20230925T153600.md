...
[[TIP("이 노트에 대하여")]] Reagent가 ClojureScript 함수와 데이터만으로 React UI를 만드는 방식을 소개한다. 히컵 문법과 최소 인터페이스라는 특징을 통해 풀스택 Clojure 선택지를 이해하려는 기록이다. [[/TIP]] - [NPM:을 활용한 클로저 풀스택](https://wikidocs.net/381112)
