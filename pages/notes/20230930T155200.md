<!-- gid:20230930T155200 -->
[[TIP("이 노트에 대하여")]]
binder 모드가 여러 파일로 이루어진 글쓰기 프로젝트를 어떻게 관리하는지 문서 번역과 함께 정리한다. Scrivener의 바인더 개념을 Emacs에서 재현하려는 흐름을 이해하기 좋은 자료다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20230930T155200/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-09-30T15:52:00+09:00`
...
[최은광 스크리브너](https://notes.junghanacs.com/bib/20250108T105154/) 다시 만남.
...
4.  <span class="org-hashtag">#tag1</span> <span class="org-hashtag">#tag2</span> ... arbitrary item tags (see **Tags** below)
