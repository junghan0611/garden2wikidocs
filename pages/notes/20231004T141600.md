...
[[TIP("이 노트에 대하여")]] 우분투와 하모니카를 업그레이드하거나 다시 볼 때 무엇을 고려해야 하는지 남긴 기록이다. 용량 문제, 사용 빈도, Regolith 구성 같은 현실적 요소가 함께 얽혀 있는 시스템 메모다. [[/TIP]] 관련메다 - [ 버전 업그레이드 업데이트](https://notes.junghanacs.com/meta/20240821T162824/)

## 히스토리

-   [2026-01-16 Fri 09:34] 우분투 업그레이드 하려다가 생각한다. 이제 안쓰게 되겠지만. - [ 리눅스 유닉스 운영체제](https://notes.junghanacs.com/meta/20250408T151014/)
-   [2023-10-04 Wed 14:16] 생성 관련노트 - [하모니카 리눅스 설치법](https://notes.junghanacs.com/notes/20230529T212700/)

## 2024 우분투 23.04에서 하모니카 8.0 레골리스 3.2 업그레이드

[2024-09-15 Sun] 전체 과정 목표 왜 갑자기? ollama 삭제 안쓰는데 랭기지모델 용량이 크다. ```text
/usr/share/ollama
