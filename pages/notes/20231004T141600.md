...
[[TIP("이 노트에 대하여")]] 우분투와 하모니카를 업그레이드하거나 다시 볼 때 무엇을 고려해야 하는지 남긴 기록이다. 용량 문제, 사용 빈도, Regolith 구성 같은 현실적 요소가 함께 얽혀 있는 시스템 메모다. [[/TIP]] 관련메다 - [ 버전 업그레이드 업데이트](https://wikidocs.net/380631)

## 히스토리

-   [2026-01-16 Fri 09:34] 우분투 업그레이드 하려다가 생각한다. 이제 안쓰게 되겠지만. - [ 리눅스 유닉스 운영체제](https://wikidocs.net/380826)
-   [2023-10-04 Wed 14:16] 생성 관련노트 - [하모니카 리눅스 설치법](https://wikidocs.net/381058)
