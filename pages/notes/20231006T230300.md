<!-- gid:20231006T230300 -->
[[TIP("이 노트에 대하여")]] 디레드에서 선택한 여러 파일에 들여쓰기나 포매팅을 한 번에 적용하는 Elisp 코드를 남겨 둔다. 반복적인 정리 작업을 손으로 하지 않기 위한 작은 자동화 아이디어 모음에 가깝다. [[/TIP]] Linting and Formatting All files at once Dired/Macro ;; <https://stackoverflow.com/questions/2551632/how-to-format-all-files-under-a-dir-in-emacs> Elisp [2023-10-06 Fri 23:04] ```elisp
...
(defun my/indent-files (directory extension)
  ...
  (dolist (file (directory-files-recursively directory extension))
    ...
    (save-buffer)
    (kill-buffer nil)))
``` Macro [2023-10-06 Fri 23:01] ```text
...
``` Related-Notes - [meta/ 리스프 '2024-06-20 2025-03-28](https://notes.junghanacs.com/meta/20240620T125311/)
-   [meta/ 이맥스리스프 '2024-09-26 2025-04-02](https://notes.junghanacs.com/meta/20240926T170557/)
