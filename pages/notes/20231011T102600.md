...
[[TIP("이 노트에 대하여")]] DevDocs를 이용해 한글 개발자 문서를 내려받고 이맥스 안에서 조회하는 흐름을 실험한다. 문서 번역 자산을 오프라인 개발 매뉴얼로 재활용하려는 시도가 구체적으로 담겨 있다. [[/TIP]] 무엇을 하려는 것인가? 한글화가 잘 되어 있는 공식 문서가 있다. 예를 들어 Python 말이다. JavaScript 도 마찬가지다. 그걸 이용하자는 말이다. 그리 되면 고생 할 것이 확실히 줄어 든다. History - [2024-01-13 Sat 20:43] python 한글 버전 살리는 중 - [2024-01-13 Sat 20:04] devdocs-browser 사용하는 거다. 헷갈리지 말자. NOTE 요약 [2024-01-14 Sun 16:55] 아직 완벽하게 생성한 것은 아니나. 만들었다. 아 그렇다면 이용할수 있다. - devdocs 를 이용하기 위해 Ruby 를 설치 - devdocs clone - bundle packages install - download documents (korean/hangul) tar.bz - fix scrapers for korean/hangul - thor generate / package - link devdocs-browser.el pakcages NOTE Devdocs Build with new Ruby version [2024-01-13 Sat 19:57] [Ruby IDE](https://notes.junghanacs.com/notes/20240113T200009/) 여기에 Ruby 설치 적어 놓았다. 버전을 맞춰야 한다. rbenv 로 준비가 되었을 것이다.
...
## <span class="org-todo todo TODO">TODO</span> rackup - devdocs.el

[2024-01-23 Tue 14:30]

## <span class="org-todo done DONT">DONT</span> Python -- devdocs (ko) branch
...
![](../../assets/20230726-0959-screenshot.png)
...
![](../../assets/20230726-0950-screenshot.png)
...
### <span class="org-todo done DONT">DONT</span> 빌드 방법
...
### <span class="org-todo todo TODO">TODO</span> mdn 소스를 적용해보자
...
### <span class="org-todo todo TODO">TODO</span> 패키징 하자
...
### <span class="org-todo done DONT">DONT</span> Emacs devdocs and devdocs-browser
...
![](../../assets/20230727-1524-screenshot.png)
...
![](../../assets/20231025_063842_screenshot.png)

#### <span class="org-todo done DONT">DONT</span> devdocs 로 변환 할 수 있는가?
...
![](../../assets/20240114_172137_screenshot.png)
