...
[[TIP("이 노트에 대하여")]] 디지털가든에서 메타노트와 태그, 영어 키워드, 한글 제목을 어떻게 엮을지 장기적으로 정리한 문서다. 단순 분류 규칙을 넘어서 검색성과 시맨틱 연결을 강화하려는 전략 노트의 성격이 강하다. [[/TIP]] 히스토리 - [2026-07-09 Thu 15:04] 가든 내보내기에 meta 워드로 태그 제한 로직 추가 - [2026-02-20 Fri 13:27] 잠시만 이거 스킬로 만들거야 검토!! - [2025-11-07 Fri 09:19] 지하철에서 힣의 요청을 받고 클로드가 생성함. 이후 메타 및 관련 문서 업데이트 확장 - [2025-11-07 Fri 09:27] [임시](https://notes.junghanacs.com/notes/20251107T082600/) 이 문서에 자동화 작업 진행 중 입니다.
-   [2025-06-12 Thu 19:41] 문서 정리 중 - [2025-06-03 Tue 17:14] 메타노트의 나름의 해석 - 외국어 활용의 가치 - [2025-04-23 Wed 12:29] MOC - [2024-12-14 Sat 19:25] 디지털가든 적용 시작 - [2023-10-18 Wed 17:01] (Karl Voit 2022) 참고 - [2022-08-29 Mon 09:00] 테스크 관리 관점에서 조금 깊게 바라보자. 조직모드 통합의 길 메타노트 - [ 메타](https://notes.junghanacs.com/meta/20241027T210006/)
...
-   [임시](https://notes.junghanacs.com/notes/20250423T122956/)
...
[2025-04-28 Mon 11:48] 그냥 껍때기이자 양식이다. 그래야 한다. 가이드이다. 메타까지 가지고 가면 포크해서 지식 체계를 가져갈 수 있다. <span class="org-todo done DONE">DONE</span> 11:56 메타는 개념의 확장이다. 여럿 노트북을 끌어와야 한다. [2025-06-03 Tue 17:13] 많은 흔적을 끌어와야 한다. 노트북은 무엇인가? 노트북이라는 이름으로 불리는 모든 것들 말이다. 여러 분야에서 노트북으로 불리는게 많을 껄? 2025 메타노트 흔적의 완성 - [2025-06-03 Tue 17:14] 메타노트의 나름의 해석 - 외국어 활용의 가치 이 맥락에서 이야기를 확장하고 싶다 - [호프스태터: GEB 괴델에셔바흐 지식사상통합](https://notes.junghanacs.com/bib/20240713T204705/)
-   [힣: 흔적 찾기 도서 - 단서 저자 분류 계층 장방시 층위](https://notes.junghanacs.com/notes/20250409T074725/)

## 2025 노트 '제목' 유니코드 분류 방법

-   [2025-04-15 Tue 17:26] - [힣: 노트테이킹 유니코드 기호: 파일명 ⓕ № ↔ → ∉ ⊢ ¬ ¢ µ ¥ £ ¡ ¿](https://notes.junghanacs.com/notes/20241225T052744/)
-   [규칙 원칙 법칙 규정 기준 지침 질서 규제 규약](https://notes.junghanacs.com/meta/20250415T172023/)으로서 말이야.

[[TIP("노트")]] - '' 시작하는 노트 메타 - '' 시작하면 서지 - 사람, 회사, 조직 등 - '' 패키지 애플리케이션 뭐 등등 - 노트의 경우, 앞에 '' 메타를 넣고 ':'으로 구분 - 태그는 영어, 메타에 정보 담지 않도록. [[/TIP]] 2025 폴더 태그 <span class="org-hashtag">카테고리</span> - 영어 한글 [2025-04-14 Mon 18:54] 쿼츠 코드에 카테고리 추가한 것. 반영. - [categories](https://notes.junghanacs.com/categories/)

## 2024 <span class="org-hashtag">#용어관리</span>: 전문용어 번역어 통일성

-   [2024-12-14 Sat 19:25] 단어로 애매한 것들이나 전문용어, 약어 등에 활용 된다. 이에 더해 폭소노미로도 영어는 유용하다.([LLM: 용어 텍사노미 폭소노미 - 분류 체계 개념 지식](https://notes.junghanacs.com/notes/20241206T164930/)). [힣: 노트테이킹 유니코드 기호: 파일명 ⓕ № ↔ → ∉ ⊢ ¬ ¢ µ ¥ £ ¡ ¿](https://notes.junghanacs.com/notes/20241225T052744/)를 활용한다. 용어 사용의 체계와 통일성 중요하다. [모음: 애매 모호 용어 사전 단어 어휘](https://notes.junghanacs.com/notes/20241215T121847/) 단어 사용
...
[2023-09-13 Wed 16:43] 메타프로젝트의 성격 BLOG Project Area Life tags-alist 여기에 추가해라. FILETAGS 가 될거야. ```emacs-lisp
...
(setq org-tag-alist
      '((:startgroup)
        ...
        ("@work" . ?W)
        ("private" . ?P)))
``` 2023 Tags for Take on Rules - (Jeremy Friesen 2024) Jeremy Friesen 2024 - (Jeremy Friesen 2020) - [제레미프리센 jeremyf takeonrules](https://notes.junghanacs.com/bib/20241025T104347/)
