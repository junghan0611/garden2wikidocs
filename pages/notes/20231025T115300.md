...
[[TIP("이 노트에 대하여")]] EPUB 전자책을 깔끔한 HTML로 바꾸는 unbook과 SingleFile 같은 도구를 소개한다. 전자책 내용을 다시 활용하거나 웹에서 읽기 좋게 변환하려는 실용적 관심이 중심이다. [[/TIP]] BIBLIOGRAPHY Related-Notes - [Pandoc](https://wikidocs.net/380552) 에 정리한다.
