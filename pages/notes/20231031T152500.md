...
[[TIP("이 노트에 대하여")]] zk, zk-index, zk-desktop 같은 패키지를 통해 Emacs에서 폴게제텔식 노트 관리가 어떻게 구현되는지 살핀다. 지금은 직접 쓰지 않더라도 개념적으로 어떤 흔적을 남겼는지 읽을 수 있는 기록이다. [[/TIP]] 히스토리 - [2025-07-14 Mon 11:06] 지금 지케이를 쓰지 않지만, 결국 그의 개념을 다 따르게 된다. - [2023-10-31 Tue 15:25] 지케이를 익히다. 관련메타 - [디노트](https://wikidocs.net/380527)
