...
[2023-11-03 Fri 11:53] Elixir ❤️ Embedded Nerves is an open-source platform that combines the rock-solid BEAM virtual machine and Elixir ecosystem to easily build and deploy production embedded systems. Related-Notes - [토머스 (2022) 처음 배우는 엘릭서 프로그래밍: 쉽고 빠르게 익히는 함수형 프로그래밍](https://wikidocs.net/381916)
