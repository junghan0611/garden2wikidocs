...
[[TIP("이 노트에 대하여")]]
Elixir와 Erlang 패키지를 설치하고 이맥스 통합개발환경으로 이어 가기 위한 기본 점검을 기록한다. 복잡한 설정 이전에 무엇이 먼저 갖춰져야 하는지 확인하는 출발선 역할의 노트다.
[[/TIP]]
...
/home/junghan/sync/man/dotsamples/vanilla/victoro-dotfiles-elixir/README.org:10 여기를 확인한다.
...
## <span class="org-todo done DONT">DONT</span> [Nerves Project - nerves-project.org](https://nerves-project.org/)

[2023-11-03 Fri 11:53] Elixir ❤️ Embedded Nerves is an open-source platform that combines the rock-solid BEAM virtual machine and Elixir ecosystem to easily build and deploy production embedded systems. Related-Notes - [토머스 (2022) 처음 배우는 엘릭서 프로그래밍: 쉽고 빠르게 익히는 함수형 프로그래밍](https://notes.junghanacs.com/bib/20240422T101836/)
