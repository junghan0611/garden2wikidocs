...
[[TIP("이 노트에 대하여")]] Vale를 설치하고 살펴보며 한국어 문장 교열에는 왜 바로 맞지 않는지 생각한다. 형태소분석 부재가 한계가 되는 지점을 짚으면서 후속 대안으로 Kiwi 같은 도구를 바라보게 한다. [[/TIP]] - [notes/ 린터: 텍스트린트 발레 한글 버전 만들고 싶지 '2024-09-23](https://wikidocs.net/381330)
...
[2024-10-07 Mon 23:11] (“Tpeacock19/Flymake-Vale” 2024) 스코드 보니까 장난아니다. 린터가 왕창 붙는구나. 놀랍다. 근데 켰나 내가? 응 vale-vscode 있네 - Related-Notes -&gt; 이것도 오타다. 아래 봐라. 여기 많은데 아마 한글 설정 하던거 있지? </home/junghan/mydotfiles/config-common/.config/vale> [텍스트린터 발레 한글 버전 : 제작](https://wikidocs.net/381330) 여기서 해봤잖아. 물어가면서 하면 된다.
