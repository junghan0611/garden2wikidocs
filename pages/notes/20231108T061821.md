<!-- gid:20231108T061821 -->
[[TIP("이 노트에 대하여")]]
Vale를 설치하고 살펴보며 한국어 문장 교열에는 왜 바로 맞지 않는지 생각한다. 형태소분석 부재가 한계가 되는 지점을 짚으면서 후속 대안으로 Kiwi 같은 도구를 바라보게 한다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20231108T061821/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-11-08T06:18:00+09:00`
...
![](../../assets/20231108_064851_screenshot.png)

## Related-Notes

-   [린터: 슈퍼린터 깃허브 마켓플레이스](https://wikidocs.net/382240)
...
[텍스트린터 발레 한글 버전 : 제작](https://wikidocs.net/381330) 여기서 해봤잖아. 물어가면서 하면 된다.
