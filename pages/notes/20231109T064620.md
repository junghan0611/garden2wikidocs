...
[[TIP("이 노트에 대하여")]] Kiwi를 한국어 형태소분석의 실전 대안으로 기록하면서 린터와 시맨틱 처리의 기반으로 바라본다. 한국어 텍스트를 제대로 다루려면 무엇이 필요한지 보여 주는 중요한 연결점이다. [[/TIP]] 히스토리 - [2026-03-30 Mon 11:19] [andenken: 존재의 뜻새김 시맨틱 메모리를 넘어서](https://wikidocs.net/382576)에서 형태소분석이 부족하면 키위로 간다.
-   [2023-11-09 Thu 06:46] "bab2min/Kiwi 지능형 한국어 형태소 분석기" 관련노트 - [린터: Vale 발레 안되는 이유 - 형태소분석](https://wikidocs.net/381152)
