...
[[TIP("이 노트에 대하여")]] Denote와 Dired를 결합해 노트를 고르고 옮기고 정리하는 작업 감각을 배운다. 단순 기능 설명보다, 여러 파일을 다루는 글쓰기와 제텔카스텐 실습에 어떻게 연결되는지가 중요하게 다뤄진다. [[/TIP]] BIBLIOGRAPHY 디노트 디레드 시그니처 [텍스트 마스터 인덱스 목차](https://notes.junghanacs.com/notes/20240119T030240/) 에 반영해야 한다.
