...
[[TIP("이 노트에 대하여")]] 순수 함수와 동형성 같은 함수형 프로그래밍 개념을 클로저 맥락에서 다시 정리하려는 노트다. 아직 초안에 가깝지만, 개념을 우리말로 붙잡아 두려는 학습의 흔적이 분명하다. [[/TIP]] BIBLIOGRAPHY Related-Notes - [클로저](https://notes.junghanacs.com/meta/20230729T052700/)
