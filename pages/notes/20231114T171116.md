<!-- gid:20231114T171116 -->
[[TIP("이 노트에 대하여")]]
mcfly, atuin, cheat, starship, ncdu, bat, btm 같은 CLI 도구들을 한데 모아 비교한다. 셸 사용 경험을 어떻게 더 빠르고 읽기 좋게 만들지 고민하는 워크플로우 노트다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20231114T171116/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-11-14T17:11:00+09:00`
...
- “Cantino/Mcfly.” 2024. [https://github.com/cantino/mcfly](https://github.com/cantino/mcfly).
- “Cheat/Cheat.” 2025. [https://github.com/cheat/cheat](https://github.com/cheat/cheat).
- “Gnebbia/Kb a Minimalist Command Line Knowledge Base Manager.” 2024. [https://github.com/gnebbia/kb](https://github.com/gnebbia/kb).
- xguru. 2024. “Starship - 크로스-쉘 프롬프트 Cli-Tools Command-Line.” January 29, 2024. [https://news.hada.io/topic?id=13084](https://news.hada.io/topic?id=13084).

## 히스토리

-   [2025-07-20 Sun 17:26] 추가 네오빔 설치
-   [2025-06-24 Tue 16:37]
-   [junghan0611 astronvim-config](https://notes.junghanacs.com/notes/20250720T171730/)
...
-   [워크플로우: 리눅스 스크린샷 도구](https://notes.junghanacs.com/notes/20230608T125600/)

## 지식 검색을 위한 핵심 리눅스 커맨드 도구 가이드

[2022-07-04 Mon 16:37]

## @injae-dotfiles/env.org
...
(“Gnebbia/Kb a Minimalist Command Line Knowledge Base Manager” 2024)
...
[mfaerevaag/wd - github.com](https://github.com/mfaerevaag/wd)

## 2025 프렉티컬리

[2025-07-20 Sun 17:25]
...
-   [bottom (btm)](https://github.com/ClementTsang/bottom) graphical process/system monitor for the terminal
    ```shell
...
[2025-07-20 Sun 16:33]

-   [#LLM: zsync 클라이언트 rsync]
...
### <span class="org-todo done DONT">DONT</span> `mcfly` -- Fly through your shell history. Great Scott!
...
### <span class="org-todo done DONT">DONT</span> @cantino ¤mcfly

[2023-11-14 Tue 17:11] (“Cantino/Mcfly” 2024)

-   Cantino, Andrew 2024
-   Fly through your shell history. Great Scott!

[GitHub - cantino/mcfly: Fly through your shell history. Great Scott!](https://github.com/cantino/mcfly)

삼천포로 또 빠졌네?! 그래도 간만에 생각이 나서 기록하자. 최신 버전이 0.6.1 이네. 업데이트도 해주자. 참고로 나는 아래와 같이 .zshrc 를 사용하고 있다.
