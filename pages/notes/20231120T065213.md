...
[[TIP("이 노트에 대하여")]] 한국어 TTS를 Emacs와 리눅스 환경에서 어떻게 활용할 수 있을지 Piper, EdgeTTS, eSpeak를 중심으로 살핀다. 실제 설치 경험과 한국어 지원 한계를 함께 적어 두어 장기적인 활용 가능성을 가늠하게 한다. [[/TIP]] 관련메타 - [ TTS Text-to-speech](https://notes.junghanacs.com/meta/20250713T112650/)

## 히스토리

-   [2026-04-13 Mon 16:46] pi — Search Console query data로 이 노트가 다시 surfaced 되었고, Piper/eSpeak/EdgeTTS 중심으로 description과 retrieval tags를 보강했다. - [2025-07-13 Sun 11:29] [전자책: 뷰어 TTS Readest Foliate ReadEra calibredb](https://notes.junghanacs.com/notes/20240901T112730/) 리디스트가 리눅스에서 책 읽어주는 것 보고 반했다. 이건 되야할 일이야.
...
[2024-10-29 Tue 12:35] Voices are trained at one of 4 "quality" levels: x_low - 16Khz audio, 5-7M params low - 16Khz audio, 15-20M params medium - 22.05Khz audio, 15-20M params high - 22.05Khz audio, 28-32M params ```shell
...
``` Pied - <span class="org-hashtag">flatpak</span> 패키지로 piper 관리 [2024-10-29 Tue 12:16] <https://github.com/Elleo/pied?tab=readme-ov-file> Pied makes it simple to install and manage text-to-speech Piper voices for use with Speech Dispatcher. Pied installs and configures the Piper neural text-to-speech engine to work with Speech Dispatcher. It can then be used to download and manage different voices. ```shell
...
``` <span class="org-todo done DONT">DONT</span> piper korean 아래 녀석을 변환하면 될 것 같은데 ```shell
...
``` echo 'Welcome to the world of speech synthesis!' | ./piper --model en_US-lessac-medium.onnx --output_file welcome.wav echo '김정한 안녕하세요' | ../piper/piper --model ko_KR-kim-medium.onnx --output_file welcome.wav <span class="org-todo done DONT">DONT</span> vosk [2024-10-29 Tue 13:06] ```shell
pipx install vosk
``` 관련노트 - [워크플로우: 모바일 스마트폰 옵시디언 갤럭시AI 소리내어읽기](https://notes.junghanacs.com/notes/20240613T064804/)

## BIBLIOGRAPHY

## 로그

### [|2025-07-13 Sun 11:26|](https://notes.junghanacs.com/journal/20250707T000000.md#2025-07-13-sun/)
