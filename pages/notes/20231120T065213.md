...
[[TIP("이 노트에 대하여")]] 한국어 TTS를 Emacs와 리눅스 환경에서 어떻게 활용할 수 있을지 Piper, EdgeTTS, eSpeak를 중심으로 살핀다. 실제 설치 경험과 한국어 지원 한계를 함께 적어 두어 장기적인 활용 가능성을 가늠하게 한다. [[/TIP]] 관련메타 - [ TTS Text-to-speech](https://wikidocs.net/381007)

## 히스토리

-   [2026-04-13 Mon 16:46] pi — Search Console query data로 이 노트가 다시 surfaced 되었고, Piper/eSpeak/EdgeTTS 중심으로 description과 retrieval tags를 보강했다. - [2025-07-13 Sun 11:29] [전자책: 뷰어 TTS Readest Foliate ReadEra calibredb](https://wikidocs.net/381299) 리디스트가 리눅스에서 책 읽어주는 것 보고 반했다. 이건 되야할 일이야.
...
pipx install vosk
``` 관련노트 - [워크플로우: 모바일 스마트폰 옵시디언 갤럭시AI 소리내어읽기](https://wikidocs.net/381245)
