...
[[TIP("이 노트에 대하여")]] Emacs 창 관리에서 팝업 버퍼와 레이아웃을 어떻게 나눠 다뤄야 하는지 popper, popwin, shackle을 통해 정리한다. 단순 패키지 소개보다 실제 작업 중 발생한 꼬임을 어떻게 풀었는지가 중요하게 남아 있다. [[/TIP]] 관련패키지 shackle: Enforce rules for popup windows (“Shackle: Enforce Rules for Popup Windows” n.d.) 히스토리 - [|2025-03-28 Fri 11:12|](https://wikidocs.net/380405.md#h-2025-03-28/) 팝업 레이아웃을 정리하긴 해야지
