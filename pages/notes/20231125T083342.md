<!-- gid:20231125T083342 -->
[[TIP("이 노트에 대하여")]]
Emacs 창 관리에서 팝업 버퍼와 레이아웃을 어떻게 나눠 다뤄야 하는지 popper, popwin, shackle을 통해 정리한다. 단순 패키지 소개보다 실제 작업 중 발생한 꼬임을 어떻게 풀었는지가 중요하게 남아 있다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20231125T083342/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2023-11-25T08:33:00+09:00`
...
(“Shackle: Enforce Rules for Popup Windows” n.d.)

## 히스토리

-   [|2025-03-28 Fri 11:12|](https://notes.junghanacs.com/journal/20250324T000000.md#h-2025-03-28/) 팝업 레이아웃을 정리하긴 해야지
-   2024-09-14 현재 상황: <span class="org-hashtag">#둠이맥스</span> 전환 이후, 별도 패키지는 사용하지 않는다.
...
![](../../assets/20231125_090006_screenshot.png)

## 관련노트

## BIBLIOGRAPHY

- “Shackle: Enforce Rules for Popup Windows.” n.d. Accessed April 4, 2023. [https://depp.brause.cc/shackle/](https://depp.brause.cc/shackle/).
