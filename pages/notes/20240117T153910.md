...
[[TIP("이 노트에 대하여")]] Crafted Emacs와 crafted-dotfiles를 가져와 개인 환경에 맞게 손보려는 과정을 기록한다. stow와 동기화 구조까지 함께 고민하며 여러 장치에서 재현 가능한 닷파일 운영을 모색한다. [[/TIP]] [2024-09-25 Wed 15:47] 동작한다. 근데 기능이 부족하다. 그래서 둠이맥스 기반으로 다시 만들었다. [프로젝트: 둠이맥스 스타터 - 최소설정 최대효과](https://wikidocs.net/381314)
