...
[[TIP("이 노트에 대하여")]] wandersoncferreira의 evil.dot.doom 문서를 중심으로 Doom Emacs와 Evil 학습 포인트를 붙잡는다. 생산성을 높이는 모션과 연산자 감각을 어떻게 익힐지에 초점이 맞춰져 있다. [[/TIP]] 히스토리 - [2025-05-25 Sun 18:37] 이만한 닷파일과 문서는 없다. 이 것 보고 둠으로 넘어왔는데 놀랍게도 이 문서는 안봤다. 언젠가 꼼꼼히 봐야할 것 같다. [힣: 이맥스 속성완성 교육프로그램 점진적 학습모델](https://notes.junghanacs.com/notes/20240908T205217/)을 만드려면 이거 봐야 한다.
