<!-- gid:20240201T054549 -->
[[TIP("이 노트에 대하여")]]
Firefox를 리눅스에 직접 설치하고 실행 경로와 데스크톱 엔트리를 구성하는 절차를 적어 둔다. 단순 명령 모음 같지만, 브라우저 환경을 손으로 세팅하는 감각을 빠르게 복원하게 해 준다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240201T054549/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-02-01T05:45:00+09:00`
...
[sudo](https://notes.junghanacs.com/notes/20240201T055927/) 가 여기서 문제였다.

## firefox with intel-gpu-tools vaapi
...
![](../../assets/20250406T160011-firefox-about-config.png)
