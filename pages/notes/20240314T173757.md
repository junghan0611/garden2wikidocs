...
[[TIP("이 노트에 대하여")]] 국가서지 링크드 오픈 데이터와 한국십진분류를 바탕으로 분류체계를 온톨로지 관점에서 읽어 보려는 노트다. RDF와 카테고리 분류를 실제 지식 구조화 프로젝트와 연결하는 실마리를 품고 있다. [[/TIP]] 도서검색 기본은 다음 2가지 이다. - [문헌정보 분류체계 도서 카테고리](https://notes.junghanacs.com/meta/20241202T223128/)
...
[links] RDF 온톨로지 데이터 <https://lod.nl.go.kr/page/KMO202206506> ```text
his page shows information obtained from the SPARQL endpoint at http://lod.nl.go.kr/sparql.
As Turtle | As RDF/XML | As JSON | As N3 | As nTriple
``` <span class="org-todo todo TODO">TODO</span> Emacs 검색 활용 방법 몇개 함수를 넣으면 좋지 않을까 한다. ```text
...
``` Related-Notes - [ 한국십진분류법](https://notes.junghanacs.com/meta/20240312T142358/)
