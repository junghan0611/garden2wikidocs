...
[[TIP("이 노트에 대하여")]] 우분투 리눅스에서 미리 설치해 두면 좋은 패키지와 참고할 만한 환경 구성을 적어 둔다. 장기적인 시스템 세팅보다 당장 필요한 도구를 다시 찾기 위한 실용 메모에 가깝다. [[/TIP]] - [패키지](https://wikidocs.net/380598)

## [2024-05-11 Sat 20:43] 여기 봐봐 설치해야 할 만한 것들 많다. anytype 은 무엇인가? [조나단리브 전산언어학](https://wikidocs.net/382251)
