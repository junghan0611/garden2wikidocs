...
[[TIP("이 노트에 대하여")]] 매일 쓰는 이맥스 패키지와 관련 링크, 키바인딩 아이디어를 느슨하게 모아 둔 컬렉션 노트다. 패키지 자체보다 어떤 감각이 실제 사용에서 중요했는지가 짧게 드러난다. [[/TIP]] 여기에 이블 넣어라! 관련 글을 확장려고 한다. [패키지](https://wikidocs.net/380598) 를 만들었다. 왜?! 중요한 단어다.
