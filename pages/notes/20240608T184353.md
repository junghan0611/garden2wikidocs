...
[[TIP("이 노트에 대하여")]] Emacs 입문자에게 키바인딩 장벽을 낮추는 메뉴 인터페이스와 transient 기반 UX를 정리한다. Casual과 context-menu를 통해 새로운 이맥스 사용 방식을 상상해 보는 노트다. [[/TIP]] BIBLIOGRAPHY 새로운 이맥스 [초보자 입문자](https://notes.junghanacs.com/meta/20230725T144900/)를 위한 새로운 인터페이스의 새 시대가 열렸도다.
