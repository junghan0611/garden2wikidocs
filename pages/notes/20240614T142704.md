<!-- gid:20240614T142704 -->
[[TIP("이 노트에 대하여")]] Org-mode에서 논리 기호를 실제 문서와 코드 안에 어떻게 자연스럽게 써 넣을지 실험한다. 단순 prettify-symbols 설정을 넘어, 문장 관계와 추론을 기호로 압축해 쓰는 감각을 다루는 운용 노트다. [[/TIP]] 히스토리 - [2026-05-01 Fri 15:10] 지피티랑 같이 업데이트 - [2024-06-14 Fri 14:27] 페이지 추가 <span class="org-hashtag">latex</span> 측면에서 보자면, [레이텍: 모음: 기호 심볼 수식](https://notes.junghanacs.com/notes/20240315T075956/)
