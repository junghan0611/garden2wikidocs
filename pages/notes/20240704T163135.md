<!-- gid:20240704T163135 -->
[[TIP("이 노트에 대하여")]]
PDF 파일을 Emacs에서 읽으면서 ChatGPT 계열 도구로 요약하고 질의하는 방법을 질문답변 형식으로 정리한다. 아직 임시적이지만 문서 활용을 대화형으로 바꾸려는 욕구가 잘 드러난다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240704T163135/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-07-04T16:31:00+09:00`
...
## <span class="org-todo todo TODO">TODO</span> 활용 방법 챗봇 대화 - 임시 방편
...
@user 이맥스에서 PDF 파일을 열어서 읽어보는데, 여기에 chatgpt를 연동해서 요약하고 질의하는 방법을 알고 싶어. 찾아봐줄래?

@assistant 이맥스에서 PDF 파일을 열고 ChatGPT를 연동하여 요약과 질의응답을 하는 방법에 대해 설명해드릴게요. 몇 가지 단계로 나뉘어져 있습니다.
...
@user 고마워. 혹시 관련 문제에 대한 자료가 있는지 찾아봐줄래?

@assistant 네, 이맥스와 OpenAI API를 활용한 PDF 요약과 관련된 자료를 제공해드릴 수는 없습니다. 하지만 이러한 작업에 대해 유용한 정보를 얻을 수 있는 몇 가지 리소스를 추천해드릴 수 있습니다.
...
## 이맥스: 문서 파일 협업 시나리오 활용법 - 투두

[2024-07-04 Thu 16:31]
