<!-- gid:20240704T165255 -->
[[TIP("이 노트에 대하여")]]
PAW가 단순 어노테이션 도구를 넘어 언어 학습과 주석 작업을 하나로 묶는 방식에 주목한 노트다. sqlite 기반 저장 구조와 학습 도구로의 확장이 함께 설명된다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240704T165255/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-07-04T16:52:00+09:00`
...
- “Chenyanming/Anki.El.” 2025. [https://github.com/chenyanming/anki.el](https://github.com/chenyanming/anki.el).
- “Chenyanming/Calibredb.El.” 2025. [https://github.com/chenyanming/calibredb.el](https://github.com/chenyanming/calibredb.el).
- “Chenyanming/Paw.” 2025. [https://github.com/chenyanming/paw](https://github.com/chenyanming/paw).
- “Junghan0611/Paw.” 2024. [https://github.com/junghan0611/paw](https://github.com/junghan0611/paw).
- “Paw.El外语学习，高亮笔记，单词本，等一体的新插件（Emacs的蒙哥阅读器、LingQ） - Emacs-General.” 2024. June 3, 2024. [https://emacs-china.org/t/paw-el-emacs-lingq/27331](https://emacs-china.org/t/paw-el-emacs-lingq/27331).

## 소개 Emacs Annotation and Language Learning tool

```text
(package! paw :recipe (:host github :repo "junghan0611/paw" :branch "ko" :files ("*")))
```

-   (“Junghan0611/Paw” 2024)o- "junghan0611/paw" JunghanKim 2024
...
-   [2025-03-07 Fri 17:48] 생성
-   [2025-03-07 Fri 17:53] 엄청 업그레이드 되었던데

[Contacts::chan demon - chenyanming](https://notes.junghanacs.com/meta/20230303T030300.md#h-cae06151-9b6c-4ee4-88bb-00b2c28a8b17/)

## junghan0611/paw

(“Junghan0611/Paw” 2024)

-   <https://github.com/junghan0611/paw>
-   JunghanKim
...
(“Chenyanming/Paw” 2025) (“Paw.El外语学习，高亮笔记，单词本，等一体的新插件（Emacs的蒙哥阅读器、LingQ） - Emacs-General” 2024)
