...
[[TIP("이 노트에 대하여")]] Doom Emacs에서 직접 바꾼 키바인딩과 설정 조각을 시간이 지날수록 모아 두는 기록 노트다. 새끼손가락 보호와 워크스페이스, vterm 같은 실제 사용 맥락이 코드와 함께 남아 있다. [[/TIP]] 히스토리 - [2025-07-13 Sun 16:03] 여기 모으는게 좋겠다. 키바인딩 변경하는 것 - [2024-07-04 Thu 17:04] EGLOT 관련노트 - [키바인딩: 새끼손가락 보호 - 키보드 레이아웃 - 한영키 컨트롤](https://wikidocs.net/381488)
