...
[[TIP("이 노트에 대하여")]] 정주희의 Coq 강의 노트를 중심으로 설치와 에디터 연동, 추가 참고 자료를 한곳에 묶는다. 증명보조기를 처음 배울 때 어떤 순서로 따라가면 좋을지 감을 잡게 해 주는 학습 허브다. [[/TIP]] - (정주희 n.d.) 수리논리전문가로서 coq 를 다룬다. 지금 핫하게 작업 중이시라 실용적 측면에서 아주 좋다. 사실 이론은 이론대로 하지만 실제 구현물을 만들어 내야 의미가 있다. - <https://jhjeong.mindconnect.cc/CoqStudy/> coq 관련 노트 키워드 coq - [notes/ 증명보조기: 콕 설치 오펨 VSCODE '2024-07-08 2025-06-08](https://notes.junghanacs.com/notes/20240708T194652/)
