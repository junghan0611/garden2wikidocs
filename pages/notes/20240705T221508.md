<!-- gid:20240705T221508 -->
[[TIP("이 노트에 대하여")]]
우분투에서 Coq와 coqtop을 어떻게 설치하고 Emacs와 연결할지 실제 명령 중심으로 정리한다. 배포판 패키지와 다른 설치 경로를 비교하며 당장 동작하는 환경을 만드는 데 초점을 둔다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240705T221508/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-07-05T22:15:00+09:00`
...
## [콕 설치는 오펨 활용하라 - 스코드](https://notes.junghanacs.com/notes/20240708T194652/) 여기서 시작!
...
이것이 이맥스에서 할 수 있는 기본적인 설정이다. 이제 할 일은 직접 해보는 것이다. [정주희 (2024) Coq 스터디 가이드](https://notes.junghanacs.com/notes/20240705T220648/) 여기에 실제 교재와 더불어 학습 내용을 기록 하면 된다.
...
-   [증명보조기](https://notes.junghanacs.com/meta/20240928T182304/)

## BIBLIOGRAPHY

- team, The PG dev. n.d. “Proof General - a Generic Emacs Interface for Proof Assistants.” Accessed July 5, 2024. [https://proofgeneral.github.io/](https://proofgeneral.github.io/).
