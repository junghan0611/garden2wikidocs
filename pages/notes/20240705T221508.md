...
[[TIP("이 노트에 대하여")]] 우분투에서 Coq와 coqtop을 어떻게 설치하고 Emacs와 연결할지 실제 명령 중심으로 정리한다. 배포판 패키지와 다른 설치 경로를 비교하며 당장 동작하는 환경을 만드는 데 초점을 둔다. [[/TIP]] - [활용법](https://notes.junghanacs.com/meta/20240821T221314/)
...
``` Related-Notes - [증명보조기](https://notes.junghanacs.com/meta/20240928T182304/)
