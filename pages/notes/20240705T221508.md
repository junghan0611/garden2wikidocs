...
## [콕 설치는 오펨 활용하라 - 스코드](https://wikidocs.net/381273) 여기서 시작!
...
이것이 이맥스에서 할 수 있는 기본적인 설정이다. 이제 할 일은 직접 해보는 것이다. [정주희 (2024) Coq 스터디 가이드](https://wikidocs.net/381268) 여기에 실제 교재와 더불어 학습 내용을 기록 하면 된다.
...
-   [증명보조기](https://wikidocs.net/380686)
