...
-   [정주희 (2024) 콕 증명보조기](https://wikidocs.net/381268)의 시작

기본을 해보는 것. 기본은 배워야 한다. 여태 이렇다 생각 없이 그냥 해보는 것이다. 그래야 배운다. 이제 들어가 보자.

-   [콕 증명 도우미 이맥스 환경의 시작](https://wikidocs.net/381269) 여기에서 일단 시작은 한 바 있다. 보다 디테일하게 나아가자.
...
-   [이맥스: 레이텍: 수식: 입력: 스니펫: 활용법](https://wikidocs.net/381195)
-   [조직모드: 논리 기호 심볼 활용](https://wikidocs.net/381248)
