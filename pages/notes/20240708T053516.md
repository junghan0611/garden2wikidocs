...
[[TIP("이 노트에 대하여")]] 강의 영상을 따라가며 Coq를 Emacs에서 어떻게 다룰지 실습한 기록이다. 온라인 에디터와 이맥스 연동, 수식 입력, 자동완성 같은 실제 사용 감각이 단계적으로 이어진다. [[/TIP]] - [정주희 (2024) 콕 증명보조기](https://wikidocs.net/381268)의 시작
