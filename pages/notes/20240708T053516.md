<!-- gid:20240708T053516 -->
[[TIP("이 노트에 대하여")]]
강의 영상을 따라가며 Coq를 Emacs에서 어떻게 다룰지 실습한 기록이다. 온라인 에디터와 이맥스 연동, 수식 입력, 자동완성 같은 실제 사용 감각이 단계적으로 이어진다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240708T053516/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-07-08T05:35:00+09:00`
...
-   [정주희 (2024) 콕 증명보조기](https://notes.junghanacs.com/notes/20240705T220648/)의 시작

기본을 해보는 것. 기본은 배워야 한다. 여태 이렇다 생각 없이 그냥 해보는 것이다. 그래야 배운다. 이제 들어가 보자.

-   [콕 증명 도우미 이맥스 환경의 시작](https://notes.junghanacs.com/notes/20240705T221508/) 여기에서 일단 시작은 한 바 있다. 보다 디테일하게 나아가자.

## [[강의 동영상 #1](https://youtu.be/zPsYXjJv5Ew)] `(20m58s)`  Coq 소개, 윈도즈 PC에 설치, CoqIDE 둘러보기
...
-   [이맥스: 레이텍: 수식: 입력: 스니펫: 활용법](https://notes.junghanacs.com/notes/20240315T075956/)
-   [조직모드: 논리 기호 심볼 활용](https://notes.junghanacs.com/notes/20240614T142704/)
...
소프트웨어파운데이션 (정주희 n.d.)에 대해서 다룬다.

-   "ProofGeneral/PG: This repo is the new home of Proof General" (“Proofgeneral/Pg: This Repo Is the New Home of Proof General” n.d.) 이 녀석한테 가보자. 여기에서 찾아야 겠다. 메뉴얼을 보려면 인포로 가자.
...
## <span class="org-hashtag">#chatgpt</span> 스니펫 좀 보자. 자연수를 어떻게 입력하는가? 위와 관계 없이 바로 물어보자.

[SYS]: You are a helpful assistant. Please write in Korean language.

@user 자연수 심볼을 어떻게 latex 심볼로 입력하는거야?

@assistant 자연수(Natural Numbers)의 심볼은 보통 'ℕ'으로 나타냅니다. LaTeX에서 자연수를 나타내려면 다음과 같이 입력하면 됩니다:
...
@user coq 에서는 자연수를 어떻게 입력하는거야?

@assistant Coq에서는 자연수를 나타내는 데 \`nat\` 타입을 사용합니다. Coq 표준 라이브러리는 이미 자연수와 관련된 많은 정의와 함수들을 포함하고 있습니다. 예를 들어, 자연수를 정의하고 사용하려면 다음과 같이 할 수 있습니다:
...
@user nat 이외에 coq에서 주로 사용하는 것들을 알려줄래?

@assistant Coq은 강력한 정리 증명 도구로 다양한 데이터 타입과 구조를 광범위하게 사용합니다. \`nat\` 외에도 Coq에서 주로 사용되는 몇 가지 중요한 데이터 타입과 구조는 다음과 같습니다:
...
- 정주희. n.d. “Software Foundations.” Accessed July 5, 2024. [https://softwarefoundations.cis.upenn.edu/](https://softwarefoundations.cis.upenn.edu/).
- “Proofgeneral/Pg: This Repo Is the New Home of Proof General.” n.d. Accessed July 5, 2024. [https://github.com/ProofGeneral/PG](https://github.com/ProofGeneral/PG).
