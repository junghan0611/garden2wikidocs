...
[[TIP("이 노트에 대하여")]] emacs-calc 튜토리얼 저장소와 casual-calc 흐름을 통해 계산기를 실용 수학 도구로 바라본다. 함수별 예제와 학습 자료가 정리되어 있어 실제로 손을 움직이며 익히기 좋은 입구가 된다. [[/TIP]] - [스티븐스트로가츠 비선형 동역학 카오스 미적분 에르베레닝 교양수학 릴리언리버 길위의 수학자](https://wikidocs.net/382161)
