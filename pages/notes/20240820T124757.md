...
[[TIP("이 노트에 대하여")]] Emacs를 왜 쓰는지 설명하는 글과 메타 노트를 모아 두는 컬렉션이다. 비사용자에게 이 도구를 어떻게 말할지, 또 개인 지식도구로서 어떤 이유를 붙일지 탐구하는 입구가 된다. [[/TIP]] 히스토리 - [2025-06-09 Mon 17:08] 왜 힣은 이맥스를 지식도구로 사용하는가? ([힣: 왜 이맥스 as 지식도구 AI노트 - 시대 질문)](https://notes.junghanacs.com/notes/20250428T150343/) 또 왜 이맥스가 개발도구 인가? [힣: 도구 춘추전국시대 키바인딩 통합](https://notes.junghanacs.com/notes/20250321T064938/)
