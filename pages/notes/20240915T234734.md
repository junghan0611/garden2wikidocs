<!-- gid:20240915T234734 -->
[[TIP("이 노트에 대하여")]] kill-region과 delete-region의 차이를 문서와 함께 짧게 정리한 메모다. 킬링 링에 남기느냐 바로 지우느냐 같은 기본 차이를 다시 확인하는 데 유용하다. [[/TIP]] Related-Notes - [이맥스리스프](https://wikidocs.net/380681)
