...
-   [터미널 이맥스 한글 입력 삽질기 — kime→fcitx5→term-keys→wezterm 해결] - [터미널 이맥스 하네스 프론트엔드 완성 — 한글입력·클립보드·SSH·에이전트통합](https://wikidocs.net/382594)
