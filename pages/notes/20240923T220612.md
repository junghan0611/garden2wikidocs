...
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20240923T220612/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-09-23T22:06:00+09:00`
...
3.  **규칙 파일 만들기**:
    ...
    -   여기에 \`no-doubled-conjunctive.yml\` 파일을 생성하고 다음과 같이 규칙을 정의합니다: \`\`\`yaml extends: existence message: 중복된 접속사가 발견되었습니다: '1 달러' level: error scope: text match: \b(그리고 그리고)\b \`\`\`
...
-   [린터: 발레 - 텍스트린트 비교](https://notes.junghanacs.com/notes/20231108T061821/)
