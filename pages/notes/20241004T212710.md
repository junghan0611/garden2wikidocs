<!-- gid:20241004T212710 -->
[[TIP("이 노트에 대하여")]]
수학의 본질을 이해하려면 기호의 언어를 먼저 익혀야 한다는 생각 아래 기호 사전과 예시를 정리한다. 사칙연산에서 대학 수학 기호까지 이어지는 긴 스펙트럼을 한 번에 조망하게 한다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20241004T212710/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2024-10-04T21:27:00+09:00`
...
to understand the essence of math and make it more useful, it is essential to understand the language of math: symbols. symbols are what make math easier, more comfortable, and more flexible for everyone to understand and use. from elementary school math to university-level math symbols, understand all the symbols used in math and get closer to the essence of math. you'll see math in a different way, and your interest in math will grow.
...
[장회익 (2019) 자연철학 강의::그리스 문자와 발음](https://notes.junghanacs.com/bib/20240510T113546.md#h-1cf00852-abbd-48c8-bf0e-402412805699/)
