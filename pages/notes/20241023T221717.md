...
[[TIP("이 노트에 대하여")]] popup frame을 이용해 org-capture나 AI 인터페이스를 시스템 전역에서 호출하는 방법을 정리한다. 워크스페이스를 유지한 채 필요한 기능만 꺼내 쓰려는 이맥스 클라이언트 감각이 인상적이다. [[/TIP]] [옴니](https://wikidocs.net/380708) 인터페이스의 일환이다.
...
``` Related-Notes - [이맥스 팝업 레이아웃 창관리](https://wikidocs.net/381171)
