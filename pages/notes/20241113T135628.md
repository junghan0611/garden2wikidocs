...
[[TIP("이 노트에 대하여")]] SICP 자료를 texi와 info 형식으로 바꿔 이맥스에서 읽기 좋은 매뉴얼로 만들려는 노트다. PDF와 HTML, EPUB 사이에서 무엇을 기준으로 삼을지 고민한 흔적이 남아 있다. [[/TIP]] JunghanKim 2024 "junghan0611/sicp-info info manual" (“Junghan0611/Sicp-Info Info Manual” 2024) Stucture and Interpretation of Computer Progams in info format "neilvandyke.org - SICP in Texinfo Format" (“Neilvandyke.Org - Sicp in Texinfo Format” n.d.) tex -&gt; info 파일 생성 pdf / org 모두 생성가능 sicp 테스트 [2024-11-12 Tue 12:55] tex -&gt; info 파일 생성 pdf / org 모두 생성가능 sicp 테스트 방법은? [활용법: 이맥스 인포 매뉴얼](https://notes.junghanacs.com/notes/20221004T150100/)
