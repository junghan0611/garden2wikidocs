...
[[TIP("이 노트에 대하여")]] 텍스트 하이라이트와 문헌노트 작업을 Org-mode 안에서 이어 주는 도구 활용 흐름을 정리한다. org-zettel-ref-mode를 중심으로 인용과 개요 동기화까지 생각하는 문헌노트 메모다. [[/TIP]] [contacts::lijigang Ignoramus marktext](https://wikidocs.net/380486.md#h-8f3132b2-4a52-4c57-ba43-f79a5145c7c8/) 간단한 개념인데 유용할 때가 있다. 더 복잡해지면 안쓰게 될 것이다.
...
``` Using Scripts to Convert Documents in PDF, ePub, HTML, MD, TXT Formats to Org Files ![](../../assets/20241010T162629--convert-to-org.png) 이 그림이 다 했다. [웹클리퍼: markdownload - 옵시디언](https://wikidocs.net/381352)
