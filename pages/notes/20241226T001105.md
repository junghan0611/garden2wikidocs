<!-- gid:20241226T001105 -->
[[TIP("이 노트에 대하여")]] 서로 다른 글꼴이 같은 크기에서도 다르게 보이는 문제를 face-font-rescale-alist 관점에서 정리한다. 한글과 이모지, 유니코드 심볼이 섞인 Emacs 화면을 고르게 맞추는 실용 노트다. [[/TIP]] 관련메타 - [타이포그래피 폰트](https://wikidocs.net/380978)

## 히스토리

-   [2025-06-22 Sun 15:51] 이 로직 사용하고 있지? 디테일한 방법이야. - [2024-12-25 Wed 05:56] 생성 - [힣: 최적 폰트 탐구 요구사항 터미널 콜아웃 웹 한글 가변폭 고정폭 유니코드 심볼 합자](https://wikidocs.net/381030)
