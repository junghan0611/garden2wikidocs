<!-- gid:20250118T124126 -->
[[TIP("이 노트에 대하여")]] nov 패키지를 이용해 Doom Emacs 안에서 EPUB을 읽고 org 링크와 연결하는 설정을 정리한다. 전자책 독서와 노트 연결을 에디터 안에서 해결하려는 실용적인 기록이다. [[/TIP]] BIBLIOGRAPHY [둠이맥스](https://wikidocs.net/380689)에서 EPUB 보려면 이렇게 하라!
