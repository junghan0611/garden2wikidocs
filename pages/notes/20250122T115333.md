...
[[TIP("이 노트에 대하여")]] Scicloj와 Clay, Emmy를 중심으로 클로저 데이터과학 커뮤니티의 흐름을 따라간다. 라이브 코딩과 시각화, 수식 표현이 어떻게 한 생태계 안에서 이어지는지 볼 수 있다. [[/TIP]] 유튜브 라이브코딩 [라이브코딩](https://notes.junghanacs.com/meta/20250209T203153/)

### Clojure visual-tools 30 - Workflow Demos 4: LLMs in Emacs for Clojure

[2025-02-09 Sun 21:07] - (<i>Clojure Visual-Tools 30 - Workflow Demos 4: Llms in Emacs for Clojure</i> 2025) - (“Scicloj - Visual-Tools Meeting 30 - Workflow Demos 4: LLMs in Emacs for Clojure - Summary &38; Recording - Community Center / Meetups and Events” 2025) - On 2025-01-23, the Clojure visual-tools group had its 30th meeting. This was the forth of a series of meetings where people would demonstrate their Clojure workflows with different tools. Ten people attended. agenda Both stoica94 and adham shared their setup, workflow, and lessons in using LLMs in Emacs for Clojure development. You may find a few of the resources they shared in the text chat. bakbeest briefly shared a tree-based UI for LLM interaction that will be the topic of a future ta... - Visual-tools meeting 30 - Workflow Demos 4 2024 고민 중 내용 [2024-11-14 Thu 17:13] - [비교: 콰르토 쿼츠 휴고 클레이 클럭 with 조직모드](https://notes.junghanacs.com/notes/20241203T123857/)
