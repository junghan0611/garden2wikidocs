...
[[TIP("이 노트에 대하여")]] 판독과 pandoc 변환 과정에서 나타나는 한글 NFD/NFC 정규화 문제를 실전 사례와 함께 설명한다. 터미널 환경과 AI 협업에서도 반복해서 마주칠 수 있는 중요한 인코딩 메모다. [[/TIP]] 관련메타 - [유니코드](https://wikidocs.net/380672)
...
-   [2025-11-14 Fri 08:05] 링크 엄청 중요한 문제를 해결한 것이다. - [memex-kb: Legacy 문서 RAG 파이프라인 입구](https://wikidocs.net/381806)
...
[2025-02-09 Sun 11:51] (“Astoff/Code-Cells.El: Emacs Utilities for Code Split into Cells, Including Jupyter Notebooks” n.d.) 텍스트는 텍스트를 수정하는 것만 해야지 양식이 바뀜 [ 리터레이트 프로그래밍 이맥스 콰르토 주피터](https://wikidocs.net/381236) 여기에 기록함
