<!-- gid:20250129T215257 -->
[[TIP("이 노트에 대하여")]] Pandoc 기반 문서 변환과 Emacs 설정이 어디서 어떻게 연결되는지 코드와 참고 노트를 통해 정리한다. 전자책과 문서 변환 워크플로우를 지속적으로 다듬는 기반 노트다. [[/TIP]] BIBLIOGRAPHY 관련연구 - [판독](https://notes.junghanacs.com/meta/20240211T101911/)
