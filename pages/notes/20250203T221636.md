...
- [소개: The Book of Secret Knowledge](#소개-the-book-of-secret-knowledge)
    ...
    - [For whom?](#for-whom)
    - [junghan0611/the-book-of-secret-knowledge](#junghan0611-the-book-of-secret-knowledge)
- [CLI Tools](#cli-tools)
    - [Shells](#shells)
    ...
    - [System Diagnostics/Debuggers](#system-diagnostics-debuggers)
    - [Log Analyzers](#log-analyzers)
    - [Databases](#databases)
    - [TOR](#tor)
    - [Messengers/IRC Clients](#messengers-irc-clients)
...
- [GUI Tools](#gui-tools)
    ...
    - [Messengers/IRC Clients](#messengers-irc-clients)
    - [Messengers (end-to-end encryption)](#messengers--end-to-end-encryption)
    - [Text editors](#text-editors)
- [Web Tools](#web-tools)
    - [Browsers](#browsers)
    - [SSL/Security](#ssl-security)
    - [HTTP Headers &amp; Web Linters](#http-headers-and-web-linters)
    - [DNS](#dns)
    - [Mail](#mail)
    - [Encoders/Decoders and Regex testing](#encoders-decoders-and-regex-testing)
    - [Net-tools](#net-tools)
    - [Privacy](#privacy)
    - [Code parsers/playgrounds](#code-parsers-playgrounds)
    - [Performance](#performance)
    - [Mass scanners (search engines)](#mass-scanners--search-engines)
    - [Generators](#generators)
    - [Passwords](#passwords)
    - [CVE/Exploits databases](#cve-exploits-databases)
    - [Mobile apps scanners](#mobile-apps-scanners)
    - [Private Search Engines](#private-search-engines)
    - [Secure Webmail Providers](#secure-webmail-providers)
    - [Crypto](#crypto)
    - [PGP Keyservers](#pgp-keyservers)
- [Systems/Services](#systems-services)
    - [Operating Systems](#operating-systems)
    - [HTTP(s) Services](#http--s--services)
...
- [Containers/Orchestration](#containers-orchestration)
    ...
    - [Web Tools](#web-tools)
    - [Security](#security)
    - [Manuals/Tutorials/Best Practices](#manuals-tutorials-best-practices)
- [Manuals/Howtos/Tutorials](#manuals-howtos-tutorials)
    - [Shell/Command line](#shell-command-line)
    - [Text Editors](#text-editors)
    - [Python](#python)
    - [Sed &amp; Awk &amp; Other](#sed-and-awk-and-other)
    - [\\\*nix &amp; Network](#nix-and-network)
    - [Microsoft](#microsoft)
    ...
    - [Ebooks](#ebooks)
    - [Other](#other)
- [Inspiring Lists](#inspiring-lists)
    - [SysOps/DevOps](#sysops-devops)
    - [Developers](#developers)
    - [Security/Pentesting](#security-pentesting)
    - [Other](#other)
- [Blogs/Podcasts/Videos](#blogs-podcasts-videos)
    - [SysOps/DevOps](#sysops-devops)
    - [Developers](#developers)
    - [Geeky Persons](#geeky-persons)
    - [Geeky Blogs](#geeky-blogs)
    - [Geeky Vendor Blogs](#geeky-vendor-blogs)
    - [Geeky Cybersecurity Podcasts](#geeky-cybersecurity-podcasts)
    - [Geeky Cybersecurity Video Blogs](#geeky-cybersecurity-video-blogs)
    - [Best Personal Twitter Accounts](#best-personal-twitter-accounts)
    - [Best Commercial Twitter Accounts](#best-commercial-twitter-accounts)
    - [A piece of history](#a-piece-of-history)
    - [Other](#other)
- [Hacking/Penetration Testing](#hacking-penetration-testing)
    - [Pentesters arsenal tools](#pentesters-arsenal-tools)
    - [Pentests bookmarks collection](#pentests-bookmarks-collection)
    - [Backdoors/exploits](#backdoors-exploits)
    - [Wordlists and Weak passwords](#wordlists-and-weak-passwords)
    - [Bounty platforms](#bounty-platforms)
    - [Web Training Apps (local installation)](#web-training-apps--local-installation)
    - [Labs (ethical hacking platforms/trainings/CTFs)](#labs--ethical-hacking-platforms-trainings-ctfs)
...
- [Your daily knowledge and news](#your-daily-knowledge-and-news)
    ...
    - [Security](#security)
    - [Other/All-in-one](#other-all-in-one)
- [Other Cheat Sheets](#other-cheat-sheets)
- [Shell One-liners](#shell-one-liners)
    - [Table of Contents](#table-of-contents)
    - [Tool: terminal](#tool-terminal)
    - [Tool: busybox](#tool-busybox)
    - [Tool: mount](#tool-mount)
    - [Tool: fuser](#tool-fuser)
    - [Tool: lsof](#tool-lsof)
    - [Tool: ps](#tool-ps)
    - [Tool: find](#tool-find)
    - [Tool: top](#tool-top)
    - [Tool: vmstat](#tool-vmstat)
    - [Tool: iostat](#tool-iostat)
    ...
    - [Tool: tar](#tool-tar)
    - [Tool: dump](#tool-dump)
    - [Tool: cpulimit](#tool-cpulimit)
    - [Tool: pwdx](#tool-pwdx)
    - [Tool: taskset](#tool-taskset)
    - [Tool: tr](#tool-tr)
    - [Tool: chmod](#tool-chmod)
    - [Tool: who](#tool-who)
    - [Tool: last](#tool-last)
    - [Tool: screen](#tool-screen)
    - [Tool: script](#tool-script)
    - [Tool: du](#tool-du)
    - [Tool: inotifywait](#tool-inotifywait)
    - [Tool: openssl](#tool-openssl)
    - [Tool: secure-delete](#tool-secure-delete)
    - [Tool: dd](#tool-dd)
    - [Tool: gpg](#tool-gpg)
    - [Tool: system-other](#tool-system-other)
    - [Tool: curl](#tool-curl)
    - [Tool: httpie](#tool-httpie)
    - [Tool: ssh](#tool-ssh)
    - [Tool: linux-dev](#tool-linux-dev)
    - [Tool: tcpdump](#tool-tcpdump)
    - [Tool: tcpick](#tool-tcpick)
    - [Tool: ngrep](#tool-ngrep)
    - [Tool: hping3](#tool-hping3)
    - [Tool: nmap](#tool-nmap)
    - [Tool: netcat](#tool-netcat)
    - [Tool: gnutls-cli](#tool-gnutls-cli)
    - [Tool: socat](#tool-socat)
    - [Tool: p0f](#tool-p0f)
    - [Tool: netstat](#tool-netstat)
    - [Tool: rsync](#tool-rsync)
    - [Tool: host](#tool-host)
    - [Tool: dig](#tool-dig)
    - [Tool: certbot](#tool-certbot)
    - [Tool: network-other](#tool-network-other)
    - [Tool: git](#tool-git)
...
- “Junghan0611/the-Book-of-Secret-Knowledge: A Collection of Inspiring Lists, Manuals, Cheatsheets, Blogs, Hacks, One-Liners, Cli/Web Tools and More.” 2024. [https://github.com/junghan0611/the-book-of-secret-knowledge](https://github.com/junghan0611/the-book-of-secret-knowledge).
...
![](../../assets/20250616T145920-secretbook-repo-title.png)

### For whom?

For everyone, really. Here everyone can find their favourite tastes. But to be perfectly honest, it is aimed towards System and Network administrators, DevOps, Pentesters, and Security Researchers.

### junghan0611/the-book-of-secret-knowledge

A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. :2024: (“Junghan0611/the-Book-of-Secret-Knowledge: A Collection of Inspiring Lists, Manuals, Cheatsheets, Blogs, Hacks, One-Liners, Cli/Web Tools and More.” 2024)
...
-   [**TLScan**](https://github.com/mjol/TLScan) - pure python, SSL/TLS protocol and cipher scanner/enumerator.
...
-   [**privacyguides.org**](https://www.privacyguides.org/) - provides knowledge and tools to protect your privacy against global mass surveillance.
...
-   [**maltiverse**](https://www.maltiverse.com/search) - is a service oriented to cybersecurity analysts.
...
-   [**InQuest Labs**](https://labs.inquest.net) - InQuest Labs is an open, interactive, and API driven data portal for security researchers.
...
-   [\*pythonium.net](https://pythonium.net/) - collection of Python tools
...
-   [**50M\\_CTF\\_Writeup**](https://github.com/manoelt/50M_CTF_Writeup) - 50 million 달러 CTF from Hackerone - writeup.
...
-   [**sha256algorithm**](https://sha256algorithm.com/) - sha256 algorithm explained online step by step visually.
...
-   [**TOP500 Supercomputers**](https://www.top500.org/) - shows the 500 most powerful commercially available computer systems.
-   [**How to build a 8 GPU password cracker**](https://www.shellntel.com/blog/2017/2/8/how-to-build-a-8-gpu-password-cracker) - hours of frustration like desktop components do.
...
-   [**How to Do Things at ARL**](http://web.archive.org/web/20190221103734/https://ftp.arl.army.mil/~mike/howto/) - how to configure modems, scan images, record CD-ROMs, and other. **\\\***
...
-   [**Metasploit**](https://www.metasploit.com/) - tool and framework for pentesting system, web and many more.
...
-   [**statistically-likely-usernames**](https://github.com/insidetrust/statistically-likely-usernames) - wordlists for creating statistically likely username lists.
...
plaintext ➡️ 🔑 ➡️ ciphertext plaintext ⬅️ 🔑 ⬅️ ciphertext (:key: shared key)

_Asymmetric encryption_

plaintext ➡️ 🔑 ➡️ ciphertext plaintext ⬅️ 〽️ ⬅️ ciphertext (:key: public key, :part\\_alternation\\_mark: private key)
...
-   [terminal](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-terminal)
-   [busybox](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-busybox)
-   [mount](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-mount)
-   [fuser](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-fuser)
-   [lsof](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-lsof)
-   [ps](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-ps)
-   [top](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-top)
-   [vmstat](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-vmstat)
-   [iostat](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-iostat)
-   [strace](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-strace)
-   [kill](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-kill)
-   [find](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-find)
-   [diff](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-diff)
-   [vimdiff](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-vimdiff)
-   [tail](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-tail)
-   [cpulimit](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-cpulimit)
-   [pwdx](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-pwdx)
-   [tr](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-tr)
-   [chmod](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-chmod)
-   [who](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-who)
-   [last](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-last)
-   [screen](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-screen)
-   [script](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-script)
-   [du](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-du)
-   [inotifywait](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-inotifywait)
-   [openssl](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-openssl)
-   [secure-delete](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-secure-delete)
-   [dd](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-dd)
-   [gpg](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-gpg)
-   [system-other](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-system-other)
-   [curl](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-curl)
-   [httpie](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-httpie)
-   [ssh](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-ssh)
-   [linux-dev](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-linux-dev)
-   [tcpdump](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-tcpdump)
-   [tcpick](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-tcpick)
-   [ngrep](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-ngrep)
-   [hping3](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-hping3)
-   [nmap](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-nmap)
-   [netcat](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-netcat)
-   [socat](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-socat)
-   [p0f](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-p0f)
-   [gnutls-cli](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-gnutls-cli)
-   [netstat](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-netstat)
-   [rsync](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-rsync)
-   [host](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-host)
-   [dig](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-dig)
-   [certbot](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-certbot)
-   [network-other](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-network-other)
-   [git](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-git)
-   [awk](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-awk)
-   [sed](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-sed)
-   [grep](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-grep)
-   [perl](https://github.com/junghan0611/the-book-of-secret-knowledge#tool-perl)
...
-   [Domain resolve](https://github.com/junghan0611/the-book-of-secret-knowledge#domain-resolve)
-   [Get ASN](https://github.com/junghan0611/the-book-of-secret-knowledge#get-asn)
