...
[[TIP("이 노트에 대하여")]] Org Babel에서 Python 코드 블록을 다루는 핵심 문서를 가져와 세션과 실행 흐름까지 정리한다. 주피터와 비교하면서 바벨 기반 작업법을 이해하는 데 유용한 노트다. [[/TIP]] 관련메타 - [ 바벨](https://wikidocs.net/380803)
...
-   [2025-07-17 Thu 18:00] 바벨 관련 - [2025-02-17 Mon 15:11] worg에서 통재로 가져옴. 이 문서를 다루면 세션까지 다 커버가 된다. 이맥스에서 파이썬 콰르토는 기대하기 어렵다. - [ob-jupyter 조직모드 바벨 파이썬 주피터](https://wikidocs.net/381236) 주피터를 이용할 경우
