...
[[TIP("이 노트에 대하여")]] 이 노트는 더 이상 Doom Emacs의 Org version mismatch 경고를 다루지 않는다. 그 문제는 이미 지나간 문제로 ARCHIVE에 남겼다. 이제 이 URL은 Emacs 27에서 31까지의 버전 흐름과, 그 흐름이 힣의 지식 작업·터미널 하네스·에이전트 협업에 어떤 의미를 가졌는지를 묶는 버전 연대기다. [[/TIP]] 히스토리 - [2026-06-06 Sat 10:55] pi — stale Org version mismatch 노트를 Emacs 버전 연대기 노트로 재작성. 기존 해결 기록은 ARCHIVE에 보존하고, 공개 URL은 그대로 살린다. - [2026-06-06 Sat 10:52] <span class="org-mention">junghan</span> — 노트를 이맥스 버전 기록으로 시간축 정렬을 하려는 중이야. 기존 노트는 "거슬리는 Org version mismatch 경고를 빌트인 elc 파일과 비동기 네이티브 컴파일 관점에서 해결한다. 문제 아닌 문제 같지만 자주 마주치는 귀찮음을 정리한 노트다." 였었는데 그건 ARCHIVE로 옮겨서 정리했다. - [2025-04-02 Wed 10:17] 도 아닌 도. 그냥 해결 되는 문제 아닌 문제 - [2025-02-24 Mon 21:00] 아주 귀찮게 하는 문제 관련메타 - [ 안드로이드 이맥스](https://notes.junghanacs.com/meta/20230829T110900/)
-   [aprj 아카이브 통합정리: 정한의 삽질 연대기 2008-2026](https://notes.junghanacs.com/botlog/20260302T130000/)
...
-   [EWS-이맥스-글쓰기-공작실] - [karthink-이맥스-구루-지피텔](https://notes.junghanacs.com/bib/20250110T104339/)
...
-   [힣: 스크린샷 범용 지식도구 - 안드로이드 덱스 호환 이맥스 일체형컴퓨터](https://notes.junghanacs.com/notes/20220928T112300/)
...
-   [힣: i-am-emacs neomacs 이맥스 코어 리서치](https://notes.junghanacs.com/notes/20260209T123532/)
...
이 축은 [터미널 이맥스 하네스 프론트엔드 완성 한글입력 클립보드 SSH원격 독립인스턴스 에이전트통합](https://notes.junghanacs.com/botlog/20260413T111237/) 노트와 이어진다.
...
[힣: i-am-emacs neomacs 이맥스 코어 리서치](https://notes.junghanacs.com/notes/20260209T123532/)는 이 축을 다룬다. Rust로 Emacs를 다시 구현한다는 것은 단순 포팅이 아니라, Lisp runtime, display, GC, keyboard/input, package bootstrap fidelity를 모두 재현해야 하는 어마어마한 작업이다. 관심을 둘 수밖에 없다.
