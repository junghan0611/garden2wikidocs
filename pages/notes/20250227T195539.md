<!-- gid:20250227T195539 -->
[[TIP("이 노트에 대하여")]] outli-mode와 outline 이동 키를 Alt 계열로 통일해 손가락 부담을 줄이려는 실제 설정을 담는다. imenu와 heading 이동 감각을 하나의 리듬으로 맞추는 노트다. [[/TIP]] BIBLIOGRAPHY History - [2025-02-27 Thu 19:55] 손가락 박살 나기 전에 통일하라 키바인딩 설정 방법 - 메타로 통일한다 - [둠이맥스: 이맥스리스프 키바인딩 설정](https://wikidocs.net/381261)
