...
- 최근 수정: `2026-07-29T16:13:00+09:00`
[[/TIP]]
...
-   [어쏠로그](https://wikidocs.net/380758) — 바깥의 라이브 날것을 가든의 정본으로 회수하는 글쓰기 방식.
...
-   [힣: 일이란 최선을다한다는것 어쏠로그 소명](https://wikidocs.net/381423) — 일과 최선, 운명애와 소명을 다시 묻는 형제 글.
-   [힣: 아무도 읽지 않는 블로그 디지털가든 왜 공개 하는가](https://wikidocs.net/381520) — 보상이나 독자보다 오늘의 행위 자체를 사는 공개의 태도.
-   [힣: 원석 날것을 휘갈긴다 — POSSE 너머 ROSSE, 그리고 일일일생으로의 회귀](https://wikidocs.net/381617) — 페이스북 라이브 글을 가든 정본으로 되돌리는 운영 원칙.
-   [이미 하던 소명이 생존 가능한 일자리와 만나기를 바라는 구직 좌표](https://wikidocs.net/381508)
...
아. 에이전트들이 이런 단어를 매우 좋아하지요. 아 그럼 이만. <https://wikidocs.net/381589>
[[/TIP]]
...
[2026-07-29 Wed 16:16] <span class="org-mention">@junghan</span> — 어디보자. 헉 힣맨이 참 멩하게 서있구먼
