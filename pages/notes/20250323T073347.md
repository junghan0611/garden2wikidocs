...
-   [둠이맥스모듈에디터 editor 편집기의 하위 분류](https://notes.junghanacs.com/notes/20250323T072708/)

## History

-   [2025-03-23 Sun 07:33] fold tree-sitter 걸린다. 관련 패키지 alexmurray/evil-vimish-fold (“Alexmurray/Evil-Vimish-Fold” 2024) - - Murray, Alex - - 2024 emacs-tree-sitter/ts-fold (“Emacs-Tree-Sitter/Ts-Fold” 2025) - - - Code-folding using tree-sitter - 2025 EmacsWiki: Hide Show (“Emacswiki: Hide Show” n.d.) z 하나의 바인딩만 활용 [2025-03-23 Sun 07:40] 둠이맥스의 경우 이미 갖춰져 있으니 공통 바인딩을 사용하면 된다. z 로 시작하는 바인딩. 능력 껏 패키지 골라서 해줄 것이다. ![](../../assets/20250323T074231-fold-bindings.png) ```elisp
...
``` [|2025-03-23 Sun 07:33|](https://notes.junghanacs.com/journal/20250317T000000.md#h-2025-03-23/)
