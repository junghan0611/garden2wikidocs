...
[[TIP("이 노트에 대하여")]] 노트 목록에서 파일명만 더 깔끔하게 보고 최근 수정 순으로 정렬하고 싶다는 문제의식에서 출발한다. Marginalia와 Vertico를 자신에게 맞게 다듬는 편집기 취향 노트다. [[/TIP]] BIBLIOGRAPHY 관련메타 - [완성](https://notes.junghanacs.com/meta/20250130T064822/)

## Related Notes

-   [조직모드 빈라인 지우기](https://notes.junghanacs.com/notes/20250416T182533/)
-   [이맥스 자동완성 프레임워크 - corfu vertico consult embark](https://notes.junghanacs.com/notes/20220921T103700/)

## History

-   [2025-03-27 Thu 12:35] <span class="org-todo done DONE">DONE</span> 11:18 버그픽스 필요 - vertico childframe 문제개요 쓰고 있는 노트에 기존 노트를 연결하려고 한다. 키보드로 뭐 하나 누르면 된다. 노트 목록이 나온다. 근데 뒤에 덕지덕지 정보가 붙어 있다. 지저분하다. 불편하다. 파일명만 나오면 된다. 파일명에 다 들어 있으니까. 대략 이 정도면 충분하다. 그럼에도 좀 바꾸고 싶다. 특히 노트 목록의 순서를 어떻게? 알파벳 순으로? 한글 순으로? 최근 수정 한 노트 순서로 정렬하는 것은? 아무렴 다 된다. 카테고리를 적용하면 된다. 스크린샷 ![](../../assets/20250327T111700-marginalia-annotator-none-category-file.png) 로그 [|2025-03-27 Thu 12:35|](https://notes.junghanacs.com/journal/20250324T000000.md#h-2025-03-27/)
