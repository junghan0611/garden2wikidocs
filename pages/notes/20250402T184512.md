...
[[TIP("이 노트에 대하여")]] elysium과 gpt-babel, copilot-chat이 코드블록과 리터레이트 프로그래밍 안에서 어떤 역할을 하는지 비교한다. Emacs 안의 AI 코딩 도구 선택지를 구조적으로 보는 노트다. [[/TIP]] BIBLIOGRAPHY 히스토리 - [2025-07-18 Fri 09:15] 이거 중요하다. gpt-babel 테스트 - [2025-03-19 Wed 18:13] 이맥스에서 코딩 도구. gpt-babel [2025-07-18 Fri 09:17] - [2b1h1a 조직모드 코드블록 업데이트 gpt-babel](https://notes.junghanacs.com/notes/20250117T091018/)

## 기본도구 고민

[2025-03-19 Wed 18:13] gptel elysium이 보다 빠르다. gemini 2.0 flash를 사용했는데 아무렴 일단 gptel을 사용하기에 답변이 한글이다 (프롬프트 변경 필요). 그리고 작성 한 뒤에 바로 조직모드로 변환할 수 있다. Copilot-chat - [chep copilot-chat.el 깃허브 코파일럿 이맥스 패키지](https://notes.junghanacs.com/notes/20241019T193836/)

그러나 코파일럿 챗의 경우 느리다. 답변이 영어인데 이걸 커스텀하는게 가능한가? 아무렴 모르겠다만 이렇게 안하는게 더 좋을 것 같다.

#### copilot-chat screenshot

[2025-03-19 Wed 18:13] ![](../../assets/20250319T181325--copilot-chat-explain.png) 로그 [|2025-07-18 Fri 09:27|](https://notes.junghanacs.com/journal/20250714T000000.md#2025-07-18-fri/)
