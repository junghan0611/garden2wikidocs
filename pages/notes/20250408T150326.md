<!-- gid:20250408T150326 -->
[[TIP("이 노트에 대하여")]] Emacs 버전업과 재설치 이후 Stow 링크가 꼬이는 문제를 스크립트로 해결하려는 노트다. 빌드 설치를 반복하는 환경에서 꼭 필요한 재연결 절차를 담고 있다. [[/TIP]] BIBLIOGRAPHY History - [2025-04-08 Tue 15:03] 이 부분은 그냥 일단 스크립트 넣어 둔다 Related-Notes - [이맥스 설치 - PPA 및 빌드 리눅스](https://wikidocs.net/381445)
