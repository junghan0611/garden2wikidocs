<!-- gid:20250414T155953 -->
[[TIP("이 노트에 대하여")]] Org heading을 특정 denote 파일로 복사하거나 이동하는 커스텀 refile 함수를 담고 있다. 데일리 루틴의 흔적을 적절한 노트로 퍼뜨리는 워크플로우 노트다. [[/TIP]] BIBLIOGRAPHY Related Notes - [내보내기 업데이트](https://notes.junghanacs.com/meta/20250416T171517/)
