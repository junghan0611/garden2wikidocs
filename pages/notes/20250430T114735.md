...
[[TIP("이 노트에 대하여")]] 그리스 문자와 발음, 수식 기호 활용, 그리고 에우다이모니아·아레테·프로네시스·에피스테메·테크네 같은 고대 그리스 개념어를 함께 모은 참고 허브다. 이 문서는 autholog가 아니라, 힣의 가든에서 반복해서 호출되는 문자·기호·개념어의 기준점이다. [[/TIP]] 히스토리 - [2026-07-08 Wed 17:05] mitsein — 제목·태그·표준 구조를 정비했다. 이 문서는 autholog가 아니라 그리스어 문자·기호·개념어 참고 허브로 둔다. - [2026-07-08 Wed 16:50] [옛 고대 그리스 개념어 방](https://notes.junghanacs.com/notes/20250423T083718/)의 프로네시스·에우다이모니아·테크네 등 12개 개념어 자료를 이 문서로 합쳤다. 그 방은 새 autholog로 재사용한다.
-   [2025-04-30 Wed 11:47] 그리스 문자를 활용하려고 해. [노트테이킹, 유니코드: № ↔ → ∉ ⊢ 기호 파일명](https://notes.junghanacs.com/notes/20241225T052744/) 컨셉.

## 관련메타

-   [개념어 단어 용어 어휘 전문 키워드 동의어 다의어](https://notes.junghanacs.com/meta/20240806T124350/) — 이 노트의 주 역할은 문자와 개념어의 재사용 허브다.
-   [철학 105](https://notes.junghanacs.com/meta/20250428T160957/) — 에우다이모니아·아레테·프로네시스가 속한 고대 철학 개념의 큰 자석.
-   [지식](https://notes.junghanacs.com/meta/20250424T230029/) — 에피스테메와 테크네를 지식의 다른 양식으로 연결한다.
-   [예술 기예 테크네](https://notes.junghanacs.com/meta/20240822T135953/) — techne를 기예·제작·하네스의 언어로 잇는 메타.
-   [인지 메타인지 인지심리 인지과학 인식](https://notes.junghanacs.com/meta/20241022T044124/) — phronesis/episteme가 인식과 실천지의 축으로 이어지는 자리.
-   [이맥스](https://notes.junghanacs.com/meta/20230521T215600/) — 그리스 문자와 유니코드 기호가 실제 노트테이킹/편집 환경에서 쓰이는 자리.

## 관련노트

-   [아리스토텔레스 (BC384-322) 철학자](https://notes.junghanacs.com/bib/20250423T083014/) — 에우다이모니아와 실천철학의 기준 인물.
-   [힣: 랜덤 포춘쿠키와 웨이 — 행복 에우다이모니아 모닝페이지](https://notes.junghanacs.com/notes/20241214T070506/) — 에우다이모니아가 힣의 autholog에서 쓰인 자리.
-   [힣: 에이전트 구도자 테크노퓨달리즘 — 창조의 씨앗과 21세기 데이비드 봄](https://notes.junghanacs.com/notes/20250423T083718/) — 옛 고대 그리스 개념어 방을 새 autholog로 재사용한 자리.
-   [힣: 어쏠로지 유니코드 기호 파일명 의미 설계](https://notes.junghanacs.com/notes/20241225T052744/) — 기호를 파일명과 의미 설계에 쓰는 기준 노트.
-   [장회익 자연철학 온생명 스승 물리학](https://notes.junghanacs.com/bib/20240510T113546/) — 그리스 문자 표를 실제로 참조하던 맥락.
-   [김도형 데이터과학 수학 파이썬 콰르토](https://notes.junghanacs.com/bib/20250124T063021/) — 수식/데이터과학 문맥에서 그리스 문자가 쓰이는 자리.
-   [모티머애들러 파이데이아 평생공부 가이드 브리태니커 폴리매스](https://notes.junghanacs.com/bib/20250415T142810/) — 고전 개념어를 평생공부/교양의 언어로 되살리는 축.
...
(“Phi (/FaꞮ/;[1] Uppercase Φ, Lowercase Φ or Φ 그리스문자” 2024) Φ φ / 피 — 그리스문자 나무위키 (“Φ Φ / 피 그리스문자 나무위키” 2024) Φ φ / 피 대문자가 Φ, 소문자는 φ. 양순음 인 Π/π (파이)와는 달리 순치음 발음이다. 라틴 문자. 그리스 알파벳 — 문자와 기호의 바닥 (“그리스 알파벳 Greek Alphabet” 2025) EN KO 그리스 알파벳은 기원전 9세기 말 또는 8세기 초부터 그리스어를 표기하는 데 사용되었습니다. 초기 페니키아 알파벳에서 파생되었으며 모음과 자음을 체계적으로 표기하는 가장 초기의 알파벳 문자입니다. 고대와 초기 고전 시대에는 그리스 알파벳이 여러 지역 변형으로 존재했지만, 기원전 4세기 말에는 알파부터 오메가까지 24개의 문자가 배열된 이오니아 기반의 유클리드 알파벳이 그리스어권 전역에서 표준이 되었으며 오늘날에도 그리스 문자에 사용되는 버전입니다. - 24글자의 대문자와 소문자 형태는 다음과 같습니다: Α α, Β β, Γ γ, Δ δ, Ε ε, Ζ ζ, Η η, Θ θ, Ι ι, Κ κ, Λ λ, Μ μ, Ν ν, Ξ ξ, Ο ο, Π π, Ρ ρ, Σ σ ς, Τ τ, Υ υ, Φ φ, Χ χ, Ψ ψ, Ω ω. 그리스 알파벳은 라틴 문자, 고딕 문자, 콥트 문자, 키릴 문자와 같은 여러 문자의 조상입니다. 고대 그리스어에는 각 문자의 대문자 형태가 하나씩만 있었습니다. 분음 부호도 없고 구두점도 거의 없이 쓰여졌습니다. 9세기에 이르러 비잔틴 서기관들은 대문자의 필기체 스타일에서 파생된 소문자 형태를 사용하기 시작했습니다. 기원전 5세기부터 현재까지 그리스어의 발음이 크게 변했기 때문에 일부 문자의 소리값과 기존 표기법이 고대 그리스어와 현대 그리스어에서 다르게 사용되고 있습니다. 또한 현대 그리스어와 고대 그리스어는 현재 서로 다른 분음 부호를 사용하며, 고대 그리스어는 다성 철자법을 사용하고 현대 그리스어는 강세 악센트(악센트)와 분음 부호만 유지합니다. 고대 그리스어와 현대 그리스어 모두 그리스어를 표기하는 데 사용되는 것 외에도 오늘날 그리스 알파벳은 수학, 과학 및 기타 여러 분야의 국제 기술 기호 및 레이블의 원천으로도 사용되고 있습니다. 그리스 문자 표와 발음 [장회익 자연철학 온생명 스승](https://notes.junghanacs.com/bib/20240510T113546/) 선생님 책 말이야.
...
-   [김도형 데이터과학 수학 파이썬 콰르토](https://notes.junghanacs.com/bib/20250124T063021/)
...
[[TIP("예시")]] 이 책에서는 모든 코드를 주피터 노트북(Jupyter notebook)으로 실행한다. 주피터 노트북에서는 TeX(택스가 아니라 텍이라고 읽는다)이라는 조판언어를 사용하여 수식을 표현할 수 있다. 우선 주피터 노트북에서 코드 셀(code cell)이 아닌 마크다운 셀(markdown cell)을 하나 생성한다. 메뉴에서 "Insert" &gt; "Insert Cell Below" 명령으로 코드 셀을 만든 뒤 해당 셀을 클릭하고 메뉴에서 "Cell" &gt; "Cell Type" &gt; "Markdown" 명령을 실행한다. 이 마크다운 셀 안에서 \`$\`(달러) 기호를 이용하면 수식을 표현할 수 있다. 수식에서 그리스 문자를 표시하려면 그리스 문자의 영어 표기법앞에 백슬레시(\`\\\`) 기호를 붙인다. 예를 들어 알파는 \`&alpha;\`, 베타는 \`&beta;\`라고 쓴다. 수식에는 문장 안에서 일부 단어가 수식인 인라인(inline) 수식과 독립된 문단이 되는 디스플레이(display) 수식이 있다. \`\\(\`와 \`\\)\`사이의 수식은 문장내의 인라인 수식을 쓸 때 사용하고 \`\\[\`와 \`\\]\`사이의 수식은 디스플레이 수식을 쓸 때 사용한다. 예를 들어 문장 내에서 \`$ &alpha; = &beta; $\`라고 쓰면 $ &alpha; = &beta; $로 나타난다. 독립된 수식의 경우 [[/TIP]] \\[ \alpha = \beta \\] ```text

라고 쓰면 다음처럼 독립된 문단으로 수식이 표시된다.

$$ \alpha = \beta $$
``` 연습 문제 1.1.2 주피터 노트북을 하나 만들고 인라인 수식과 디스플레이 수식으로 알파부터 오메가까지 써본다. 고대 그리스 개념어 — 에우다이모니아에서 테크네까지 [2026-07-08 Wed 16:50] 이 절은 옛 [고대 그리스어 용어 - 프로네시스](https://notes.junghanacs.com/notes/20250423T083718/) 방에서 합친 자료다. 그리스 문자 노트는 autholog가 아니라 참고 허브이므로, 문자·기호·개념어를 한곳에 둔다. 프로네시스, 에우다이모니아, 테크네 같은 단어는 힣의 가든에서 반복적으로 쓰이는 중요한 개념어다.
