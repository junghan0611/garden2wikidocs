<!-- gid:20250525T164501 -->
[[TIP("이 노트에 대하여")]] 구글 문서 번역과 판독(pandoc) 흐름을 어떻게 연결할지 정리한 실용 노트다. 온라인 문서 번역과 로컬 텍스트 워크플로우를 이어 보려는 시도가 담겨 있다. [[/TIP]] History - [2025-05-25 Sun 16:45] Related-Notes BIBLIOGRAPHY <span class="org-todo done DONE">DONE</span> OFF [구글 문서 번역을 이용](https://wikidocs.net/381724)하는 방법
