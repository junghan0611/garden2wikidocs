...
[[TIP("이 노트에 대하여")]] AI PC와 소규모 클러스터를 구성할 때 필요한 GPU와 가격, 스펙을 정리하는 노트다. 개인 연구 환경과 워크스테이션 설계의 기초 자료 역할을 한다. [[/TIP]] 관련메타 - [ 인공지능](https://wikidocs.net/380588)
...
-   [2025-06-05 Thu 22:27] 사내 인공지능 활용 클러스터 이야기들은 바 기록 - Qwen3 - 더 깊이 생각하고 더 빠르게 행동하는 차세대 언어 모델 (Slipbox) (neo 2025) - [Dify 에이전틱 AI 개발 플랫폼 - 지식베이스 클러스터 LangGenius](https://wikidocs.net/381749)

## 로그

### 2000만원 이내로 인공지능을 위한 PC 클러스터 제품의 예

(“2000만원 이내로 인공지능을 위한 Pc 클러스터 제품의 예” n.d.) [2025-06-05 Thu 22:28] [|2025-06-05 Thu 22:27|](https://wikidocs.net/380418.md#h-2025-06-05/)
