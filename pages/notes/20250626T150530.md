...
[[TIP("이 노트에 대하여")]] ThingsBoard PE 에디션을 소규모 IoT 플랫폼으로 개발·배포할 때 필요한 아키텍처와 키워드를 정리한다. 시스템 구조와 프로토콜, 저장소 선택까지 폭넓게 담은 실무 노트다. [[/TIP]] 히스토리 - [2025-06-26 Thu 15:05] 관련 사례 관련메타 - [ IoT InternetofThings 아이오티](https://wikidocs.net/380996)
