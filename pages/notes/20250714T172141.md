...
[[TIP("이 노트에 대하여")]] 코드를 리포지토리보다 지식베이스 중심에서 다루며 tangle과 detangle로 문서와 실행물을 오가는 전략을 설명한다. 에이전트 코딩 시대의 Emacs literate workflow를 정리한 핵심 노트다. [[/TIP]] 히스토리 - [2026-02-13 Fri 05:57] 리터레이트 [Self-documenting CLI 패턴: 인간과 에이전트를 위한 실행기](https://wikidocs.net/381852) 추가
-   [2025-07-14 Mon 17:21] 에이전트 코딩 시키면 날리 바가지를 만든다. 관련노트 - [힣: memex-kb 힣의 범용 지식베이스 변환 시스템](https://wikidocs.net/381806)
