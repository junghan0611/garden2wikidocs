<!-- gid:20250719T105015 -->
[[TIP("이 노트에 대하여")]] 노트북 로컬 환경에서 n8n과 Zammad, Dify를 Docker로 띄워 기본 자동화 스택을 재현하는 노트다. 서버 이전에 작은 실험장을 구축해 보는 셀프호스팅 실무 메모다. [[/TIP]] 히스토리 - [2025-07-19 Sat 10:50] 그래 노트북에 다 설치해서 아주 기본 동작은 다 확인 할 수 있다. 그 정도 환경은 되니까. 아하! 관련메타 - [ 도커 MLflow 랭체인](https://wikidocs.net/380737)
