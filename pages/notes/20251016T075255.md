<!-- gid:20251016T075255 -->
[[TIP("이 노트에 대하여")]] claude-memory 폴더 구조를 Denote 기반 지식베이스로 옮길지, 어떤 계층과 형식으로 통합할지 따져 보는 전략 노트다. 디지털가든 출판과 메모리 속도 사이의 긴장을 드러낸다. [[/TIP]] 히스토리 - [2025-10-16 Thu 07:52] 고민 - [[최종 결정] 3-Tier 지식베이스 아키텍처 (마이그레이션 보류)](https://wikidocs.net/381796)
