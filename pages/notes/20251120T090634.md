<!-- gid:20251120T090634 -->
[[TIP("이 노트에 대하여")]] 메인 에이전트와 여러 서브에이전트가 역할을 나누는 오케스트레이션 구조를 통해 '존재 대 존재' 협업 모델을 구현하려는 설계를 담는다. 에이전트 구조 철학과 실전 구성이 함께 보이는 노트다. [[/TIP]] 관련노트 - [OPENCODE: 오픈코드 에이전트 오케스트레이션 도구](https://notes.junghanacs.com/notes/20251024T085736/)
