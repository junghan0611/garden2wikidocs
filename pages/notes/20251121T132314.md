<!-- gid:20251121T132314 -->
[[TIP("이 노트에 대하여")]]
Emacs의 강점인 REPL과 라이브 프로그래밍을 AI 통합에 어떻게 되살릴 수 있는지 묻는다. 단방향 명령 실행이 아닌 상태 공유형 협업 패러다임을 제안하는 노트다.
[[/TIP]]

<!-- provenance:source:start -->
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20251121T132314/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2025-11-21T13:23:00+09:00`
- 최근 수정: `2025-11-21T13:23:00+09:00`
[[/TIP]]
<!-- provenance:source:end -->

-   [Emacs agent-shell + OpenCode MCP 통합 실행 계획](https://notes.junghanacs.com/notes/20251121T132839/)
...
(mcp-add-server "github" :command '("/home/tbdhny/sync/emacs/claude-config/opencode/github-mcp-with-env.sh"))
...
**OpenCode 설정**: \`\`\`jsonc _/ ~_.config/opencode/opencode.jsonc { "mcp": { "emacs-elisp-dev": { "type": "local", "command": ["node", "/path/to/elisp-dev-mcp/build/index.js"], "environment": { "EMACS_SERVER_FILE": "/tmp/emacs1000/server" }, "enabled": true } } } \`\`\`
