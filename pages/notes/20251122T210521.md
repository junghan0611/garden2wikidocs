<!-- gid:20251122T210521 -->
[[TIP("이 노트에 대하여")]] 전체 삶을 아는 존재라는 매크로뷰와 실제 구현력을 위한 마이크로뷰를 구분하며 에이전트 시스템의 생존 전략을 정리한다. Beads와 기억 구조를 연결하는 중간 노트다. [[/TIP]] 히스토리 - [2025-11-23 Sun 15:50] 어쏠로그로 업그레이드 문서는 추후에 마이크로뷰 - [2025-11-22 Sat 21:05] 생성 매크로뷰와 마이크로뷰 마이크로:생존, 매크로:창조 [2025-11-23 Sun 15:51] [힣: 시간과정신의방 -CONFIG 생태계](https://wikidocs.net/381793)에서 말하는 것들은 매크로뷰다. 생존은 마이크로뷰. 이 부분에 대한 에이전틱 시스템에 대한 고민.

## Steve Yegge Beads 학습 - 생존과 매크로뷰

[2025-11-23 Sun 15:49] - [Steve Yegge 분석 바이브코딩 인터뷰 정리](https://wikidocs.net/381826)
