...
[[TIP("이 노트에 대하여")]] Steve Yegge의 Beads 프로젝트와 인터뷰를 단서로 상용·오픈소스 에이전트 도구들의 본질을 비교한다. ACP와 vibe coding 시대의 흐름을 읽는 분석 노트다. [[/TIP]] 관련메타 - [바이브코딩](https://wikidocs.net/380814)

## 히스토리

-   [2025-11-23 Sun 15:40] 만든것 - [스티브예기 steveyegge beads efrit 바이브코딩](https://wikidocs.net/382504)
