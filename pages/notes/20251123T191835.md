...
-   [힣: 분신이 생존을 위해 나선다 — FDE와 아무도 읽지 않는 가든](https://wikidocs.net/396757) - 이건 자매 노트다.
...
<https://xirp.spotify.com/> 이거 보자.

누가 아래와 같이 썼길래. 내가 이 주제 탐구 비교 중([에이전트 오케스트레이터 리서치 — 뉴스와 비교 누적](https://wikidocs.net/382608))
...
[힣: entwurf는 모두를 지원하지 않는다 — PI 코어·ACP 레일·부름의 mux](https://wikidocs.net/390030) [힣: entwurf 물음·부름·불응·부릉 — 보이는 곳에서 함께 달리는 분신](https://wikidocs.net/394534)
