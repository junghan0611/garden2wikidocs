...
[[TIP("이 노트에 대하여")]] Efrit와 Steve Yegge의 비전을 따라 Emacs가 멀티에이전트 시대에도 왜 의미 있는지 살핀다. 오래된 편집기와 새로운 에이전트 패러다임의 접점을 정리한 노트다. [[/TIP]] Efrit: 왜 Emacs에서 멀티에이전트인가? Steve Yegge가 Emacs로 멀티에이전트 시스템을 구축하려는 이유와 그의 전체 비전을 분석한 문서. 관련노트 - [샘스트라우스 클로저 이맥스 유튜버 SammyEngineering](https://wikidocs.net/382144)
