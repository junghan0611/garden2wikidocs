<!-- gid:20251217T105827 -->
[[TIP("이 노트에 대하여")]] Windows에서 ext4 파일시스템을 바로 읽지 못할 때 WSL2로 우회해 접근하는 방법을 설명한다. 탐색기와 리눅스 파일시스템 사이를 잇는 실용 노트다. [[/TIP]] 관련메타 - [ 윈도우즈](https://notes.junghanacs.com/meta/20250107T151412/)
