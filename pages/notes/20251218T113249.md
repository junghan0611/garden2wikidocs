...
[[TIP("원본·최신본")]]
이 페이지는 한국어 검색과 읽기를 위한 WikiDocs 미러입니다. [원본·최신본은 가든](https://notes.junghanacs.com/notes/20251218T113249/)에 있습니다. 최신 수정 내용·백링크·태그·히스토리·댓글·출처 정보는 원본 가든에서 확인하세요.

- 작성: `2025-12-18T11:32:00+09:00`
- 최근 수정: `2026-04-24T14:10:00+09:00`
[[/TIP]]
...
-   [2026-08-03 Mon 12:20] @mitsein/claude-sonnet-5 — 표준 구조로 수선. 문서 끝의 `관련문서=(자석·노트 혼재)를 =관련메타=/=관련노트` 로 분리해 `배경` 뒤 표준 위치로 옮기고, `메타워드 연결 지도` 다이어그램은 그 옆에 남겼다. 본문 서술은 손대지 않았다.
-   [2026-04-24 Fri 14:10] 힣의 네트워크 스택 통합 노트로 상향 조정. 홈/공장 통합 토폴로지 전략 관점 추가
-   [2025-12-18 Thu 11:50] IKEA DIRIGERA 분석 추가
-   [2025-12-18 Thu 11:39] 간담회 중에 문서 생성

## 배경

[2025-12-18 Thu 10:39] TTA 지능형 홈 지원 사업 설명회 참석 중 작성한 메모를 기반으로 시작했다. 처음에는 스레드/매터 기반 지능형 홈 지원 사업과 현재 진행 중인 프로젝트들의 연결고리를 정리하는 노트였다.

[2026-04-24 Fri 14:10] 이제 이 노트는 범위를 넓혀, 힣이 홈과 공장, 엣지와 온프레미스를 관통하는 `네트워크 스택 통합 전략` 을 사고하는 중심 노트가 된다.

### 현재 프로젝트

-   `fxf-uho-mvt` : Zigbee 기반 허브, Zig 상태머신 아키텍처
-   `xlhatqbat-rockchip` : RK3588 Android 15, Matter/OpenThread 정부과제
-   `matter.js` : 현대적 TypeScript 코드베이스 기반 Matter 구현 추적 대상
-   `homeagent-config` : 허브-에이전트 구조의 산업 확장 가능성 검토 대상
...
-   [힣: 메모리 대란과 임베디드 개발 — 투명한 경계](https://notes.junghanacs.com/notes/20241019T193836/) — 네트워크 스택 통합을 인간의 시간·건강·재현성 문제로 다시 묶는 원석.
-   [힣: 나는허브다 - 상태머신과 에이전트 협업 임베디드](https://notes.junghanacs.com/notes/20251212T162004/)
...
-   [힣: 경계는 사람이 열고, 절차는 완전히 돌아야 한다](https://notes.junghanacs.com/notes/20250601T145258/) — 같은 xlhatqbat-rockchip 궤적에서 나온 형제 원칙.
...
Matter는 "무엇을 제어할 것인가"를 정의하는 공통 언어다. 즉 디바이스 타입, 속성, 명령, 상호운용 모델을 통일하는 계층이다. Thread/WiFi/Ethernet은 "어떻게 전송할 것인가"를 담당한다.
...
-   홈 _오피스_ 생활공간: Thread + Wi-Fi + Ethernet
...
[힣: 인생도구 지식관리 생각도구](https://notes.junghanacs.com/notes/20250526T161643/)에서:
